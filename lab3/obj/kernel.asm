...
ffffffffc0200052:	42a58593          	addi	a1,a1,1066 # ffffffffc0204478 <etext+0x4>
ffffffffc0200056:	00004517          	auipc	a0,0x4
ffffffffc020005a:	44250513          	addi	a0,a0,1090 # ffffffffc0204498 <etext+0x24>
...
ffffffffc020006e:	6ac030ef          	jal	ra,ffffffffc020371a <vmm_init>
...
ffffffffc02000ac:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000ae:	6eb030ef          	jal	ra,ffffffffc0203f98 <vprintfmt>
    return cnt;
}
...
ffffffffc02000e2:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000e4:	6b5030ef          	jal	ra,ffffffffc0203f98 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc0200108:	39c50513          	addi	a0,a0,924 # ffffffffc02044a0 <etext+0x2c>
void print_kerninfo(void) {
...
ffffffffc020011e:	3a650513          	addi	a0,a0,934 # ffffffffc02044c0 <etext+0x4c>
ffffffffc0200122:	f99ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200126:	00004597          	auipc	a1,0x4
ffffffffc020012a:	34e58593          	addi	a1,a1,846 # ffffffffc0204474 <etext>
ffffffffc020012e:	00004517          	auipc	a0,0x4
ffffffffc0200132:	3b250513          	addi	a0,a0,946 # ffffffffc02044e0 <etext+0x6c>
...
ffffffffc0200146:	3be50513          	addi	a0,a0,958 # ffffffffc0204500 <etext+0x8c>
...
ffffffffc020015a:	3ca50513          	addi	a0,a0,970 # ffffffffc0204520 <etext+0xac>
...
ffffffffc0200188:	3bc50513          	addi	a0,a0,956 # ffffffffc0204540 <etext+0xcc>
}
...
ffffffffc0200196:	3de60613          	addi	a2,a2,990 # ffffffffc0204570 <etext+0xfc>
ffffffffc020019a:	04e00593          	li	a1,78
ffffffffc020019e:	00004517          	auipc	a0,0x4
ffffffffc02001a2:	3ea50513          	addi	a0,a0,1002 # ffffffffc0204588 <etext+0x114>
void print_stackframe(void) {
...
ffffffffc02001b2:	3f260613          	addi	a2,a2,1010 # ffffffffc02045a0 <etext+0x12c>
ffffffffc02001b6:	00004597          	auipc	a1,0x4
ffffffffc02001ba:	40a58593          	addi	a1,a1,1034 # ffffffffc02045c0 <etext+0x14c>
ffffffffc02001be:	00004517          	auipc	a0,0x4
ffffffffc02001c2:	40a50513          	addi	a0,a0,1034 # ffffffffc02045c8 <etext+0x154>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02001d0:	40c60613          	addi	a2,a2,1036 # ffffffffc02045d8 <etext+0x164>
ffffffffc02001d4:	00004597          	auipc	a1,0x4
ffffffffc02001d8:	42c58593          	addi	a1,a1,1068 # ffffffffc0204600 <etext+0x18c>
ffffffffc02001dc:	00004517          	auipc	a0,0x4
ffffffffc02001e0:	3ec50513          	addi	a0,a0,1004 # ffffffffc02045c8 <etext+0x154>
ffffffffc02001e4:	ed7ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
ffffffffc02001e8:	00004617          	auipc	a2,0x4
ffffffffc02001ec:	42860613          	addi	a2,a2,1064 # ffffffffc0204610 <etext+0x19c>
ffffffffc02001f0:	00004597          	auipc	a1,0x4
ffffffffc02001f4:	44058593          	addi	a1,a1,1088 # ffffffffc0204630 <etext+0x1bc>
ffffffffc02001f8:	00004517          	auipc	a0,0x4
ffffffffc02001fc:	3d050513          	addi	a0,a0,976 # ffffffffc02045c8 <etext+0x154>
...
ffffffffc0200236:	40e50513          	addi	a0,a0,1038 # ffffffffc0204640 <etext+0x1cc>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200258:	41450513          	addi	a0,a0,1044 # ffffffffc0204668 <etext+0x1f4>
...
ffffffffc020027e:	41648493          	addi	s1,s1,1046 # ffffffffc0204690 <etext+0x21c>
        if (argc == MAXARGS - 1) {
ffffffffc0200282:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200284:	00004b17          	auipc	s6,0x4
ffffffffc0200288:	414b0b13          	addi	s6,s6,1044 # ffffffffc0204698 <etext+0x224>
        argv[argc ++] = buf;
ffffffffc020028c:	00004a17          	auipc	s4,0x4
ffffffffc0200290:	334a0a13          	addi	s4,s4,820 # ffffffffc02045c0 <etext+0x14c>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc0200294:	4a8d                	li	s5,3
        if ((buf = readline("")) != NULL) {
ffffffffc0200296:	854a                	mv	a0,s2
ffffffffc0200298:	082040ef          	jal	ra,ffffffffc020431a <readline>
...
ffffffffc02002ce:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002d0:	146040ef          	jal	ra,ffffffffc0204416 <strcmp>
...
ffffffffc020030e:	126040ef          	jal	ra,ffffffffc0204434 <strchr>
...
ffffffffc020034c:	0e8040ef          	jal	ra,ffffffffc0204434 <strchr>
...
ffffffffc020036a:	35250513          	addi	a0,a0,850 # ffffffffc02046b8 <etext+0x244>
...
ffffffffc02004b6:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02004b8:	7a5030ef          	jal	ra,ffffffffc020445c <memcpy>
    return 0;
}
...
ffffffffc02004da:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02004dc:	781030ef          	jal	ra,ffffffffc020445c <memcpy>
    return 0;
}
...
ffffffffc0200546:	0141                	addi	sp,sp,16
        return do_pgfault(check_mm_struct, tf->cause, tf->badvaddr);
ffffffffc0200548:	7aa0306f          	j	ffffffffc0203cf2 <do_pgfault>
    panic("unhandled page fault.\n");
...
ffffffffc0200b6e:	8065b583          	ld	a1,-2042(a1) # ffffffffc0206370 <error_string+0x38>
ffffffffc0200b72:	02b70733          	mul	a4,a4,a1
ffffffffc0200b76:	00006617          	auipc	a2,0x6
ffffffffc0200b7a:	80263603          	ld	a2,-2046(a2) # ffffffffc0206378 <nbase>
...
ffffffffc0201614:	18b010ef          	jal	ra,ffffffffc0202f9e <swap_out>
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc0201722:	c52b3b03          	ld	s6,-942(s6) # ffffffffc0206370 <error_string+0x38>
...
ffffffffc0201760:	4eb020ef          	jal	ra,ffffffffc020444a <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc02017d0:	ba4b3b03          	ld	s6,-1116(s6) # ffffffffc0206370 <error_string+0x38>
...
ffffffffc0201802:	449020ef          	jal	ra,ffffffffc020444a <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc02019f8:	97c43403          	ld	s0,-1668(s0) # ffffffffc0206370 <error_string+0x38>
...
ffffffffc0201dfe:	576cbc83          	ld	s9,1398(s9) # ffffffffc0206370 <error_string+0x38>
...
ffffffffc0201f60:	4a4020ef          	jal	ra,ffffffffc0204404 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0201f64:	10040593          	addi	a1,s0,256
ffffffffc0201f68:	10000513          	li	a0,256
ffffffffc0201f6c:	4aa020ef          	jal	ra,ffffffffc0204416 <strcmp>
...
ffffffffc0201fa2:	10068023          	sb	zero,256(a3) # fffffffffff80100 <end+0x3fd6eb9c>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0201fa6:	428020ef          	jal	ra,ffffffffc02043ce <strlen>
...
ffffffffc0202712:	081000ef          	jal	ra,ffffffffc0202f92 <swap_map_swappable>
...
ffffffffc02027a4:	bd06b683          	ld	a3,-1072(a3) # ffffffffc0206370 <error_string+0x38>
...
ffffffffc0202934:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202936:	48a010ef          	jal	ra,ffffffffc0203dc0 <swapfs_init>
...
ffffffffc020294c:	3ee7e163          	bltu	a5,a4,ffffffffc0202d2e <swap_init+0x414>
...
ffffffffc0202954:	6b078793          	addi	a5,a5,1712 # ffffffffc020a000 <swap_manager_fifo>
     int r = sm->init();
...
ffffffffc02029b4:	4d01                	li	s10,0
     list_entry_t *le = &free_list;
     while ((le = list_next(le)) != &free_list) {
ffffffffc02029b6:	2c978263          	beq	a5,s1,ffffffffc0202c7a <swap_init+0x360>
    return (((*(volatile unsigned long *)addr) >> nr) & 1);
ffffffffc02029ba:	fe87b703          	ld	a4,-24(a5)
        struct Page *p = le2page(le, page_link);
        assert(PageProperty(p));
ffffffffc02029be:	8b09                	andi	a4,a4,2
ffffffffc02029c0:	2a070f63          	beqz	a4,ffffffffc0202c7e <swap_init+0x364>
        count ++, total += p->property;
...
ffffffffc02029d8:	47251763          	bne	a0,s2,ffffffffc0202e46 <swap_init+0x52c>
...
ffffffffc02029ec:	373000ef          	jal	ra,ffffffffc020355e <mm_create>
ffffffffc02029f0:	8aaa                	mv	s5,a0
     assert(mm != NULL);
ffffffffc02029f2:	52050a63          	beqz	a0,ffffffffc0202f26 <swap_init+0x60c>
...
ffffffffc0202a00:	54071363          	bnez	a4,ffffffffc0202f46 <swap_init+0x62c>
...
ffffffffc0202a12:	01753c23          	sd	s7,24(a0)
     assert(pgdir[0] == 0);
ffffffffc0202a16:	3c071863          	bnez	a4,ffffffffc0202de6 <swap_init+0x4cc>

     struct vma_struct *vma = vma_create(BEING_CHECK_VALID_VADDR, CHECK_VALID_VADDR, VM_WRITE | VM_READ);
ffffffffc0202a1a:	6599                	lui	a1,0x6
ffffffffc0202a1c:	460d                	li	a2,3
ffffffffc0202a1e:	6505                	lui	a0,0x1
ffffffffc0202a20:	387000ef          	jal	ra,ffffffffc02035a6 <vma_create>
ffffffffc0202a24:	85aa                	mv	a1,a0
     assert(vma != NULL);
ffffffffc0202a26:	3e050063          	beqz	a0,ffffffffc0202e06 <swap_init+0x4ec>

     insert_vma_struct(mm, vma);
ffffffffc0202a2a:	8556                	mv	a0,s5
ffffffffc0202a2c:	3e9000ef          	jal	ra,ffffffffc0203614 <insert_vma_struct>
...
ffffffffc0202a48:	3c050f63          	beqz	a0,ffffffffc0202e26 <swap_init+0x50c>
...
ffffffffc0202a74:	28050d63          	beqz	a0,ffffffffc0202d0e <swap_init+0x3f4>
ffffffffc0202a78:	651c                	ld	a5,8(a0)
          assert(!PageProperty(check_rp[i]));
ffffffffc0202a7a:	8b89                	andi	a5,a5,2
ffffffffc0202a7c:	26079963          	bnez	a5,ffffffffc0202cee <swap_init+0x3d4>
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
...
ffffffffc0202abc:	4afc1563          	bne	s8,a5,ffffffffc0202f66 <swap_init+0x64c>
...
ffffffffc0202aee:	3f059c63          	bne	a1,a6,ffffffffc0202ee6 <swap_init+0x5cc>
     *(unsigned char *)0x1010 = 0x0a;
ffffffffc0202af2:	00a60823          	sb	a0,16(a2)
     assert(pgfault_num==1);
ffffffffc0202af6:	4390                	lw	a2,0(a5)
ffffffffc0202af8:	2601                	sext.w	a2,a2
ffffffffc0202afa:	40b61663          	bne	a2,a1,ffffffffc0202f06 <swap_init+0x5ec>
...
ffffffffc0202b0c:	35061d63          	bne	a2,a6,ffffffffc0202e66 <swap_init+0x54c>
     *(unsigned char *)0x2010 = 0x0b;
ffffffffc0202b10:	00a58823          	sb	a0,16(a1)
     assert(pgfault_num==2);
ffffffffc0202b14:	438c                	lw	a1,0(a5)
ffffffffc0202b16:	2581                	sext.w	a1,a1
ffffffffc0202b18:	36c59763          	bne	a1,a2,ffffffffc0202e86 <swap_init+0x56c>
...
ffffffffc0202b2a:	37061e63          	bne	a2,a6,ffffffffc0202ea6 <swap_init+0x58c>
     *(unsigned char *)0x3010 = 0x0c;
ffffffffc0202b2e:	00a58823          	sb	a0,16(a1)
     assert(pgfault_num==3);
ffffffffc0202b32:	438c                	lw	a1,0(a5)
ffffffffc0202b34:	2581                	sext.w	a1,a1
ffffffffc0202b36:	38c59863          	bne	a1,a2,ffffffffc0202ec6 <swap_init+0x5ac>
...
ffffffffc0202b46:	23861063          	bne	a2,s8,ffffffffc0202d66 <swap_init+0x44c>
     *(unsigned char *)0x4010 = 0x0d;
ffffffffc0202b4a:	00a58823          	sb	a0,16(a1)
     assert(pgfault_num==4);
ffffffffc0202b4e:	439c                	lw	a5,0(a5)
ffffffffc0202b50:	2781                	sext.w	a5,a5
ffffffffc0202b52:	22c79a63          	bne	a5,a2,ffffffffc0202d86 <swap_init+0x46c>
     
     check_content_set();
     assert( nr_free == 0);         
ffffffffc0202b56:	489c                	lw	a5,16(s1)
ffffffffc0202b58:	24079763          	bnez	a5,ffffffffc0202da6 <swap_init+0x48c>
...
ffffffffc0202ba0:	7dcc0c13          	addi	s8,s8,2012 # ffffffffc0206378 <nbase>
...
ffffffffc0202bc8:	16050f63          	beqz	a0,ffffffffc0202d46 <swap_init+0x42c>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202bcc:	611c                	ld	a5,0(a0)
    if (!(pte & PTE_V)) {
ffffffffc0202bce:	0017f613          	andi	a2,a5,1
ffffffffc0202bd2:	0e060663          	beqz	a2,ffffffffc0202cbe <swap_init+0x3a4>
    if (PPN(pa) >= npage) {
...
ffffffffc0202bdc:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc0202bde:	0ec7fc63          	bgeu	a5,a2,ffffffffc0202cd6 <swap_init+0x3bc>
    return &pages[PPN(pa) - nbase];
...
ffffffffc0202bfa:	0aff1263          	bne	t5,a5,ffffffffc0202c9e <swap_init+0x384>
     for (i= 0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
...
ffffffffc0202c1e:	7f9c                	ld	a5,56(a5)
ffffffffc0202c20:	9782                	jalr	a5
     // now access the virt pages to test  page relpacement algorithm 
     ret=check_content_access(mm);
     assert(ret==0);
ffffffffc0202c22:	1a051263          	bnez	a0,ffffffffc0202dc6 <swap_init+0x4ac>
     
     //restore kernel mem env
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
         free_pages(check_rp[i],1);
ffffffffc0202c26:	00093503          	ld	a0,0(s2)
ffffffffc0202c2a:	4585                	li	a1,1
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
ffffffffc0202c2c:	0921                	addi	s2,s2,8
         free_pages(check_rp[i],1);
ffffffffc0202c2e:	a25fe0ef          	jal	ra,ffffffffc0201652 <free_pages>
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
ffffffffc0202c32:	ff491ae3          	bne	s2,s4,ffffffffc0202c26 <swap_init+0x30c>
     } 

     //free_page(pte2page(*temp_ptep));
     
     mm_destroy(mm);
ffffffffc0202c36:	8556                	mv	a0,s5
ffffffffc0202c38:	2ad000ef          	jal	ra,ffffffffc02036e4 <mm_destroy>
         
     nr_free = nr_free_store;
ffffffffc0202c3c:	77a2                	ld	a5,40(sp)
     free_list = free_list_store;
ffffffffc0202c3e:	01b4b423          	sd	s11,8(s1)
     nr_free = nr_free_store;
ffffffffc0202c42:	c89c                	sw	a5,16(s1)
     free_list = free_list_store;
ffffffffc0202c44:	7782                	ld	a5,32(sp)
ffffffffc0202c46:	e09c                	sd	a5,0(s1)

     
     le = &free_list;
     while ((le = list_next(le)) != &free_list) {
ffffffffc0202c48:	009d8a63          	beq	s11,s1,ffffffffc0202c5c <swap_init+0x342>
         struct Page *p = le2page(le, page_link);
         count --, total -= p->property;
ffffffffc0202c4c:	ff8da783          	lw	a5,-8(s11)
    return listelm->next;
ffffffffc0202c50:	008dbd83          	ld	s11,8(s11)
ffffffffc0202c54:	3d7d                	addiw	s10,s10,-1
ffffffffc0202c56:	9c1d                	subw	s0,s0,a5
     while ((le = list_next(le)) != &free_list) {
ffffffffc0202c58:	fe9d9ae3          	bne	s11,s1,ffffffffc0202c4c <swap_init+0x332>
     }
     cprintf("count is %d, total is %d\n",count,total);
ffffffffc0202c5c:	8622                	mv	a2,s0
ffffffffc0202c5e:	85ea                	mv	a1,s10
ffffffffc0202c60:	00003517          	auipc	a0,0x3
ffffffffc0202c64:	e4850513          	addi	a0,a0,-440 # ffffffffc0205aa8 <default_pmm_manager+0x8f0>
ffffffffc0202c68:	c52fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     //assert(count == 0);
     
     cprintf("check_swap() succeeded!\n");
ffffffffc0202c6c:	00003517          	auipc	a0,0x3
ffffffffc0202c70:	e5c50513          	addi	a0,a0,-420 # ffffffffc0205ac8 <default_pmm_manager+0x910>
ffffffffc0202c74:	c46fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
}
ffffffffc0202c78:	b9d5                	j	ffffffffc020296c <swap_init+0x52>
     while ((le = list_next(le)) != &free_list) {
ffffffffc0202c7a:	4901                	li	s2,0
ffffffffc0202c7c:	bba1                	j	ffffffffc02029d4 <swap_init+0xba>
        assert(PageProperty(p));
ffffffffc0202c7e:	00002697          	auipc	a3,0x2
ffffffffc0202c82:	17a68693          	addi	a3,a3,378 # ffffffffc0204df8 <commands+0x728>
ffffffffc0202c86:	00002617          	auipc	a2,0x2
ffffffffc0202c8a:	18260613          	addi	a2,a2,386 # ffffffffc0204e08 <commands+0x738>
ffffffffc0202c8e:	0ba00593          	li	a1,186
ffffffffc0202c92:	00003517          	auipc	a0,0x3
ffffffffc0202c96:	bce50513          	addi	a0,a0,-1074 # ffffffffc0205860 <default_pmm_manager+0x6a8>
ffffffffc0202c9a:	edafd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202c9e:	00003697          	auipc	a3,0x3
ffffffffc0202ca2:	db268693          	addi	a3,a3,-590 # ffffffffc0205a50 <default_pmm_manager+0x898>
ffffffffc0202ca6:	00002617          	auipc	a2,0x2
ffffffffc0202caa:	16260613          	addi	a2,a2,354 # ffffffffc0204e08 <commands+0x738>
ffffffffc0202cae:	0fa00593          	li	a1,250
ffffffffc0202cb2:	00003517          	auipc	a0,0x3
ffffffffc0202cb6:	bae50513          	addi	a0,a0,-1106 # ffffffffc0205860 <default_pmm_manager+0x6a8>
ffffffffc0202cba:	ebafd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202cbe:	00002617          	auipc	a2,0x2
ffffffffc0202cc2:	56260613          	addi	a2,a2,1378 # ffffffffc0205220 <default_pmm_manager+0x68>
ffffffffc0202cc6:	07000593          	li	a1,112
ffffffffc0202cca:	00002517          	auipc	a0,0x2
ffffffffc0202cce:	54650513          	addi	a0,a0,1350 # ffffffffc0205210 <default_pmm_manager+0x58>
ffffffffc0202cd2:	ea2fd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0202cd6:	00002617          	auipc	a2,0x2
ffffffffc0202cda:	51a60613          	addi	a2,a2,1306 # ffffffffc02051f0 <default_pmm_manager+0x38>
ffffffffc0202cde:	06500593          	li	a1,101
ffffffffc0202ce2:	00002517          	auipc	a0,0x2
ffffffffc0202ce6:	52e50513          	addi	a0,a0,1326 # ffffffffc0205210 <default_pmm_manager+0x58>
ffffffffc0202cea:	e8afd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0202cee:	00003697          	auipc	a3,0x3
ffffffffc0202cf2:	c9a68693          	addi	a3,a3,-870 # ffffffffc0205988 <default_pmm_manager+0x7d0>
ffffffffc0202cf6:	00002617          	auipc	a2,0x2
ffffffffc0202cfa:	11260613          	addi	a2,a2,274 # ffffffffc0204e08 <commands+0x738>
ffffffffc0202cfe:	0db00593          	li	a1,219
ffffffffc0202d02:	00003517          	auipc	a0,0x3
ffffffffc0202d06:	b5e50513          	addi	a0,a0,-1186 # ffffffffc0205860 <default_pmm_manager+0x6a8>
ffffffffc0202d0a:	e6afd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202d0e:	00003697          	auipc	a3,0x3
ffffffffc0202d12:	c6268693          	addi	a3,a3,-926 # ffffffffc0205970 <default_pmm_manager+0x7b8>
ffffffffc0202d16:	00002617          	auipc	a2,0x2
ffffffffc0202d1a:	0f260613          	addi	a2,a2,242 # ffffffffc0204e08 <commands+0x738>
ffffffffc0202d1e:	0da00593          	li	a1,218
ffffffffc0202d22:	00003517          	auipc	a0,0x3
ffffffffc0202d26:	b3e50513          	addi	a0,a0,-1218 # ffffffffc0205860 <default_pmm_manager+0x6a8>
ffffffffc0202d2a:	e4afd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202d2e:	00003617          	auipc	a2,0x3
ffffffffc0202d32:	b1260613          	addi	a2,a2,-1262 # ffffffffc0205840 <default_pmm_manager+0x688>
ffffffffc0202d36:	02700593          	li	a1,39
ffffffffc0202d3a:	00003517          	auipc	a0,0x3
ffffffffc0202d3e:	b2650513          	addi	a0,a0,-1242 # ffffffffc0205860 <default_pmm_manager+0x6a8>
ffffffffc0202d42:	e32fd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202d46:	00003697          	auipc	a3,0x3
ffffffffc0202d4a:	cf268693          	addi	a3,a3,-782 # ffffffffc0205a38 <default_pmm_manager+0x880>
ffffffffc0202d4e:	00002617          	auipc	a2,0x2
ffffffffc0202d52:	0ba60613          	addi	a2,a2,186 # ffffffffc0204e08 <commands+0x738>
ffffffffc0202d56:	0f900593          	li	a1,249
ffffffffc0202d5a:	00003517          	auipc	a0,0x3
ffffffffc0202d5e:	b0650513          	addi	a0,a0,-1274 # ffffffffc0205860 <default_pmm_manager+0x6a8>
ffffffffc0202d62:	e12fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d66:	00003697          	auipc	a3,0x3
ffffffffc0202d6a:	cc268693          	addi	a3,a3,-830 # ffffffffc0205a28 <default_pmm_manager+0x870>
ffffffffc0202d6e:	00002617          	auipc	a2,0x2
ffffffffc0202d72:	09a60613          	addi	a2,a2,154 # ffffffffc0204e08 <commands+0x738>
ffffffffc0202d76:	09d00593          	li	a1,157
ffffffffc0202d7a:	00003517          	auipc	a0,0x3
ffffffffc0202d7e:	ae650513          	addi	a0,a0,-1306 # ffffffffc0205860 <default_pmm_manager+0x6a8>
ffffffffc0202d82:	df2fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d86:	00003697          	auipc	a3,0x3
ffffffffc0202d8a:	ca268693          	addi	a3,a3,-862 # ffffffffc0205a28 <default_pmm_manager+0x870>
ffffffffc0202d8e:	00002617          	auipc	a2,0x2
ffffffffc0202d92:	07a60613          	addi	a2,a2,122 # ffffffffc0204e08 <commands+0x738>
ffffffffc0202d96:	09f00593          	li	a1,159
ffffffffc0202d9a:	00003517          	auipc	a0,0x3
ffffffffc0202d9e:	ac650513          	addi	a0,a0,-1338 # ffffffffc0205860 <default_pmm_manager+0x6a8>
ffffffffc0202da2:	dd2fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert( nr_free == 0);         
ffffffffc0202da6:	00002697          	auipc	a3,0x2
ffffffffc0202daa:	23a68693          	addi	a3,a3,570 # ffffffffc0204fe0 <commands+0x910>
ffffffffc0202dae:	00002617          	auipc	a2,0x2
ffffffffc0202db2:	05a60613          	addi	a2,a2,90 # ffffffffc0204e08 <commands+0x738>
ffffffffc0202db6:	0f100593          	li	a1,241
ffffffffc0202dba:	00003517          	auipc	a0,0x3
ffffffffc0202dbe:	aa650513          	addi	a0,a0,-1370 # ffffffffc0205860 <default_pmm_manager+0x6a8>
ffffffffc0202dc2:	db2fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(ret==0);
ffffffffc0202dc6:	00003697          	auipc	a3,0x3
ffffffffc0202dca:	cda68693          	addi	a3,a3,-806 # ffffffffc0205aa0 <default_pmm_manager+0x8e8>
ffffffffc0202dce:	00002617          	auipc	a2,0x2
ffffffffc0202dd2:	03a60613          	addi	a2,a2,58 # ffffffffc0204e08 <commands+0x738>
ffffffffc0202dd6:	10000593          	li	a1,256
ffffffffc0202dda:	00003517          	auipc	a0,0x3
ffffffffc0202dde:	a8650513          	addi	a0,a0,-1402 # ffffffffc0205860 <default_pmm_manager+0x6a8>
ffffffffc0202de2:	d92fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0202de6:	00003697          	auipc	a3,0x3
ffffffffc0202dea:	af268693          	addi	a3,a3,-1294 # ffffffffc02058d8 <default_pmm_manager+0x720>
ffffffffc0202dee:	00002617          	auipc	a2,0x2
ffffffffc0202df2:	01a60613          	addi	a2,a2,26 # ffffffffc0204e08 <commands+0x738>
ffffffffc0202df6:	0ca00593          	li	a1,202
ffffffffc0202dfa:	00003517          	auipc	a0,0x3
ffffffffc0202dfe:	a6650513          	addi	a0,a0,-1434 # ffffffffc0205860 <default_pmm_manager+0x6a8>
ffffffffc0202e02:	d72fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(vma != NULL);
ffffffffc0202e06:	00003697          	auipc	a3,0x3
ffffffffc0202e0a:	ae268693          	addi	a3,a3,-1310 # ffffffffc02058e8 <default_pmm_manager+0x730>
ffffffffc0202e0e:	00002617          	auipc	a2,0x2
ffffffffc0202e12:	ffa60613          	addi	a2,a2,-6 # ffffffffc0204e08 <commands+0x738>
ffffffffc0202e16:	0cd00593          	li	a1,205
ffffffffc0202e1a:	00003517          	auipc	a0,0x3
ffffffffc0202e1e:	a4650513          	addi	a0,a0,-1466 # ffffffffc0205860 <default_pmm_manager+0x6a8>
ffffffffc0202e22:	d52fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc0202e26:	00003697          	auipc	a3,0x3
ffffffffc0202e2a:	b0a68693          	addi	a3,a3,-1270 # ffffffffc0205930 <default_pmm_manager+0x778>
ffffffffc0202e2e:	00002617          	auipc	a2,0x2
ffffffffc0202e32:	fda60613          	addi	a2,a2,-38 # ffffffffc0204e08 <commands+0x738>
ffffffffc0202e36:	0d500593          	li	a1,213
ffffffffc0202e3a:	00003517          	auipc	a0,0x3
ffffffffc0202e3e:	a2650513          	addi	a0,a0,-1498 # ffffffffc0205860 <default_pmm_manager+0x6a8>
ffffffffc0202e42:	d32fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(total == nr_free_pages());
ffffffffc0202e46:	00002697          	auipc	a3,0x2
ffffffffc0202e4a:	ff268693          	addi	a3,a3,-14 # ffffffffc0204e38 <commands+0x768>
ffffffffc0202e4e:	00002617          	auipc	a2,0x2
ffffffffc0202e52:	fba60613          	addi	a2,a2,-70 # ffffffffc0204e08 <commands+0x738>
ffffffffc0202e56:	0bd00593          	li	a1,189
ffffffffc0202e5a:	00003517          	auipc	a0,0x3
ffffffffc0202e5e:	a0650513          	addi	a0,a0,-1530 # ffffffffc0205860 <default_pmm_manager+0x6a8>
ffffffffc0202e62:	d12fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202e66:	00003697          	auipc	a3,0x3
ffffffffc0202e6a:	ba268693          	addi	a3,a3,-1118 # ffffffffc0205a08 <default_pmm_manager+0x850>
ffffffffc0202e6e:	00002617          	auipc	a2,0x2
ffffffffc0202e72:	f9a60613          	addi	a2,a2,-102 # ffffffffc0204e08 <commands+0x738>
ffffffffc0202e76:	09500593          	li	a1,149
ffffffffc0202e7a:	00003517          	auipc	a0,0x3
ffffffffc0202e7e:	9e650513          	addi	a0,a0,-1562 # ffffffffc0205860 <default_pmm_manager+0x6a8>
ffffffffc0202e82:	cf2fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202e86:	00003697          	auipc	a3,0x3
ffffffffc0202e8a:	b8268693          	addi	a3,a3,-1150 # ffffffffc0205a08 <default_pmm_manager+0x850>
ffffffffc0202e8e:	00002617          	auipc	a2,0x2
ffffffffc0202e92:	f7a60613          	addi	a2,a2,-134 # ffffffffc0204e08 <commands+0x738>
ffffffffc0202e96:	09700593          	li	a1,151
ffffffffc0202e9a:	00003517          	auipc	a0,0x3
ffffffffc0202e9e:	9c650513          	addi	a0,a0,-1594 # ffffffffc0205860 <default_pmm_manager+0x6a8>
ffffffffc0202ea2:	cd2fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202ea6:	00003697          	auipc	a3,0x3
ffffffffc0202eaa:	b7268693          	addi	a3,a3,-1166 # ffffffffc0205a18 <default_pmm_manager+0x860>
ffffffffc0202eae:	00002617          	auipc	a2,0x2
ffffffffc0202eb2:	f5a60613          	addi	a2,a2,-166 # ffffffffc0204e08 <commands+0x738>
ffffffffc0202eb6:	09900593          	li	a1,153
ffffffffc0202eba:	00003517          	auipc	a0,0x3
ffffffffc0202ebe:	9a650513          	addi	a0,a0,-1626 # ffffffffc0205860 <default_pmm_manager+0x6a8>
ffffffffc0202ec2:	cb2fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202ec6:	00003697          	auipc	a3,0x3
ffffffffc0202eca:	b5268693          	addi	a3,a3,-1198 # ffffffffc0205a18 <default_pmm_manager+0x860>
ffffffffc0202ece:	00002617          	auipc	a2,0x2
ffffffffc0202ed2:	f3a60613          	addi	a2,a2,-198 # ffffffffc0204e08 <commands+0x738>
ffffffffc0202ed6:	09b00593          	li	a1,155
ffffffffc0202eda:	00003517          	auipc	a0,0x3
ffffffffc0202ede:	98650513          	addi	a0,a0,-1658 # ffffffffc0205860 <default_pmm_manager+0x6a8>
ffffffffc0202ee2:	c92fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202ee6:	00003697          	auipc	a3,0x3
ffffffffc0202eea:	b1268693          	addi	a3,a3,-1262 # ffffffffc02059f8 <default_pmm_manager+0x840>
ffffffffc0202eee:	00002617          	auipc	a2,0x2
ffffffffc0202ef2:	f1a60613          	addi	a2,a2,-230 # ffffffffc0204e08 <commands+0x738>
ffffffffc0202ef6:	09100593          	li	a1,145
ffffffffc0202efa:	00003517          	auipc	a0,0x3
ffffffffc0202efe:	96650513          	addi	a0,a0,-1690 # ffffffffc0205860 <default_pmm_manager+0x6a8>
ffffffffc0202f02:	c72fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202f06:	00003697          	auipc	a3,0x3
ffffffffc0202f0a:	af268693          	addi	a3,a3,-1294 # ffffffffc02059f8 <default_pmm_manager+0x840>
ffffffffc0202f0e:	00002617          	auipc	a2,0x2
ffffffffc0202f12:	efa60613          	addi	a2,a2,-262 # ffffffffc0204e08 <commands+0x738>
ffffffffc0202f16:	09300593          	li	a1,147
ffffffffc0202f1a:	00003517          	auipc	a0,0x3
ffffffffc0202f1e:	94650513          	addi	a0,a0,-1722 # ffffffffc0205860 <default_pmm_manager+0x6a8>
ffffffffc0202f22:	c52fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(mm != NULL);
ffffffffc0202f26:	00003697          	auipc	a3,0x3
ffffffffc0202f2a:	98a68693          	addi	a3,a3,-1654 # ffffffffc02058b0 <default_pmm_manager+0x6f8>
ffffffffc0202f2e:	00002617          	auipc	a2,0x2
ffffffffc0202f32:	eda60613          	addi	a2,a2,-294 # ffffffffc0204e08 <commands+0x738>
ffffffffc0202f36:	0c200593          	li	a1,194
ffffffffc0202f3a:	00003517          	auipc	a0,0x3
ffffffffc0202f3e:	92650513          	addi	a0,a0,-1754 # ffffffffc0205860 <default_pmm_manager+0x6a8>
ffffffffc0202f42:	c32fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0202f46:	00003697          	auipc	a3,0x3
ffffffffc0202f4a:	97a68693          	addi	a3,a3,-1670 # ffffffffc02058c0 <default_pmm_manager+0x708>
ffffffffc0202f4e:	00002617          	auipc	a2,0x2
ffffffffc0202f52:	eba60613          	addi	a2,a2,-326 # ffffffffc0204e08 <commands+0x738>
ffffffffc0202f56:	0c500593          	li	a1,197
ffffffffc0202f5a:	00003517          	auipc	a0,0x3
ffffffffc0202f5e:	90650513          	addi	a0,a0,-1786 # ffffffffc0205860 <default_pmm_manager+0x6a8>
ffffffffc0202f62:	c12fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc0202f66:	00003697          	auipc	a3,0x3
ffffffffc0202f6a:	a4268693          	addi	a3,a3,-1470 # ffffffffc02059a8 <default_pmm_manager+0x7f0>
ffffffffc0202f6e:	00002617          	auipc	a2,0x2
ffffffffc0202f72:	e9a60613          	addi	a2,a2,-358 # ffffffffc0204e08 <commands+0x738>
ffffffffc0202f76:	0e800593          	li	a1,232
ffffffffc0202f7a:	00003517          	auipc	a0,0x3
ffffffffc0202f7e:	8e650513          	addi	a0,a0,-1818 # ffffffffc0205860 <default_pmm_manager+0x6a8>
ffffffffc0202f82:	bf2fd0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0202f86 <swap_init_mm>:
     return sm->init_mm(mm);
ffffffffc0202f86:	0000e797          	auipc	a5,0xe
ffffffffc0202f8a:	5c27b783          	ld	a5,1474(a5) # ffffffffc0211548 <sm>
ffffffffc0202f8e:	6b9c                	ld	a5,16(a5)
ffffffffc0202f90:	8782                	jr	a5

ffffffffc0202f92 <swap_map_swappable>:
     return sm->map_swappable(mm, addr, page, swap_in);
ffffffffc0202f92:	0000e797          	auipc	a5,0xe
ffffffffc0202f96:	5b67b783          	ld	a5,1462(a5) # ffffffffc0211548 <sm>
ffffffffc0202f9a:	739c                	ld	a5,32(a5)
ffffffffc0202f9c:	8782                	jr	a5

ffffffffc0202f9e <swap_out>:
{
ffffffffc0202f9e:	711d                	addi	sp,sp,-96
ffffffffc0202fa0:	ec86                	sd	ra,88(sp)
ffffffffc0202fa2:	e8a2                	sd	s0,80(sp)
ffffffffc0202fa4:	e4a6                	sd	s1,72(sp)
ffffffffc0202fa6:	e0ca                	sd	s2,64(sp)
ffffffffc0202fa8:	fc4e                	sd	s3,56(sp)
ffffffffc0202faa:	f852                	sd	s4,48(sp)
ffffffffc0202fac:	f456                	sd	s5,40(sp)
ffffffffc0202fae:	f05a                	sd	s6,32(sp)
ffffffffc0202fb0:	ec5e                	sd	s7,24(sp)
ffffffffc0202fb2:	e862                	sd	s8,16(sp)
     for (i = 0; i != n; ++ i)
ffffffffc0202fb4:	cde9                	beqz	a1,ffffffffc020308e <swap_out+0xf0>
ffffffffc0202fb6:	8a2e                	mv	s4,a1
ffffffffc0202fb8:	892a                	mv	s2,a0
ffffffffc0202fba:	8ab2                	mv	s5,a2
ffffffffc0202fbc:	4401                	li	s0,0
ffffffffc0202fbe:	0000e997          	auipc	s3,0xe
ffffffffc0202fc2:	58a98993          	addi	s3,s3,1418 # ffffffffc0211548 <sm>
                    cprintf("swap_out: i %d, store page in vaddr 0x%x to disk swap entry %d\n", i, v, page->pra_vaddr/PGSIZE+1);
ffffffffc0202fc6:	00003b17          	auipc	s6,0x3
ffffffffc0202fca:	b82b0b13          	addi	s6,s6,-1150 # ffffffffc0205b48 <default_pmm_manager+0x990>
                    cprintf("SWAP: failed to save\n");
ffffffffc0202fce:	00003b97          	auipc	s7,0x3
ffffffffc0202fd2:	b62b8b93          	addi	s7,s7,-1182 # ffffffffc0205b30 <default_pmm_manager+0x978>
ffffffffc0202fd6:	a825                	j	ffffffffc020300e <swap_out+0x70>
                    cprintf("swap_out: i %d, store page in vaddr 0x%x to disk swap entry %d\n", i, v, page->pra_vaddr/PGSIZE+1);
ffffffffc0202fd8:	67a2                	ld	a5,8(sp)
ffffffffc0202fda:	8626                	mv	a2,s1
ffffffffc0202fdc:	85a2                	mv	a1,s0
ffffffffc0202fde:	63b4                	ld	a3,64(a5)
ffffffffc0202fe0:	855a                	mv	a0,s6
     for (i = 0; i != n; ++ i)
ffffffffc0202fe2:	2405                	addiw	s0,s0,1
                    cprintf("swap_out: i %d, store page in vaddr 0x%x to disk swap entry %d\n", i, v, page->pra_vaddr/PGSIZE+1);
ffffffffc0202fe4:	82b1                	srli	a3,a3,0xc
ffffffffc0202fe6:	0685                	addi	a3,a3,1
ffffffffc0202fe8:	8d2fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
                    *ptep = (page->pra_vaddr/PGSIZE+1)<<8;
ffffffffc0202fec:	6522                	ld	a0,8(sp)
                    free_page(page);
ffffffffc0202fee:	4585                	li	a1,1
                    *ptep = (page->pra_vaddr/PGSIZE+1)<<8;
ffffffffc0202ff0:	613c                	ld	a5,64(a0)
ffffffffc0202ff2:	83b1                	srli	a5,a5,0xc
ffffffffc0202ff4:	0785                	addi	a5,a5,1
ffffffffc0202ff6:	07a2                	slli	a5,a5,0x8
ffffffffc0202ff8:	00fc3023          	sd	a5,0(s8)
                    free_page(page);
ffffffffc0202ffc:	e56fe0ef          	jal	ra,ffffffffc0201652 <free_pages>
          tlb_invalidate(mm->pgdir, v);
ffffffffc0203000:	01893503          	ld	a0,24(s2)
ffffffffc0203004:	85a6                	mv	a1,s1
ffffffffc0203006:	eb4ff0ef          	jal	ra,ffffffffc02026ba <tlb_invalidate>
     for (i = 0; i != n; ++ i)
ffffffffc020300a:	048a0d63          	beq	s4,s0,ffffffffc0203064 <swap_out+0xc6>
          int r = sm->swap_out_victim(mm, &page, in_tick);
ffffffffc020300e:	0009b783          	ld	a5,0(s3)
ffffffffc0203012:	8656                	mv	a2,s5
ffffffffc0203014:	002c                	addi	a1,sp,8
ffffffffc0203016:	7b9c                	ld	a5,48(a5)
ffffffffc0203018:	854a                	mv	a0,s2
ffffffffc020301a:	9782                	jalr	a5
          if (r != 0) {
ffffffffc020301c:	e12d                	bnez	a0,ffffffffc020307e <swap_out+0xe0>
          v=page->pra_vaddr; 
ffffffffc020301e:	67a2                	ld	a5,8(sp)
          pte_t *ptep = get_pte(mm->pgdir, v, 0);
ffffffffc0203020:	01893503          	ld	a0,24(s2)
ffffffffc0203024:	4601                	li	a2,0
          v=page->pra_vaddr; 
ffffffffc0203026:	63a4                	ld	s1,64(a5)
          pte_t *ptep = get_pte(mm->pgdir, v, 0);
ffffffffc0203028:	85a6                	mv	a1,s1
ffffffffc020302a:	ea2fe0ef          	jal	ra,ffffffffc02016cc <get_pte>
          assert((*ptep & PTE_V) != 0);
ffffffffc020302e:	611c                	ld	a5,0(a0)
          pte_t *ptep = get_pte(mm->pgdir, v, 0);
ffffffffc0203030:	8c2a                	mv	s8,a0
          assert((*ptep & PTE_V) != 0);
ffffffffc0203032:	8b85                	andi	a5,a5,1
ffffffffc0203034:	cfb9                	beqz	a5,ffffffffc0203092 <swap_out+0xf4>
          if (swapfs_write( (page->pra_vaddr/PGSIZE+1)<<8, page) != 0) {
ffffffffc0203036:	65a2                	ld	a1,8(sp)
ffffffffc0203038:	61bc                	ld	a5,64(a1)
ffffffffc020303a:	83b1                	srli	a5,a5,0xc
ffffffffc020303c:	0785                	addi	a5,a5,1
ffffffffc020303e:	00879513          	slli	a0,a5,0x8
ffffffffc0203042:	651000ef          	jal	ra,ffffffffc0203e92 <swapfs_write>
ffffffffc0203046:	d949                	beqz	a0,ffffffffc0202fd8 <swap_out+0x3a>
                    cprintf("SWAP: failed to save\n");
ffffffffc0203048:	855e                	mv	a0,s7
ffffffffc020304a:	870fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
                    sm->map_swappable(mm, v, page, 0);
ffffffffc020304e:	0009b783          	ld	a5,0(s3)
ffffffffc0203052:	6622                	ld	a2,8(sp)
ffffffffc0203054:	4681                	li	a3,0
ffffffffc0203056:	739c                	ld	a5,32(a5)
ffffffffc0203058:	85a6                	mv	a1,s1
ffffffffc020305a:	854a                	mv	a0,s2
     for (i = 0; i != n; ++ i)
ffffffffc020305c:	2405                	addiw	s0,s0,1
                    sm->map_swappable(mm, v, page, 0);
ffffffffc020305e:	9782                	jalr	a5
     for (i = 0; i != n; ++ i)
ffffffffc0203060:	fa8a17e3          	bne	s4,s0,ffffffffc020300e <swap_out+0x70>
}
ffffffffc0203064:	60e6                	ld	ra,88(sp)
ffffffffc0203066:	8522                	mv	a0,s0
ffffffffc0203068:	6446                	ld	s0,80(sp)
ffffffffc020306a:	64a6                	ld	s1,72(sp)
ffffffffc020306c:	6906                	ld	s2,64(sp)
ffffffffc020306e:	79e2                	ld	s3,56(sp)
ffffffffc0203070:	7a42                	ld	s4,48(sp)
ffffffffc0203072:	7aa2                	ld	s5,40(sp)
ffffffffc0203074:	7b02                	ld	s6,32(sp)
ffffffffc0203076:	6be2                	ld	s7,24(sp)
ffffffffc0203078:	6c42                	ld	s8,16(sp)
ffffffffc020307a:	6125                	addi	sp,sp,96
ffffffffc020307c:	8082                	ret
                    cprintf("i %d, swap_out: call swap_out_victim failed\n",i);
ffffffffc020307e:	85a2                	mv	a1,s0
ffffffffc0203080:	00003517          	auipc	a0,0x3
ffffffffc0203084:	a6850513          	addi	a0,a0,-1432 # ffffffffc0205ae8 <default_pmm_manager+0x930>
ffffffffc0203088:	832fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
                  break;
ffffffffc020308c:	bfe1                	j	ffffffffc0203064 <swap_out+0xc6>
     for (i = 0; i != n; ++ i)
ffffffffc020308e:	4401                	li	s0,0
ffffffffc0203090:	bfd1                	j	ffffffffc0203064 <swap_out+0xc6>
          assert((*ptep & PTE_V) != 0);
ffffffffc0203092:	00003697          	auipc	a3,0x3
ffffffffc0203096:	a8668693          	addi	a3,a3,-1402 # ffffffffc0205b18 <default_pmm_manager+0x960>
ffffffffc020309a:	00002617          	auipc	a2,0x2
ffffffffc020309e:	d6e60613          	addi	a2,a2,-658 # ffffffffc0204e08 <commands+0x738>
ffffffffc02030a2:	06600593          	li	a1,102
ffffffffc02030a6:	00002517          	auipc	a0,0x2
ffffffffc02030aa:	7ba50513          	addi	a0,a0,1978 # ffffffffc0205860 <default_pmm_manager+0x6a8>
ffffffffc02030ae:	ac6fd0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02030b2 <swap_in>:
{
ffffffffc02030b2:	7179                	addi	sp,sp,-48
ffffffffc02030b4:	e84a                	sd	s2,16(sp)
ffffffffc02030b6:	892a                	mv	s2,a0
     struct Page *result = alloc_page();
ffffffffc02030b8:	4505                	li	a0,1
{
ffffffffc02030ba:	ec26                	sd	s1,24(sp)
ffffffffc02030bc:	e44e                	sd	s3,8(sp)
ffffffffc02030be:	f406                	sd	ra,40(sp)
ffffffffc02030c0:	f022                	sd	s0,32(sp)
ffffffffc02030c2:	84ae                	mv	s1,a1
ffffffffc02030c4:	89b2                	mv	s3,a2
     struct Page *result = alloc_page();
ffffffffc02030c6:	cfafe0ef          	jal	ra,ffffffffc02015c0 <alloc_pages>
     assert(result!=NULL);
ffffffffc02030ca:	c129                	beqz	a0,ffffffffc020310c <swap_in+0x5a>
     pte_t *ptep = get_pte(mm->pgdir, addr, 0);
ffffffffc02030cc:	842a                	mv	s0,a0
ffffffffc02030ce:	01893503          	ld	a0,24(s2)
ffffffffc02030d2:	4601                	li	a2,0
ffffffffc02030d4:	85a6                	mv	a1,s1
ffffffffc02030d6:	df6fe0ef          	jal	ra,ffffffffc02016cc <get_pte>
ffffffffc02030da:	892a                	mv	s2,a0
     if ((r = swapfs_read((*ptep), result)) != 0)
ffffffffc02030dc:	6108                	ld	a0,0(a0)
ffffffffc02030de:	85a2                	mv	a1,s0
ffffffffc02030e0:	519000ef          	jal	ra,ffffffffc0203df8 <swapfs_read>
     cprintf("swap_in: load disk swap entry %d with swap_page in vadr 0x%x\n", (*ptep)>>8, addr);
ffffffffc02030e4:	00093583          	ld	a1,0(s2)
ffffffffc02030e8:	8626                	mv	a2,s1
ffffffffc02030ea:	00003517          	auipc	a0,0x3
ffffffffc02030ee:	aae50513          	addi	a0,a0,-1362 # ffffffffc0205b98 <default_pmm_manager+0x9e0>
ffffffffc02030f2:	81a1                	srli	a1,a1,0x8
ffffffffc02030f4:	fc7fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
}
ffffffffc02030f8:	70a2                	ld	ra,40(sp)
     *ptr_result=result;
ffffffffc02030fa:	0089b023          	sd	s0,0(s3)
}
ffffffffc02030fe:	7402                	ld	s0,32(sp)
ffffffffc0203100:	64e2                	ld	s1,24(sp)
ffffffffc0203102:	6942                	ld	s2,16(sp)
ffffffffc0203104:	69a2                	ld	s3,8(sp)
ffffffffc0203106:	4501                	li	a0,0
ffffffffc0203108:	6145                	addi	sp,sp,48
ffffffffc020310a:	8082                	ret
     assert(result!=NULL);
ffffffffc020310c:	00003697          	auipc	a3,0x3
ffffffffc0203110:	a7c68693          	addi	a3,a3,-1412 # ffffffffc0205b88 <default_pmm_manager+0x9d0>
ffffffffc0203114:	00002617          	auipc	a2,0x2
ffffffffc0203118:	cf460613          	addi	a2,a2,-780 # ffffffffc0204e08 <commands+0x738>
ffffffffc020311c:	07c00593          	li	a1,124
ffffffffc0203120:	00002517          	auipc	a0,0x2
ffffffffc0203124:	74050513          	addi	a0,a0,1856 # ffffffffc0205860 <default_pmm_manager+0x6a8>
ffffffffc0203128:	a4cfd0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc020312c <_fifo_init_mm>:
    elm->prev = elm->next = elm;
ffffffffc020312c:	0000e797          	auipc	a5,0xe
ffffffffc0203130:	fbc78793          	addi	a5,a5,-68 # ffffffffc02110e8 <pra_list_head>
 */
static int
...
ffffffffc0203134:	f51c                	sd	a5,40(a0)
ffffffffc0203136:	e79c                	sd	a5,8(a5)
ffffffffc0203138:	e39c                	sd	a5,0(a5)
...
ffffffffc020313e:	4501                	li	a0,0
ffffffffc0203140:	8082                	ret

ffffffffc0203142 <_fifo_set_unswappable>:
...
ffffffffc0203146 <_fifo_tick_event>:

static int
_fifo_tick_event(struct mm_struct *mm)
{ return 0; }
ffffffffc0203146:	4501                	li	a0,0
ffffffffc0203148:	8082                	ret

ffffffffc020314a <_fifo_check_swap>:
_fifo_check_swap(void) {
ffffffffc020314a:	711d                	addi	sp,sp,-96
ffffffffc020314c:	fc4e                	sd	s3,56(sp)
ffffffffc020314e:	f852                	sd	s4,48(sp)
    cprintf("write Virt Page c in fifo_check_swap\n");
ffffffffc0203150:	00003517          	auipc	a0,0x3
ffffffffc0203154:	a8850513          	addi	a0,a0,-1400 # ffffffffc0205bd8 <default_pmm_manager+0xa20>
    *(unsigned char *)0x3000 = 0x0c;
ffffffffc0203158:	698d                	lui	s3,0x3
ffffffffc020315a:	4a31                	li	s4,12
_fifo_check_swap(void) {
ffffffffc020315c:	e0ca                	sd	s2,64(sp)
ffffffffc020315e:	ec86                	sd	ra,88(sp)
ffffffffc0203160:	e8a2                	sd	s0,80(sp)
ffffffffc0203162:	e4a6                	sd	s1,72(sp)
ffffffffc0203164:	f456                	sd	s5,40(sp)
ffffffffc0203166:	f05a                	sd	s6,32(sp)
ffffffffc0203168:	ec5e                	sd	s7,24(sp)
ffffffffc020316a:	e862                	sd	s8,16(sp)
ffffffffc020316c:	e466                	sd	s9,8(sp)
ffffffffc020316e:	e06a                	sd	s10,0(sp)
    cprintf("write Virt Page c in fifo_check_swap\n");
ffffffffc0203170:	f4bfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    *(unsigned char *)0x3000 = 0x0c;
ffffffffc0203174:	01498023          	sb	s4,0(s3) # 3000 <kern_entry-0xffffffffc01fd000>
    assert(pgfault_num==4);
ffffffffc0203178:	0000e917          	auipc	s2,0xe
ffffffffc020317c:	3e892903          	lw	s2,1000(s2) # ffffffffc0211560 <pgfault_num>
ffffffffc0203180:	4791                	li	a5,4
ffffffffc0203182:	14f91e63          	bne	s2,a5,ffffffffc02032de <_fifo_check_swap+0x194>
    cprintf("write Virt Page a in fifo_check_swap\n");
ffffffffc0203186:	00003517          	auipc	a0,0x3
ffffffffc020318a:	a9250513          	addi	a0,a0,-1390 # ffffffffc0205c18 <default_pmm_manager+0xa60>
    *(unsigned char *)0x1000 = 0x0a;
ffffffffc020318e:	6a85                	lui	s5,0x1
ffffffffc0203190:	4b29                	li	s6,10
    cprintf("write Virt Page a in fifo_check_swap\n");
ffffffffc0203192:	f29fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
ffffffffc0203196:	0000e417          	auipc	s0,0xe
ffffffffc020319a:	3ca40413          	addi	s0,s0,970 # ffffffffc0211560 <pgfault_num>
    *(unsigned char *)0x1000 = 0x0a;
ffffffffc020319e:	016a8023          	sb	s6,0(s5) # 1000 <kern_entry-0xffffffffc01ff000>
    assert(pgfault_num==4);
ffffffffc02031a2:	4004                	lw	s1,0(s0)
ffffffffc02031a4:	2481                	sext.w	s1,s1
ffffffffc02031a6:	2b249c63          	bne	s1,s2,ffffffffc020345e <_fifo_check_swap+0x314>
    cprintf("write Virt Page d in fifo_check_swap\n");
ffffffffc02031aa:	00003517          	auipc	a0,0x3
ffffffffc02031ae:	a9650513          	addi	a0,a0,-1386 # ffffffffc0205c40 <default_pmm_manager+0xa88>
    *(unsigned char *)0x4000 = 0x0d;
ffffffffc02031b2:	6b91                	lui	s7,0x4
ffffffffc02031b4:	4c35                	li	s8,13
    cprintf("write Virt Page d in fifo_check_swap\n");
ffffffffc02031b6:	f05fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    *(unsigned char *)0x4000 = 0x0d;
ffffffffc02031ba:	018b8023          	sb	s8,0(s7) # 4000 <kern_entry-0xffffffffc01fc000>
    assert(pgfault_num==4);
ffffffffc02031be:	00042903          	lw	s2,0(s0)
ffffffffc02031c2:	2901                	sext.w	s2,s2
ffffffffc02031c4:	26991d63          	bne	s2,s1,ffffffffc020343e <_fifo_check_swap+0x2f4>
    cprintf("write Virt Page b in fifo_check_swap\n");
ffffffffc02031c8:	00003517          	auipc	a0,0x3
ffffffffc02031cc:	aa050513          	addi	a0,a0,-1376 # ffffffffc0205c68 <default_pmm_manager+0xab0>
    *(unsigned char *)0x2000 = 0x0b;
ffffffffc02031d0:	6c89                	lui	s9,0x2
ffffffffc02031d2:	4d2d                	li	s10,11
    cprintf("write Virt Page b in fifo_check_swap\n");
ffffffffc02031d4:	ee7fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    *(unsigned char *)0x2000 = 0x0b;
ffffffffc02031d8:	01ac8023          	sb	s10,0(s9) # 2000 <kern_entry-0xffffffffc01fe000>
    assert(pgfault_num==4);
ffffffffc02031dc:	401c                	lw	a5,0(s0)
ffffffffc02031de:	2781                	sext.w	a5,a5
ffffffffc02031e0:	23279f63          	bne	a5,s2,ffffffffc020341e <_fifo_check_swap+0x2d4>
    cprintf("write Virt Page e in fifo_check_swap\n");
ffffffffc02031e4:	00003517          	auipc	a0,0x3
ffffffffc02031e8:	aac50513          	addi	a0,a0,-1364 # ffffffffc0205c90 <default_pmm_manager+0xad8>
ffffffffc02031ec:	ecffc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    *(unsigned char *)0x5000 = 0x0e;
ffffffffc02031f0:	6795                	lui	a5,0x5
ffffffffc02031f2:	4739                	li	a4,14
ffffffffc02031f4:	00e78023          	sb	a4,0(a5) # 5000 <kern_entry-0xffffffffc01fb000>
    assert(pgfault_num==5);
ffffffffc02031f8:	4004                	lw	s1,0(s0)
ffffffffc02031fa:	4795                	li	a5,5
ffffffffc02031fc:	2481                	sext.w	s1,s1
ffffffffc02031fe:	20f49063          	bne	s1,a5,ffffffffc02033fe <_fifo_check_swap+0x2b4>
    cprintf("write Virt Page b in fifo_check_swap\n");
ffffffffc0203202:	00003517          	auipc	a0,0x3
ffffffffc0203206:	a6650513          	addi	a0,a0,-1434 # ffffffffc0205c68 <default_pmm_manager+0xab0>
ffffffffc020320a:	eb1fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    *(unsigned char *)0x2000 = 0x0b;
ffffffffc020320e:	01ac8023          	sb	s10,0(s9)
    assert(pgfault_num==5);
ffffffffc0203212:	401c                	lw	a5,0(s0)
ffffffffc0203214:	2781                	sext.w	a5,a5
ffffffffc0203216:	1c979463          	bne	a5,s1,ffffffffc02033de <_fifo_check_swap+0x294>
    cprintf("write Virt Page a in fifo_check_swap\n");
ffffffffc020321a:	00003517          	auipc	a0,0x3
ffffffffc020321e:	9fe50513          	addi	a0,a0,-1538 # ffffffffc0205c18 <default_pmm_manager+0xa60>
ffffffffc0203222:	e99fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    *(unsigned char *)0x1000 = 0x0a;
ffffffffc0203226:	016a8023          	sb	s6,0(s5)
    assert(pgfault_num==6);
ffffffffc020322a:	401c                	lw	a5,0(s0)
ffffffffc020322c:	4719                	li	a4,6
ffffffffc020322e:	2781                	sext.w	a5,a5
ffffffffc0203230:	18e79763          	bne	a5,a4,ffffffffc02033be <_fifo_check_swap+0x274>
    cprintf("write Virt Page b in fifo_check_swap\n");
ffffffffc0203234:	00003517          	auipc	a0,0x3
ffffffffc0203238:	a3450513          	addi	a0,a0,-1484 # ffffffffc0205c68 <default_pmm_manager+0xab0>
ffffffffc020323c:	e7ffc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    *(unsigned char *)0x2000 = 0x0b;
ffffffffc0203240:	01ac8023          	sb	s10,0(s9)
    assert(pgfault_num==7);
ffffffffc0203244:	401c                	lw	a5,0(s0)
ffffffffc0203246:	471d                	li	a4,7
ffffffffc0203248:	2781                	sext.w	a5,a5
ffffffffc020324a:	14e79a63          	bne	a5,a4,ffffffffc020339e <_fifo_check_swap+0x254>
    cprintf("write Virt Page c in fifo_check_swap\n");
ffffffffc020324e:	00003517          	auipc	a0,0x3
ffffffffc0203252:	98a50513          	addi	a0,a0,-1654 # ffffffffc0205bd8 <default_pmm_manager+0xa20>
ffffffffc0203256:	e65fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    *(unsigned char *)0x3000 = 0x0c;
ffffffffc020325a:	01498023          	sb	s4,0(s3)
    assert(pgfault_num==8);
ffffffffc020325e:	401c                	lw	a5,0(s0)
ffffffffc0203260:	4721                	li	a4,8
ffffffffc0203262:	2781                	sext.w	a5,a5
ffffffffc0203264:	10e79d63          	bne	a5,a4,ffffffffc020337e <_fifo_check_swap+0x234>
    cprintf("write Virt Page d in fifo_check_swap\n");
ffffffffc0203268:	00003517          	auipc	a0,0x3
ffffffffc020326c:	9d850513          	addi	a0,a0,-1576 # ffffffffc0205c40 <default_pmm_manager+0xa88>
ffffffffc0203270:	e4bfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    *(unsigned char *)0x4000 = 0x0d;
ffffffffc0203274:	018b8023          	sb	s8,0(s7)
    assert(pgfault_num==9);
ffffffffc0203278:	401c                	lw	a5,0(s0)
ffffffffc020327a:	4725                	li	a4,9
ffffffffc020327c:	2781                	sext.w	a5,a5
ffffffffc020327e:	0ee79063          	bne	a5,a4,ffffffffc020335e <_fifo_check_swap+0x214>
    cprintf("write Virt Page e in fifo_check_swap\n");
ffffffffc0203282:	00003517          	auipc	a0,0x3
ffffffffc0203286:	a0e50513          	addi	a0,a0,-1522 # ffffffffc0205c90 <default_pmm_manager+0xad8>
ffffffffc020328a:	e31fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    *(unsigned char *)0x5000 = 0x0e;
ffffffffc020328e:	6795                	lui	a5,0x5
ffffffffc0203290:	4739                	li	a4,14
ffffffffc0203292:	00e78023          	sb	a4,0(a5) # 5000 <kern_entry-0xffffffffc01fb000>
    assert(pgfault_num==10);
ffffffffc0203296:	4004                	lw	s1,0(s0)
ffffffffc0203298:	47a9                	li	a5,10
ffffffffc020329a:	2481                	sext.w	s1,s1
ffffffffc020329c:	0af49163          	bne	s1,a5,ffffffffc020333e <_fifo_check_swap+0x1f4>
    cprintf("write Virt Page a in fifo_check_swap\n");
ffffffffc02032a0:	00003517          	auipc	a0,0x3
ffffffffc02032a4:	97850513          	addi	a0,a0,-1672 # ffffffffc0205c18 <default_pmm_manager+0xa60>
ffffffffc02032a8:	e13fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc02032ac:	6785                	lui	a5,0x1
ffffffffc02032ae:	0007c783          	lbu	a5,0(a5) # 1000 <kern_entry-0xffffffffc01ff000>
ffffffffc02032b2:	06979663          	bne	a5,s1,ffffffffc020331e <_fifo_check_swap+0x1d4>
    assert(pgfault_num==11);
ffffffffc02032b6:	401c                	lw	a5,0(s0)
ffffffffc02032b8:	472d                	li	a4,11
ffffffffc02032ba:	2781                	sext.w	a5,a5
ffffffffc02032bc:	04e79163          	bne	a5,a4,ffffffffc02032fe <_fifo_check_swap+0x1b4>
}
ffffffffc02032c0:	60e6                	ld	ra,88(sp)
ffffffffc02032c2:	6446                	ld	s0,80(sp)
ffffffffc02032c4:	64a6                	ld	s1,72(sp)
ffffffffc02032c6:	6906                	ld	s2,64(sp)
ffffffffc02032c8:	79e2                	ld	s3,56(sp)
ffffffffc02032ca:	7a42                	ld	s4,48(sp)
ffffffffc02032cc:	7aa2                	ld	s5,40(sp)
ffffffffc02032ce:	7b02                	ld	s6,32(sp)
ffffffffc02032d0:	6be2                	ld	s7,24(sp)
ffffffffc02032d2:	6c42                	ld	s8,16(sp)
ffffffffc02032d4:	6ca2                	ld	s9,8(sp)
ffffffffc02032d6:	6d02                	ld	s10,0(sp)
ffffffffc02032d8:	4501                	li	a0,0
ffffffffc02032da:	6125                	addi	sp,sp,96
ffffffffc02032dc:	8082                	ret
    assert(pgfault_num==4);
ffffffffc02032de:	00002697          	auipc	a3,0x2
ffffffffc02032e2:	74a68693          	addi	a3,a3,1866 # ffffffffc0205a28 <default_pmm_manager+0x870>
ffffffffc02032e6:	00002617          	auipc	a2,0x2
ffffffffc02032ea:	b2260613          	addi	a2,a2,-1246 # ffffffffc0204e08 <commands+0x738>
ffffffffc02032ee:	05500593          	li	a1,85
ffffffffc02032f2:	00003517          	auipc	a0,0x3
ffffffffc02032f6:	90e50513          	addi	a0,a0,-1778 # ffffffffc0205c00 <default_pmm_manager+0xa48>
ffffffffc02032fa:	87afd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==11);
ffffffffc02032fe:	00003697          	auipc	a3,0x3
ffffffffc0203302:	a4268693          	addi	a3,a3,-1470 # ffffffffc0205d40 <default_pmm_manager+0xb88>
ffffffffc0203306:	00002617          	auipc	a2,0x2
ffffffffc020330a:	b0260613          	addi	a2,a2,-1278 # ffffffffc0204e08 <commands+0x738>
ffffffffc020330e:	07700593          	li	a1,119
ffffffffc0203312:	00003517          	auipc	a0,0x3
ffffffffc0203316:	8ee50513          	addi	a0,a0,-1810 # ffffffffc0205c00 <default_pmm_manager+0xa48>
ffffffffc020331a:	85afd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc020331e:	00003697          	auipc	a3,0x3
ffffffffc0203322:	9fa68693          	addi	a3,a3,-1542 # ffffffffc0205d18 <default_pmm_manager+0xb60>
ffffffffc0203326:	00002617          	auipc	a2,0x2
ffffffffc020332a:	ae260613          	addi	a2,a2,-1310 # ffffffffc0204e08 <commands+0x738>
ffffffffc020332e:	07500593          	li	a1,117
ffffffffc0203332:	00003517          	auipc	a0,0x3
ffffffffc0203336:	8ce50513          	addi	a0,a0,-1842 # ffffffffc0205c00 <default_pmm_manager+0xa48>
ffffffffc020333a:	83afd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==10);
ffffffffc020333e:	00003697          	auipc	a3,0x3
ffffffffc0203342:	9ca68693          	addi	a3,a3,-1590 # ffffffffc0205d08 <default_pmm_manager+0xb50>
ffffffffc0203346:	00002617          	auipc	a2,0x2
ffffffffc020334a:	ac260613          	addi	a2,a2,-1342 # ffffffffc0204e08 <commands+0x738>
ffffffffc020334e:	07300593          	li	a1,115
ffffffffc0203352:	00003517          	auipc	a0,0x3
ffffffffc0203356:	8ae50513          	addi	a0,a0,-1874 # ffffffffc0205c00 <default_pmm_manager+0xa48>
ffffffffc020335a:	81afd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==9);
ffffffffc020335e:	00003697          	auipc	a3,0x3
ffffffffc0203362:	99a68693          	addi	a3,a3,-1638 # ffffffffc0205cf8 <default_pmm_manager+0xb40>
ffffffffc0203366:	00002617          	auipc	a2,0x2
ffffffffc020336a:	aa260613          	addi	a2,a2,-1374 # ffffffffc0204e08 <commands+0x738>
ffffffffc020336e:	07000593          	li	a1,112
ffffffffc0203372:	00003517          	auipc	a0,0x3
ffffffffc0203376:	88e50513          	addi	a0,a0,-1906 # ffffffffc0205c00 <default_pmm_manager+0xa48>
ffffffffc020337a:	ffbfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==8);
ffffffffc020337e:	00003697          	auipc	a3,0x3
ffffffffc0203382:	96a68693          	addi	a3,a3,-1686 # ffffffffc0205ce8 <default_pmm_manager+0xb30>
ffffffffc0203386:	00002617          	auipc	a2,0x2
ffffffffc020338a:	a8260613          	addi	a2,a2,-1406 # ffffffffc0204e08 <commands+0x738>
ffffffffc020338e:	06d00593          	li	a1,109
ffffffffc0203392:	00003517          	auipc	a0,0x3
ffffffffc0203396:	86e50513          	addi	a0,a0,-1938 # ffffffffc0205c00 <default_pmm_manager+0xa48>
ffffffffc020339a:	fdbfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==7);
ffffffffc020339e:	00003697          	auipc	a3,0x3
ffffffffc02033a2:	93a68693          	addi	a3,a3,-1734 # ffffffffc0205cd8 <default_pmm_manager+0xb20>
ffffffffc02033a6:	00002617          	auipc	a2,0x2
ffffffffc02033aa:	a6260613          	addi	a2,a2,-1438 # ffffffffc0204e08 <commands+0x738>
ffffffffc02033ae:	06a00593          	li	a1,106
ffffffffc02033b2:	00003517          	auipc	a0,0x3
ffffffffc02033b6:	84e50513          	addi	a0,a0,-1970 # ffffffffc0205c00 <default_pmm_manager+0xa48>
ffffffffc02033ba:	fbbfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==6);
ffffffffc02033be:	00003697          	auipc	a3,0x3
ffffffffc02033c2:	90a68693          	addi	a3,a3,-1782 # ffffffffc0205cc8 <default_pmm_manager+0xb10>
ffffffffc02033c6:	00002617          	auipc	a2,0x2
ffffffffc02033ca:	a4260613          	addi	a2,a2,-1470 # ffffffffc0204e08 <commands+0x738>
ffffffffc02033ce:	06700593          	li	a1,103
ffffffffc02033d2:	00003517          	auipc	a0,0x3
ffffffffc02033d6:	82e50513          	addi	a0,a0,-2002 # ffffffffc0205c00 <default_pmm_manager+0xa48>
ffffffffc02033da:	f9bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02033de:	00003697          	auipc	a3,0x3
ffffffffc02033e2:	8da68693          	addi	a3,a3,-1830 # ffffffffc0205cb8 <default_pmm_manager+0xb00>
ffffffffc02033e6:	00002617          	auipc	a2,0x2
ffffffffc02033ea:	a2260613          	addi	a2,a2,-1502 # ffffffffc0204e08 <commands+0x738>
ffffffffc02033ee:	06400593          	li	a1,100
ffffffffc02033f2:	00003517          	auipc	a0,0x3
ffffffffc02033f6:	80e50513          	addi	a0,a0,-2034 # ffffffffc0205c00 <default_pmm_manager+0xa48>
ffffffffc02033fa:	f7bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02033fe:	00003697          	auipc	a3,0x3
ffffffffc0203402:	8ba68693          	addi	a3,a3,-1862 # ffffffffc0205cb8 <default_pmm_manager+0xb00>
ffffffffc0203406:	00002617          	auipc	a2,0x2
ffffffffc020340a:	a0260613          	addi	a2,a2,-1534 # ffffffffc0204e08 <commands+0x738>
ffffffffc020340e:	06100593          	li	a1,97
ffffffffc0203412:	00002517          	auipc	a0,0x2
ffffffffc0203416:	7ee50513          	addi	a0,a0,2030 # ffffffffc0205c00 <default_pmm_manager+0xa48>
ffffffffc020341a:	f5bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc020341e:	00002697          	auipc	a3,0x2
ffffffffc0203422:	60a68693          	addi	a3,a3,1546 # ffffffffc0205a28 <default_pmm_manager+0x870>
ffffffffc0203426:	00002617          	auipc	a2,0x2
ffffffffc020342a:	9e260613          	addi	a2,a2,-1566 # ffffffffc0204e08 <commands+0x738>
ffffffffc020342e:	05e00593          	li	a1,94
ffffffffc0203432:	00002517          	auipc	a0,0x2
ffffffffc0203436:	7ce50513          	addi	a0,a0,1998 # ffffffffc0205c00 <default_pmm_manager+0xa48>
ffffffffc020343a:	f3bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc020343e:	00002697          	auipc	a3,0x2
ffffffffc0203442:	5ea68693          	addi	a3,a3,1514 # ffffffffc0205a28 <default_pmm_manager+0x870>
ffffffffc0203446:	00002617          	auipc	a2,0x2
ffffffffc020344a:	9c260613          	addi	a2,a2,-1598 # ffffffffc0204e08 <commands+0x738>
ffffffffc020344e:	05b00593          	li	a1,91
ffffffffc0203452:	00002517          	auipc	a0,0x2
ffffffffc0203456:	7ae50513          	addi	a0,a0,1966 # ffffffffc0205c00 <default_pmm_manager+0xa48>
ffffffffc020345a:	f1bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc020345e:	00002697          	auipc	a3,0x2
ffffffffc0203462:	5ca68693          	addi	a3,a3,1482 # ffffffffc0205a28 <default_pmm_manager+0x870>
ffffffffc0203466:	00002617          	auipc	a2,0x2
ffffffffc020346a:	9a260613          	addi	a2,a2,-1630 # ffffffffc0204e08 <commands+0x738>
ffffffffc020346e:	05800593          	li	a1,88
ffffffffc0203472:	00002517          	auipc	a0,0x2
ffffffffc0203476:	78e50513          	addi	a0,a0,1934 # ffffffffc0205c00 <default_pmm_manager+0xa48>
ffffffffc020347a:	efbfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc020347e <_fifo_swap_out_victim>:
     list_entry_t *head=(list_entry_t*) mm->sm_priv;
ffffffffc020347e:	7518                	ld	a4,40(a0)
{
ffffffffc0203480:	1141                	addi	sp,sp,-16
ffffffffc0203482:	e406                	sd	ra,8(sp)
         assert(head != NULL);
ffffffffc0203484:	c731                	beqz	a4,ffffffffc02034d0 <_fifo_swap_out_victim+0x52>
     assert(in_tick==0);
ffffffffc0203486:	e60d                	bnez	a2,ffffffffc02034b0 <_fifo_swap_out_victim+0x32>
    return listelm->prev;
ffffffffc0203488:	631c                	ld	a5,0(a4)
    if (entry != head) {
ffffffffc020348a:	00f70d63          	beq	a4,a5,ffffffffc02034a4 <_fifo_swap_out_victim+0x26>
    __list_del(listelm->prev, listelm->next);
ffffffffc020348e:	6394                	ld	a3,0(a5)
ffffffffc0203490:	6798                	ld	a4,8(a5)
}
ffffffffc0203492:	60a2                	ld	ra,8(sp)
        *ptr_page = le2page(entry, pra_page_link);
ffffffffc0203494:	fd078793          	addi	a5,a5,-48
    prev->next = next;
ffffffffc0203498:	e698                	sd	a4,8(a3)
    next->prev = prev;
ffffffffc020349a:	e314                	sd	a3,0(a4)
ffffffffc020349c:	e19c                	sd	a5,0(a1)
}
ffffffffc020349e:	4501                	li	a0,0
ffffffffc02034a0:	0141                	addi	sp,sp,16
ffffffffc02034a2:	8082                	ret
ffffffffc02034a4:	60a2                	ld	ra,8(sp)
        *ptr_page = NULL;
ffffffffc02034a6:	0005b023          	sd	zero,0(a1) # 1000 <kern_entry-0xffffffffc01ff000>
}
ffffffffc02034aa:	4501                	li	a0,0
ffffffffc02034ac:	0141                	addi	sp,sp,16
ffffffffc02034ae:	8082                	ret
     assert(in_tick==0);
ffffffffc02034b0:	00003697          	auipc	a3,0x3
ffffffffc02034b4:	8b068693          	addi	a3,a3,-1872 # ffffffffc0205d60 <default_pmm_manager+0xba8>
ffffffffc02034b8:	00002617          	auipc	a2,0x2
ffffffffc02034bc:	95060613          	addi	a2,a2,-1712 # ffffffffc0204e08 <commands+0x738>
ffffffffc02034c0:	04300593          	li	a1,67
ffffffffc02034c4:	00002517          	auipc	a0,0x2
ffffffffc02034c8:	73c50513          	addi	a0,a0,1852 # ffffffffc0205c00 <default_pmm_manager+0xa48>
ffffffffc02034cc:	ea9fc0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(head != NULL);
ffffffffc02034d0:	00003697          	auipc	a3,0x3
ffffffffc02034d4:	88068693          	addi	a3,a3,-1920 # ffffffffc0205d50 <default_pmm_manager+0xb98>
ffffffffc02034d8:	00002617          	auipc	a2,0x2
ffffffffc02034dc:	93060613          	addi	a2,a2,-1744 # ffffffffc0204e08 <commands+0x738>
ffffffffc02034e0:	04200593          	li	a1,66
ffffffffc02034e4:	00002517          	auipc	a0,0x2
ffffffffc02034e8:	71c50513          	addi	a0,a0,1820 # ffffffffc0205c00 <default_pmm_manager+0xa48>
ffffffffc02034ec:	e89fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02034f0 <_fifo_map_swappable>:
    list_entry_t *head=(list_entry_t*) mm->sm_priv;
ffffffffc02034f0:	751c                	ld	a5,40(a0)
{
ffffffffc02034f2:	1141                	addi	sp,sp,-16
ffffffffc02034f4:	e406                	sd	ra,8(sp)
    assert(entry != NULL && head != NULL);
ffffffffc02034f6:	c395                	beqz	a5,ffffffffc020351a <_fifo_map_swappable+0x2a>
    __list_add(elm, listelm, listelm->next);
ffffffffc02034f8:	6798                	ld	a4,8(a5)
ffffffffc02034fa:	03060593          	addi	a1,a2,48
    cprintf("curr_ptr %p\n", entry);
ffffffffc02034fe:	00003517          	auipc	a0,0x3
ffffffffc0203502:	89250513          	addi	a0,a0,-1902 # ffffffffc0205d90 <default_pmm_manager+0xbd8>
    prev->next = next->prev = elm;
ffffffffc0203506:	e30c                	sd	a1,0(a4)
ffffffffc0203508:	e78c                	sd	a1,8(a5)
    elm->next = next;
ffffffffc020350a:	fe18                	sd	a4,56(a2)
    elm->prev = prev;
ffffffffc020350c:	fa1c                	sd	a5,48(a2)
...
ffffffffc020351e:	85668693          	addi	a3,a3,-1962 # ffffffffc0205d70 <default_pmm_manager+0xbb8>
ffffffffc0203522:	00002617          	auipc	a2,0x2
ffffffffc0203526:	8e660613          	addi	a2,a2,-1818 # ffffffffc0204e08 <commands+0x738>
ffffffffc020352a:	03200593          	li	a1,50
ffffffffc020352e:	00002517          	auipc	a0,0x2
ffffffffc0203532:	6d250513          	addi	a0,a0,1746 # ffffffffc0205c00 <default_pmm_manager+0xa48>
ffffffffc0203536:	e3ffc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc020353a <check_vma_overlap.part.0>:
}
...
ffffffffc020353a:	1141                	addi	sp,sp,-16
    assert(prev->vm_start < prev->vm_end);
    assert(prev->vm_end <= next->vm_start);
    assert(next->vm_start < next->vm_end);
ffffffffc020353c:	00003697          	auipc	a3,0x3
ffffffffc0203540:	87c68693          	addi	a3,a3,-1924 # ffffffffc0205db8 <default_pmm_manager+0xc00>
ffffffffc0203544:	00002617          	auipc	a2,0x2
ffffffffc0203548:	8c460613          	addi	a2,a2,-1852 # ffffffffc0204e08 <commands+0x738>
ffffffffc020354c:	07d00593          	li	a1,125
ffffffffc0203550:	00003517          	auipc	a0,0x3
ffffffffc0203554:	88850513          	addi	a0,a0,-1912 # ffffffffc0205dd8 <default_pmm_manager+0xc20>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
ffffffffc0203558:	e406                	sd	ra,8(sp)
    assert(next->vm_start < next->vm_end);
ffffffffc020355a:	e1bfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc020355e <mm_create>:
mm_create(void) {
ffffffffc020355e:	1141                	addi	sp,sp,-16
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203560:	03000513          	li	a0,48
mm_create(void) {
ffffffffc0203564:	e022                	sd	s0,0(sp)
ffffffffc0203566:	e406                	sd	ra,8(sp)
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203568:	a10ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc020356c:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc020356e:	c105                	beqz	a0,ffffffffc020358e <mm_create+0x30>
    elm->prev = elm->next = elm;
ffffffffc0203570:	e408                	sd	a0,8(s0)
ffffffffc0203572:	e008                	sd	a0,0(s0)
        mm->mmap_cache = NULL;
ffffffffc0203574:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc0203578:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc020357c:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203580:	0000e797          	auipc	a5,0xe
ffffffffc0203584:	fd07a783          	lw	a5,-48(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc0203588:	eb81                	bnez	a5,ffffffffc0203598 <mm_create+0x3a>
        else mm->sm_priv = NULL;
ffffffffc020358a:	02053423          	sd	zero,40(a0)
}
ffffffffc020358e:	60a2                	ld	ra,8(sp)
ffffffffc0203590:	8522                	mv	a0,s0
ffffffffc0203592:	6402                	ld	s0,0(sp)
ffffffffc0203594:	0141                	addi	sp,sp,16
ffffffffc0203596:	8082                	ret
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203598:	9efff0ef          	jal	ra,ffffffffc0202f86 <swap_init_mm>
}
ffffffffc020359c:	60a2                	ld	ra,8(sp)
ffffffffc020359e:	8522                	mv	a0,s0
ffffffffc02035a0:	6402                	ld	s0,0(sp)
ffffffffc02035a2:	0141                	addi	sp,sp,16
ffffffffc02035a4:	8082                	ret

ffffffffc02035a6 <vma_create>:
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc02035a6:	1101                	addi	sp,sp,-32
ffffffffc02035a8:	e04a                	sd	s2,0(sp)
ffffffffc02035aa:	892a                	mv	s2,a0
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02035ac:	03000513          	li	a0,48
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc02035b0:	e822                	sd	s0,16(sp)
ffffffffc02035b2:	e426                	sd	s1,8(sp)
ffffffffc02035b4:	ec06                	sd	ra,24(sp)
ffffffffc02035b6:	84ae                	mv	s1,a1
ffffffffc02035b8:	8432                	mv	s0,a2
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02035ba:	9beff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (vma != NULL) {
ffffffffc02035be:	c509                	beqz	a0,ffffffffc02035c8 <vma_create+0x22>
        vma->vm_start = vm_start;
ffffffffc02035c0:	01253423          	sd	s2,8(a0)
        vma->vm_end = vm_end;
ffffffffc02035c4:	e904                	sd	s1,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc02035c6:	ed00                	sd	s0,24(a0)
}
ffffffffc02035c8:	60e2                	ld	ra,24(sp)
ffffffffc02035ca:	6442                	ld	s0,16(sp)
ffffffffc02035cc:	64a2                	ld	s1,8(sp)
ffffffffc02035ce:	6902                	ld	s2,0(sp)
...
ffffffffc02035e8:	fe87b703          	ld	a4,-24(a5)
...
ffffffffc0203616:	0105b803          	ld	a6,16(a1)
insert_vma_struct(struct mm_struct *mm, struct vma_struct *vma) {
...
ffffffffc0203680:	ebbff0ef          	jal	ra,ffffffffc020353a <check_vma_overlap.part.0>
    assert(vma->vm_start < vma->vm_end);
ffffffffc0203684:	00002697          	auipc	a3,0x2
ffffffffc0203688:	76468693          	addi	a3,a3,1892 # ffffffffc0205de8 <default_pmm_manager+0xc30>
ffffffffc020368c:	00001617          	auipc	a2,0x1
ffffffffc0203690:	77c60613          	addi	a2,a2,1916 # ffffffffc0204e08 <commands+0x738>
ffffffffc0203694:	08400593          	li	a1,132
ffffffffc0203698:	00002517          	auipc	a0,0x2
ffffffffc020369c:	74050513          	addi	a0,a0,1856 # ffffffffc0205dd8 <default_pmm_manager+0xc20>
ffffffffc02036a0:	cd5fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc02036a4:	00002697          	auipc	a3,0x2
ffffffffc02036a8:	78468693          	addi	a3,a3,1924 # ffffffffc0205e28 <default_pmm_manager+0xc70>
ffffffffc02036ac:	00001617          	auipc	a2,0x1
ffffffffc02036b0:	75c60613          	addi	a2,a2,1884 # ffffffffc0204e08 <commands+0x738>
ffffffffc02036b4:	07c00593          	li	a1,124
ffffffffc02036b8:	00002517          	auipc	a0,0x2
ffffffffc02036bc:	72050513          	addi	a0,a0,1824 # ffffffffc0205dd8 <default_pmm_manager+0xc20>
ffffffffc02036c0:	cb5fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc02036c4:	00002697          	auipc	a3,0x2
ffffffffc02036c8:	74468693          	addi	a3,a3,1860 # ffffffffc0205e08 <default_pmm_manager+0xc50>
ffffffffc02036cc:	00001617          	auipc	a2,0x1
ffffffffc02036d0:	73c60613          	addi	a2,a2,1852 # ffffffffc0204e08 <commands+0x738>
ffffffffc02036d4:	07b00593          	li	a1,123
ffffffffc02036d8:	00002517          	auipc	a0,0x2
ffffffffc02036dc:	70050513          	addi	a0,a0,1792 # ffffffffc0205dd8 <default_pmm_manager+0xc20>
...
ffffffffc02036e8:	842a                	mv	s0,a0
    return listelm->next;
ffffffffc02036ea:	6508                	ld	a0,8(a0)
ffffffffc02036ec:	e406                	sd	ra,8(sp)

    list_entry_t *list = &(mm->mmap_list), *le;
    while ((le = list_next(list)) != list) {
ffffffffc02036ee:	00a40e63          	beq	s0,a0,ffffffffc020370a <mm_destroy+0x26>
    __list_del(listelm->prev, listelm->next);
ffffffffc02036f2:	6118                	ld	a4,0(a0)
ffffffffc02036f4:	651c                	ld	a5,8(a0)
        list_del(le);
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc02036f6:	03000593          	li	a1,48
ffffffffc02036fa:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc02036fc:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc02036fe:	e398                	sd	a4,0(a5)
ffffffffc0203700:	932ff0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc0203704:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203706:	fea416e3          	bne	s0,a0,ffffffffc02036f2 <mm_destroy+0xe>
    }
...
ffffffffc0203714:	0141                	addi	sp,sp,16
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203716:	91cff06f          	j	ffffffffc0202832 <kfree>

ffffffffc020371a <vmm_init>:

// vmm_init - initialize virtual memory management
//          - now just call check_vmm to check correctness of vmm
void
vmm_init(void) {
ffffffffc020371a:	715d                	addi	sp,sp,-80
ffffffffc020371c:	e486                	sd	ra,72(sp)
ffffffffc020371e:	f44e                	sd	s3,40(sp)
ffffffffc0203720:	f052                	sd	s4,32(sp)
ffffffffc0203722:	e0a2                	sd	s0,64(sp)
ffffffffc0203724:	fc26                	sd	s1,56(sp)
ffffffffc0203726:	f84a                	sd	s2,48(sp)
ffffffffc0203728:	ec56                	sd	s5,24(sp)
ffffffffc020372a:	e85a                	sd	s6,16(sp)
ffffffffc020372c:	e45e                	sd	s7,8(sp)
}
...
ffffffffc020372e:	f65fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
...
check_vma_struct(void) {
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc0203734:	f5ffd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203738:	8a2a                	mv	s4,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc020373a:	03000513          	li	a0,48
ffffffffc020373e:	83aff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (mm != NULL) {
ffffffffc0203742:	56050863          	beqz	a0,ffffffffc0203cb2 <vmm_init+0x598>
    elm->prev = elm->next = elm;
ffffffffc0203746:	e508                	sd	a0,8(a0)
ffffffffc0203748:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc020374a:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc020374e:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc0203752:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203756:	0000e797          	auipc	a5,0xe
ffffffffc020375a:	dfa7a783          	lw	a5,-518(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc020375e:	84aa                	mv	s1,a0
ffffffffc0203760:	e7b9                	bnez	a5,ffffffffc02037ae <vmm_init+0x94>
        else mm->sm_priv = NULL;
ffffffffc0203762:	02053423          	sd	zero,40(a0)
vmm_init(void) {
ffffffffc0203766:	03200413          	li	s0,50
ffffffffc020376a:	a811                	j	ffffffffc020377e <vmm_init+0x64>
        vma->vm_start = vm_start;
ffffffffc020376c:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
...
ffffffffc0203770:	00053c23          	sd	zero,24(a0)
    ...
    int i;
    for (i = step1; i >= 1; i --) {
ffffffffc0203774:	146d                	addi	s0,s0,-5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc0203776:	8526                	mv	a0,s1
ffffffffc0203778:	e9dff0ef          	jal	ra,ffffffffc0203614 <insert_vma_struct>
    for (i = step1; i >= 1; i --) {
ffffffffc020377c:	cc05                	beqz	s0,ffffffffc02037b4 <vmm_init+0x9a>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc020377e:	03000513          	li	a0,48
ffffffffc0203782:	ff7fe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203786:	85aa                	mv	a1,a0
ffffffffc0203788:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc020378c:	f165                	bnez	a0,ffffffffc020376c <vmm_init+0x52>
        assert(vma != NULL);
ffffffffc020378e:	00002697          	auipc	a3,0x2
ffffffffc0203792:	15a68693          	addi	a3,a3,346 # ffffffffc02058e8 <default_pmm_manager+0x730>
ffffffffc0203796:	00001617          	auipc	a2,0x1
ffffffffc020379a:	67260613          	addi	a2,a2,1650 # ffffffffc0204e08 <commands+0x738>
ffffffffc020379e:	0ce00593          	li	a1,206
ffffffffc02037a2:	00002517          	auipc	a0,0x2
ffffffffc02037a6:	63650513          	addi	a0,a0,1590 # ffffffffc0205dd8 <default_pmm_manager+0xc20>
ffffffffc02037aa:	bcbfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02037ae:	fd8ff0ef          	jal	ra,ffffffffc0202f86 <swap_init_mm>
ffffffffc02037b2:	bf55                	j	ffffffffc0203766 <vmm_init+0x4c>
ffffffffc02037b4:	03700413          	li	s0,55
    }

    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc02037b8:	1f900913          	li	s2,505
ffffffffc02037bc:	a819                	j	ffffffffc02037d2 <vmm_init+0xb8>
        vma->vm_start = vm_start;
ffffffffc02037be:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc02037c0:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc02037c2:	00053c23          	sd	zero,24(a0)
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc02037c6:	0415                	addi	s0,s0,5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc02037c8:	8526                	mv	a0,s1
ffffffffc02037ca:	e4bff0ef          	jal	ra,ffffffffc0203614 <insert_vma_struct>
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc02037ce:	03240a63          	beq	s0,s2,ffffffffc0203802 <vmm_init+0xe8>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
...
ffffffffc02037dc:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc02037e0:	fd79                	bnez	a0,ffffffffc02037be <vmm_init+0xa4>
        assert(vma != NULL);
ffffffffc02037e2:	00002697          	auipc	a3,0x2
ffffffffc02037e6:	10668693          	addi	a3,a3,262 # ffffffffc02058e8 <default_pmm_manager+0x730>
ffffffffc02037ea:	00001617          	auipc	a2,0x1
ffffffffc02037ee:	61e60613          	addi	a2,a2,1566 # ffffffffc0204e08 <commands+0x738>
ffffffffc02037f2:	0d400593          	li	a1,212
ffffffffc02037f6:	00002517          	auipc	a0,0x2
ffffffffc02037fa:	5e250513          	addi	a0,a0,1506 # ffffffffc0205dd8 <default_pmm_manager+0xc20>
ffffffffc02037fe:	b77fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    return listelm->next;
ffffffffc0203802:	649c                	ld	a5,8(s1)
ffffffffc0203804:	471d                	li	a4,7
    }

    list_entry_t *le = list_next(&(mm->mmap_list));

    for (i = 1; i <= step2; i ++) {
ffffffffc0203806:	1fb00593          	li	a1,507
        assert(le != &(mm->mmap_list));
ffffffffc020380a:	2ef48463          	beq	s1,a5,ffffffffc0203af2 <vmm_init+0x3d8>
        struct vma_struct *mmap = le2vma(le, list_link);
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc020380e:	fe87b603          	ld	a2,-24(a5)
ffffffffc0203812:	ffe70693          	addi	a3,a4,-2
ffffffffc0203816:	26d61e63          	bne	a2,a3,ffffffffc0203a92 <vmm_init+0x378>
ffffffffc020381a:	ff07b683          	ld	a3,-16(a5)
ffffffffc020381e:	26e69a63          	bne	a3,a4,ffffffffc0203a92 <vmm_init+0x378>
    for (i = 1; i <= step2; i ++) {
ffffffffc0203822:	0715                	addi	a4,a4,5
ffffffffc0203824:	679c                	ld	a5,8(a5)
ffffffffc0203826:	feb712e3          	bne	a4,a1,ffffffffc020380a <vmm_init+0xf0>
ffffffffc020382a:	4b1d                	li	s6,7
ffffffffc020382c:	4415                	li	s0,5
        le = list_next(le);
    }

    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc020382e:	1f900b93          	li	s7,505
        struct vma_struct *vma1 = find_vma(mm, i);
ffffffffc0203832:	85a2                	mv	a1,s0
ffffffffc0203834:	8526                	mv	a0,s1
ffffffffc0203836:	d9fff0ef          	jal	ra,ffffffffc02035d4 <find_vma>
ffffffffc020383a:	892a                	mv	s2,a0
        assert(vma1 != NULL);
ffffffffc020383c:	2c050b63          	beqz	a0,ffffffffc0203b12 <vmm_init+0x3f8>
        struct vma_struct *vma2 = find_vma(mm, i+1);
ffffffffc0203840:	00140593          	addi	a1,s0,1
ffffffffc0203844:	8526                	mv	a0,s1
ffffffffc0203846:	d8fff0ef          	jal	ra,ffffffffc02035d4 <find_vma>
ffffffffc020384a:	8aaa                	mv	s5,a0
        assert(vma2 != NULL);
ffffffffc020384c:	2e050363          	beqz	a0,ffffffffc0203b32 <vmm_init+0x418>
        struct vma_struct *vma3 = find_vma(mm, i+2);
ffffffffc0203850:	85da                	mv	a1,s6
ffffffffc0203852:	8526                	mv	a0,s1
ffffffffc0203854:	d81ff0ef          	jal	ra,ffffffffc02035d4 <find_vma>
        assert(vma3 == NULL);
ffffffffc0203858:	2e051d63          	bnez	a0,ffffffffc0203b52 <vmm_init+0x438>
        struct vma_struct *vma4 = find_vma(mm, i+3);
ffffffffc020385c:	00340593          	addi	a1,s0,3
ffffffffc0203860:	8526                	mv	a0,s1
ffffffffc0203862:	d73ff0ef          	jal	ra,ffffffffc02035d4 <find_vma>
        assert(vma4 == NULL);
ffffffffc0203866:	30051663          	bnez	a0,ffffffffc0203b72 <vmm_init+0x458>
        struct vma_struct *vma5 = find_vma(mm, i+4);
ffffffffc020386a:	00440593          	addi	a1,s0,4
ffffffffc020386e:	8526                	mv	a0,s1
ffffffffc0203870:	d65ff0ef          	jal	ra,ffffffffc02035d4 <find_vma>
        assert(vma5 == NULL);
ffffffffc0203874:	30051f63          	bnez	a0,ffffffffc0203b92 <vmm_init+0x478>

        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203878:	00893783          	ld	a5,8(s2)
ffffffffc020387c:	24879b63          	bne	a5,s0,ffffffffc0203ad2 <vmm_init+0x3b8>
ffffffffc0203880:	01093783          	ld	a5,16(s2)
ffffffffc0203884:	25679763          	bne	a5,s6,ffffffffc0203ad2 <vmm_init+0x3b8>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203888:	008ab783          	ld	a5,8(s5)
ffffffffc020388c:	22879363          	bne	a5,s0,ffffffffc0203ab2 <vmm_init+0x398>
ffffffffc0203890:	010ab783          	ld	a5,16(s5)
ffffffffc0203894:	21679f63          	bne	a5,s6,ffffffffc0203ab2 <vmm_init+0x398>
    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc0203898:	0415                	addi	s0,s0,5
ffffffffc020389a:	0b15                	addi	s6,s6,5
ffffffffc020389c:	f9741be3          	bne	s0,s7,ffffffffc0203832 <vmm_init+0x118>
ffffffffc02038a0:	4411                	li	s0,4
    }

    for (i =4; i>=0; i--) {
ffffffffc02038a2:	597d                	li	s2,-1
        struct vma_struct *vma_below_5= find_vma(mm,i);
ffffffffc02038a4:	85a2                	mv	a1,s0
ffffffffc02038a6:	8526                	mv	a0,s1
ffffffffc02038a8:	d2dff0ef          	jal	ra,ffffffffc02035d4 <find_vma>
ffffffffc02038ac:	0004059b          	sext.w	a1,s0
        if (vma_below_5 != NULL ) {
ffffffffc02038b0:	c90d                	beqz	a0,ffffffffc02038e2 <vmm_init+0x1c8>
           cprintf("vma_below_5: i %x, start %x, end %x\n",i, vma_below_5->vm_start, vma_below_5->vm_end); 
ffffffffc02038b2:	6914                	ld	a3,16(a0)
ffffffffc02038b4:	6510                	ld	a2,8(a0)
ffffffffc02038b6:	00002517          	auipc	a0,0x2
ffffffffc02038ba:	69250513          	addi	a0,a0,1682 # ffffffffc0205f48 <default_pmm_manager+0xd90>
ffffffffc02038be:	ffcfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc02038c2:	00002697          	auipc	a3,0x2
ffffffffc02038c6:	6ae68693          	addi	a3,a3,1710 # ffffffffc0205f70 <default_pmm_manager+0xdb8>
ffffffffc02038ca:	00001617          	auipc	a2,0x1
ffffffffc02038ce:	53e60613          	addi	a2,a2,1342 # ffffffffc0204e08 <commands+0x738>
ffffffffc02038d2:	0f600593          	li	a1,246
ffffffffc02038d6:	00002517          	auipc	a0,0x2
ffffffffc02038da:	50250513          	addi	a0,a0,1282 # ffffffffc0205dd8 <default_pmm_manager+0xc20>
ffffffffc02038de:	a97fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    for (i =4; i>=0; i--) {
ffffffffc02038e2:	147d                	addi	s0,s0,-1
ffffffffc02038e4:	fd2410e3          	bne	s0,s2,ffffffffc02038a4 <vmm_init+0x18a>
ffffffffc02038e8:	a811                	j	ffffffffc02038fc <vmm_init+0x1e2>
    __list_del(listelm->prev, listelm->next);
ffffffffc02038ea:	6118                	ld	a4,0(a0)
ffffffffc02038ec:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc02038ee:	03000593          	li	a1,48
ffffffffc02038f2:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc02038f4:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc02038f6:	e398                	sd	a4,0(a5)
ffffffffc02038f8:	f3bfe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc02038fc:	6488                	ld	a0,8(s1)
    while ((le = list_next(list)) != list) {
ffffffffc02038fe:	fea496e3          	bne	s1,a0,ffffffffc02038ea <vmm_init+0x1d0>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203902:	03000593          	li	a1,48
ffffffffc0203906:	8526                	mv	a0,s1
ffffffffc0203908:	f2bfe0ef          	jal	ra,ffffffffc0202832 <kfree>
    }

    mm_destroy(mm);

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc020390c:	d87fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203910:	3caa1163          	bne	s4,a0,ffffffffc0203cd2 <vmm_init+0x5b8>

    cprintf("check_vma_struct() succeeded!\n");
ffffffffc0203914:	00002517          	auipc	a0,0x2
ffffffffc0203918:	69c50513          	addi	a0,a0,1692 # ffffffffc0205fb0 <default_pmm_manager+0xdf8>
ffffffffc020391c:	f9efc0ef          	jal	ra,ffffffffc02000ba <cprintf>
...
check_pgfault(void) {
    ...
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc0203920:	d73fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203924:	84aa                	mv	s1,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203926:	03000513          	li	a0,48
ffffffffc020392a:	e4ffe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc020392e:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc0203930:	2a050163          	beqz	a0,ffffffffc0203bd2 <vmm_init+0x4b8>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203934:	0000e797          	auipc	a5,0xe
ffffffffc0203938:	c1c7a783          	lw	a5,-996(a5) # ffffffffc0211550 <swap_init_ok>
    elm->prev = elm->next = elm;
ffffffffc020393c:	e508                	sd	a0,8(a0)
ffffffffc020393e:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc0203940:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc0203944:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc0203948:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020394c:	14079063          	bnez	a5,ffffffffc0203a8c <vmm_init+0x372>
        else mm->sm_priv = NULL;
ffffffffc0203950:	02053423          	sd	zero,40(a0)
    ...
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc0203954:	0000e917          	auipc	s2,0xe
ffffffffc0203958:	bc493903          	ld	s2,-1084(s2) # ffffffffc0211518 <boot_pgdir>
    assert(pgdir[0] == 0);
ffffffffc020395c:	00093783          	ld	a5,0(s2)
    check_mm_struct = mm_create();
ffffffffc0203960:	0000e717          	auipc	a4,0xe
ffffffffc0203964:	be873c23          	sd	s0,-1032(a4) # ffffffffc0211558 <check_mm_struct>
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc0203968:	01243c23          	sd	s2,24(s0)
    assert(pgdir[0] == 0);
ffffffffc020396c:	24079363          	bnez	a5,ffffffffc0203bb2 <vmm_init+0x498>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203970:	03000513          	li	a0,48
ffffffffc0203974:	e05fe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203978:	8a2a                	mv	s4,a0
    if (vma != NULL) {
ffffffffc020397a:	28050063          	beqz	a0,ffffffffc0203bfa <vmm_init+0x4e0>
        vma->vm_end = vm_end;
ffffffffc020397e:	002007b7          	lui	a5,0x200
ffffffffc0203982:	00fa3823          	sd	a5,16(s4)
        vma->vm_flags = vm_flags;
ffffffffc0203986:	4789                	li	a5,2
    ...
    insert_vma_struct(mm, vma);
ffffffffc0203988:	85aa                	mv	a1,a0
        vma->vm_flags = vm_flags;
ffffffffc020398a:	00fa3c23          	sd	a5,24(s4)
    insert_vma_struct(mm, vma);
ffffffffc020398e:	8522                	mv	a0,s0
        vma->vm_start = vm_start;
ffffffffc0203990:	000a3423          	sd	zero,8(s4)
    insert_vma_struct(mm, vma);
ffffffffc0203994:	c81ff0ef          	jal	ra,ffffffffc0203614 <insert_vma_struct>

    uintptr_t addr = 0x100;
    assert(find_vma(mm, addr) == vma);
ffffffffc0203998:	10000593          	li	a1,256
ffffffffc020399c:	8522                	mv	a0,s0
ffffffffc020399e:	c37ff0ef          	jal	ra,ffffffffc02035d4 <find_vma>
ffffffffc02039a2:	10000793          	li	a5,256

    int i, sum = 0;
    for (i = 0; i < 100; i ++) {
ffffffffc02039a6:	16400713          	li	a4,356
    assert(find_vma(mm, addr) == vma);
ffffffffc02039aa:	26aa1863          	bne	s4,a0,ffffffffc0203c1a <vmm_init+0x500>
        *(char *)(addr + i) = i;
ffffffffc02039ae:	00f78023          	sb	a5,0(a5) # 200000 <kern_entry-0xffffffffc0000000>
    for (i = 0; i < 100; i ++) {
ffffffffc02039b2:	0785                	addi	a5,a5,1
ffffffffc02039b4:	fee79de3          	bne	a5,a4,ffffffffc02039ae <vmm_init+0x294>
        sum += i;
ffffffffc02039b8:	6705                	lui	a4,0x1
ffffffffc02039ba:	10000793          	li	a5,256
ffffffffc02039be:	35670713          	addi	a4,a4,854 # 1356 <kern_entry-0xffffffffc01fecaa>
    }
    for (i = 0; i < 100; i ++) {
ffffffffc02039c2:	16400613          	li	a2,356
        sum -= *(char *)(addr + i);
ffffffffc02039c6:	0007c683          	lbu	a3,0(a5)
    for (i = 0; i < 100; i ++) {
ffffffffc02039ca:	0785                	addi	a5,a5,1
        sum -= *(char *)(addr + i);
ffffffffc02039cc:	9f15                	subw	a4,a4,a3
    for (i = 0; i < 100; i ++) {
ffffffffc02039ce:	fec79ce3          	bne	a5,a2,ffffffffc02039c6 <vmm_init+0x2ac>
    }
    assert(sum == 0);
ffffffffc02039d2:	26071463          	bnez	a4,ffffffffc0203c3a <vmm_init+0x520>

    page_remove(pgdir, ROUNDDOWN(addr, PGSIZE));
ffffffffc02039d6:	4581                	li	a1,0
ffffffffc02039d8:	854a                	mv	a0,s2
ffffffffc02039da:	f43fd0ef          	jal	ra,ffffffffc020191c <page_remove>
    return pa2page(PDE_ADDR(pde));
ffffffffc02039de:	00093783          	ld	a5,0(s2)
    if (PPN(pa) >= npage) {
ffffffffc02039e2:	0000e717          	auipc	a4,0xe
ffffffffc02039e6:	b3e73703          	ld	a4,-1218(a4) # ffffffffc0211520 <npage>
    return pa2page(PDE_ADDR(pde));
ffffffffc02039ea:	078a                	slli	a5,a5,0x2
ffffffffc02039ec:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc02039ee:	26e7f663          	bgeu	a5,a4,ffffffffc0203c5a <vmm_init+0x540>
    return &pages[PPN(pa) - nbase];
ffffffffc02039f2:	00003717          	auipc	a4,0x3
ffffffffc02039f6:	98673703          	ld	a4,-1658(a4) # ffffffffc0206378 <nbase>
ffffffffc02039fa:	8f99                	sub	a5,a5,a4
ffffffffc02039fc:	00379713          	slli	a4,a5,0x3
ffffffffc0203a00:	97ba                	add	a5,a5,a4
ffffffffc0203a02:	078e                	slli	a5,a5,0x3

    free_page(pde2page(pgdir[0]));
ffffffffc0203a04:	0000e517          	auipc	a0,0xe
ffffffffc0203a08:	b2453503          	ld	a0,-1244(a0) # ffffffffc0211528 <pages>
ffffffffc0203a0c:	953e                	add	a0,a0,a5
ffffffffc0203a0e:	4585                	li	a1,1
ffffffffc0203a10:	c43fd0ef          	jal	ra,ffffffffc0201652 <free_pages>
    return listelm->next;
ffffffffc0203a14:	6408                	ld	a0,8(s0)

    pgdir[0] = 0;
ffffffffc0203a16:	00093023          	sd	zero,0(s2)

    mm->pgdir = NULL;
ffffffffc0203a1a:	00043c23          	sd	zero,24(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203a1e:	00a40e63          	beq	s0,a0,ffffffffc0203a3a <vmm_init+0x320>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203a22:	6118                	ld	a4,0(a0)
ffffffffc0203a24:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc0203a26:	03000593          	li	a1,48
ffffffffc0203a2a:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203a2c:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203a2e:	e398                	sd	a4,0(a5)
ffffffffc0203a30:	e03fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc0203a34:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203a36:	fea416e3          	bne	s0,a0,ffffffffc0203a22 <vmm_init+0x308>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203a3a:	03000593          	li	a1,48
ffffffffc0203a3e:	8522                	mv	a0,s0
ffffffffc0203a40:	df3fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    mm_destroy(mm);

    check_mm_struct = NULL;
    nr_free_pages_store--;	// szx : Sv39第二级页表多占了一个内存页，所以执行此操作
ffffffffc0203a44:	14fd                	addi	s1,s1,-1
    check_mm_struct = NULL;
ffffffffc0203a46:	0000e797          	auipc	a5,0xe
ffffffffc0203a4a:	b007b923          	sd	zero,-1262(a5) # ffffffffc0211558 <check_mm_struct>

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a4e:	c45fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203a52:	22a49063          	bne	s1,a0,ffffffffc0203c72 <vmm_init+0x558>

    cprintf("check_pgfault() succeeded!\n");
ffffffffc0203a56:	00002517          	auipc	a0,0x2
ffffffffc0203a5a:	5aa50513          	addi	a0,a0,1450 # ffffffffc0206000 <default_pmm_manager+0xe48>
ffffffffc0203a5e:	e5cfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a62:	c31fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
    nr_free_pages_store--;	// szx : Sv39三级页表多占一个内存页，所以执行此操作
ffffffffc0203a66:	19fd                	addi	s3,s3,-1
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a68:	22a99563          	bne	s3,a0,ffffffffc0203c92 <vmm_init+0x578>
}
ffffffffc0203a6c:	6406                	ld	s0,64(sp)
ffffffffc0203a6e:	60a6                	ld	ra,72(sp)
ffffffffc0203a70:	74e2                	ld	s1,56(sp)
ffffffffc0203a72:	7942                	ld	s2,48(sp)
ffffffffc0203a74:	79a2                	ld	s3,40(sp)
ffffffffc0203a76:	7a02                	ld	s4,32(sp)
ffffffffc0203a78:	6ae2                	ld	s5,24(sp)
ffffffffc0203a7a:	6b42                	ld	s6,16(sp)
ffffffffc0203a7c:	6ba2                	ld	s7,8(sp)
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203a7e:	00002517          	auipc	a0,0x2
ffffffffc0203a82:	5a250513          	addi	a0,a0,1442 # ffffffffc0206020 <default_pmm_manager+0xe68>
}
ffffffffc0203a86:	6161                	addi	sp,sp,80
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203a88:	e32fc06f          	j	ffffffffc02000ba <cprintf>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203a8c:	cfaff0ef          	jal	ra,ffffffffc0202f86 <swap_init_mm>
ffffffffc0203a90:	b5d1                	j	ffffffffc0203954 <vmm_init+0x23a>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203a92:	00002697          	auipc	a3,0x2
ffffffffc0203a96:	3ce68693          	addi	a3,a3,974 # ffffffffc0205e60 <default_pmm_manager+0xca8>
ffffffffc0203a9a:	00001617          	auipc	a2,0x1
ffffffffc0203a9e:	36e60613          	addi	a2,a2,878 # ffffffffc0204e08 <commands+0x738>
ffffffffc0203aa2:	0dd00593          	li	a1,221
ffffffffc0203aa6:	00002517          	auipc	a0,0x2
ffffffffc0203aaa:	33250513          	addi	a0,a0,818 # ffffffffc0205dd8 <default_pmm_manager+0xc20>
ffffffffc0203aae:	8c7fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203ab2:	00002697          	auipc	a3,0x2
ffffffffc0203ab6:	46668693          	addi	a3,a3,1126 # ffffffffc0205f18 <default_pmm_manager+0xd60>
ffffffffc0203aba:	00001617          	auipc	a2,0x1
ffffffffc0203abe:	34e60613          	addi	a2,a2,846 # ffffffffc0204e08 <commands+0x738>
ffffffffc0203ac2:	0ee00593          	li	a1,238
ffffffffc0203ac6:	00002517          	auipc	a0,0x2
ffffffffc0203aca:	31250513          	addi	a0,a0,786 # ffffffffc0205dd8 <default_pmm_manager+0xc20>
ffffffffc0203ace:	8a7fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203ad2:	00002697          	auipc	a3,0x2
ffffffffc0203ad6:	41668693          	addi	a3,a3,1046 # ffffffffc0205ee8 <default_pmm_manager+0xd30>
ffffffffc0203ada:	00001617          	auipc	a2,0x1
ffffffffc0203ade:	32e60613          	addi	a2,a2,814 # ffffffffc0204e08 <commands+0x738>
ffffffffc0203ae2:	0ed00593          	li	a1,237
ffffffffc0203ae6:	00002517          	auipc	a0,0x2
ffffffffc0203aea:	2f250513          	addi	a0,a0,754 # ffffffffc0205dd8 <default_pmm_manager+0xc20>
ffffffffc0203aee:	887fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203af2:	00002697          	auipc	a3,0x2
ffffffffc0203af6:	35668693          	addi	a3,a3,854 # ffffffffc0205e48 <default_pmm_manager+0xc90>
ffffffffc0203afa:	00001617          	auipc	a2,0x1
ffffffffc0203afe:	30e60613          	addi	a2,a2,782 # ffffffffc0204e08 <commands+0x738>
ffffffffc0203b02:	0db00593          	li	a1,219
ffffffffc0203b06:	00002517          	auipc	a0,0x2
ffffffffc0203b0a:	2d250513          	addi	a0,a0,722 # ffffffffc0205dd8 <default_pmm_manager+0xc20>
ffffffffc0203b0e:	867fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1 != NULL);
ffffffffc0203b12:	00002697          	auipc	a3,0x2
ffffffffc0203b16:	38668693          	addi	a3,a3,902 # ffffffffc0205e98 <default_pmm_manager+0xce0>
ffffffffc0203b1a:	00001617          	auipc	a2,0x1
ffffffffc0203b1e:	2ee60613          	addi	a2,a2,750 # ffffffffc0204e08 <commands+0x738>
ffffffffc0203b22:	0e300593          	li	a1,227
ffffffffc0203b26:	00002517          	auipc	a0,0x2
ffffffffc0203b2a:	2b250513          	addi	a0,a0,690 # ffffffffc0205dd8 <default_pmm_manager+0xc20>
ffffffffc0203b2e:	847fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2 != NULL);
ffffffffc0203b32:	00002697          	auipc	a3,0x2
ffffffffc0203b36:	37668693          	addi	a3,a3,886 # ffffffffc0205ea8 <default_pmm_manager+0xcf0>
ffffffffc0203b3a:	00001617          	auipc	a2,0x1
ffffffffc0203b3e:	2ce60613          	addi	a2,a2,718 # ffffffffc0204e08 <commands+0x738>
ffffffffc0203b42:	0e500593          	li	a1,229
ffffffffc0203b46:	00002517          	auipc	a0,0x2
ffffffffc0203b4a:	29250513          	addi	a0,a0,658 # ffffffffc0205dd8 <default_pmm_manager+0xc20>
ffffffffc0203b4e:	827fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma3 == NULL);
ffffffffc0203b52:	00002697          	auipc	a3,0x2
ffffffffc0203b56:	36668693          	addi	a3,a3,870 # ffffffffc0205eb8 <default_pmm_manager+0xd00>
ffffffffc0203b5a:	00001617          	auipc	a2,0x1
ffffffffc0203b5e:	2ae60613          	addi	a2,a2,686 # ffffffffc0204e08 <commands+0x738>
ffffffffc0203b62:	0e700593          	li	a1,231
ffffffffc0203b66:	00002517          	auipc	a0,0x2
ffffffffc0203b6a:	27250513          	addi	a0,a0,626 # ffffffffc0205dd8 <default_pmm_manager+0xc20>
ffffffffc0203b6e:	807fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma4 == NULL);
ffffffffc0203b72:	00002697          	auipc	a3,0x2
ffffffffc0203b76:	35668693          	addi	a3,a3,854 # ffffffffc0205ec8 <default_pmm_manager+0xd10>
ffffffffc0203b7a:	00001617          	auipc	a2,0x1
ffffffffc0203b7e:	28e60613          	addi	a2,a2,654 # ffffffffc0204e08 <commands+0x738>
ffffffffc0203b82:	0e900593          	li	a1,233
ffffffffc0203b86:	00002517          	auipc	a0,0x2
ffffffffc0203b8a:	25250513          	addi	a0,a0,594 # ffffffffc0205dd8 <default_pmm_manager+0xc20>
ffffffffc0203b8e:	fe6fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma5 == NULL);
ffffffffc0203b92:	00002697          	auipc	a3,0x2
ffffffffc0203b96:	34668693          	addi	a3,a3,838 # ffffffffc0205ed8 <default_pmm_manager+0xd20>
ffffffffc0203b9a:	00001617          	auipc	a2,0x1
ffffffffc0203b9e:	26e60613          	addi	a2,a2,622 # ffffffffc0204e08 <commands+0x738>
ffffffffc0203ba2:	0eb00593          	li	a1,235
ffffffffc0203ba6:	00002517          	auipc	a0,0x2
ffffffffc0203baa:	23250513          	addi	a0,a0,562 # ffffffffc0205dd8 <default_pmm_manager+0xc20>
ffffffffc0203bae:	fc6fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203bb2:	00002697          	auipc	a3,0x2
ffffffffc0203bb6:	d2668693          	addi	a3,a3,-730 # ffffffffc02058d8 <default_pmm_manager+0x720>
ffffffffc0203bba:	00001617          	auipc	a2,0x1
ffffffffc0203bbe:	24e60613          	addi	a2,a2,590 # ffffffffc0204e08 <commands+0x738>
ffffffffc0203bc2:	10d00593          	li	a1,269
ffffffffc0203bc6:	00002517          	auipc	a0,0x2
ffffffffc0203bca:	21250513          	addi	a0,a0,530 # ffffffffc0205dd8 <default_pmm_manager+0xc20>
ffffffffc0203bce:	fa6fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203bd2:	00002697          	auipc	a3,0x2
ffffffffc0203bd6:	46668693          	addi	a3,a3,1126 # ffffffffc0206038 <default_pmm_manager+0xe80>
ffffffffc0203bda:	00001617          	auipc	a2,0x1
ffffffffc0203bde:	22e60613          	addi	a2,a2,558 # ffffffffc0204e08 <commands+0x738>
ffffffffc0203be2:	10a00593          	li	a1,266
ffffffffc0203be6:	00002517          	auipc	a0,0x2
ffffffffc0203bea:	1f250513          	addi	a0,a0,498 # ffffffffc0205dd8 <default_pmm_manager+0xc20>
    check_mm_struct = mm_create();
ffffffffc0203bee:	0000e797          	auipc	a5,0xe
ffffffffc0203bf2:	9607b523          	sd	zero,-1686(a5) # ffffffffc0211558 <check_mm_struct>
    assert(check_mm_struct != NULL);
ffffffffc0203bf6:	f7efc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(vma != NULL);
ffffffffc0203bfa:	00002697          	auipc	a3,0x2
ffffffffc0203bfe:	cee68693          	addi	a3,a3,-786 # ffffffffc02058e8 <default_pmm_manager+0x730>
ffffffffc0203c02:	00001617          	auipc	a2,0x1
ffffffffc0203c06:	20660613          	addi	a2,a2,518 # ffffffffc0204e08 <commands+0x738>
ffffffffc0203c0a:	11100593          	li	a1,273
ffffffffc0203c0e:	00002517          	auipc	a0,0x2
ffffffffc0203c12:	1ca50513          	addi	a0,a0,458 # ffffffffc0205dd8 <default_pmm_manager+0xc20>
ffffffffc0203c16:	f5efc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203c1a:	00002697          	auipc	a3,0x2
ffffffffc0203c1e:	3b668693          	addi	a3,a3,950 # ffffffffc0205fd0 <default_pmm_manager+0xe18>
ffffffffc0203c22:	00001617          	auipc	a2,0x1
ffffffffc0203c26:	1e660613          	addi	a2,a2,486 # ffffffffc0204e08 <commands+0x738>
ffffffffc0203c2a:	11600593          	li	a1,278
ffffffffc0203c2e:	00002517          	auipc	a0,0x2
ffffffffc0203c32:	1aa50513          	addi	a0,a0,426 # ffffffffc0205dd8 <default_pmm_manager+0xc20>
ffffffffc0203c36:	f3efc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(sum == 0);
ffffffffc0203c3a:	00002697          	auipc	a3,0x2
ffffffffc0203c3e:	3b668693          	addi	a3,a3,950 # ffffffffc0205ff0 <default_pmm_manager+0xe38>
ffffffffc0203c42:	00001617          	auipc	a2,0x1
ffffffffc0203c46:	1c660613          	addi	a2,a2,454 # ffffffffc0204e08 <commands+0x738>
ffffffffc0203c4a:	12000593          	li	a1,288
ffffffffc0203c4e:	00002517          	auipc	a0,0x2
ffffffffc0203c52:	18a50513          	addi	a0,a0,394 # ffffffffc0205dd8 <default_pmm_manager+0xc20>
ffffffffc0203c56:	f1efc0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203c5a:	00001617          	auipc	a2,0x1
ffffffffc0203c5e:	59660613          	addi	a2,a2,1430 # ffffffffc02051f0 <default_pmm_manager+0x38>
ffffffffc0203c62:	06500593          	li	a1,101
ffffffffc0203c66:	00001517          	auipc	a0,0x1
ffffffffc0203c6a:	5aa50513          	addi	a0,a0,1450 # ffffffffc0205210 <default_pmm_manager+0x58>
ffffffffc0203c6e:	f06fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c72:	00002697          	auipc	a3,0x2
ffffffffc0203c76:	31668693          	addi	a3,a3,790 # ffffffffc0205f88 <default_pmm_manager+0xdd0>
ffffffffc0203c7a:	00001617          	auipc	a2,0x1
ffffffffc0203c7e:	18e60613          	addi	a2,a2,398 # ffffffffc0204e08 <commands+0x738>
ffffffffc0203c82:	12e00593          	li	a1,302
ffffffffc0203c86:	00002517          	auipc	a0,0x2
ffffffffc0203c8a:	15250513          	addi	a0,a0,338 # ffffffffc0205dd8 <default_pmm_manager+0xc20>
ffffffffc0203c8e:	ee6fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c92:	00002697          	auipc	a3,0x2
ffffffffc0203c96:	2f668693          	addi	a3,a3,758 # ffffffffc0205f88 <default_pmm_manager+0xdd0>
ffffffffc0203c9a:	00001617          	auipc	a2,0x1
ffffffffc0203c9e:	16e60613          	addi	a2,a2,366 # ffffffffc0204e08 <commands+0x738>
ffffffffc0203ca2:	0bd00593          	li	a1,189
ffffffffc0203ca6:	00002517          	auipc	a0,0x2
ffffffffc0203caa:	13250513          	addi	a0,a0,306 # ffffffffc0205dd8 <default_pmm_manager+0xc20>
ffffffffc0203cae:	ec6fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(mm != NULL);
ffffffffc0203cb2:	00002697          	auipc	a3,0x2
ffffffffc0203cb6:	bfe68693          	addi	a3,a3,-1026 # ffffffffc02058b0 <default_pmm_manager+0x6f8>
ffffffffc0203cba:	00001617          	auipc	a2,0x1
ffffffffc0203cbe:	14e60613          	addi	a2,a2,334 # ffffffffc0204e08 <commands+0x738>
ffffffffc0203cc2:	0c700593          	li	a1,199
ffffffffc0203cc6:	00002517          	auipc	a0,0x2
ffffffffc0203cca:	11250513          	addi	a0,a0,274 # ffffffffc0205dd8 <default_pmm_manager+0xc20>
ffffffffc0203cce:	ea6fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203cd2:	00002697          	auipc	a3,0x2
ffffffffc0203cd6:	2b668693          	addi	a3,a3,694 # ffffffffc0205f88 <default_pmm_manager+0xdd0>
ffffffffc0203cda:	00001617          	auipc	a2,0x1
ffffffffc0203cde:	12e60613          	addi	a2,a2,302 # ffffffffc0204e08 <commands+0x738>
ffffffffc0203ce2:	0fb00593          	li	a1,251
ffffffffc0203ce6:	00002517          	auipc	a0,0x2
ffffffffc0203cea:	0f250513          	addi	a0,a0,242 # ffffffffc0205dd8 <default_pmm_manager+0xc20>
ffffffffc0203cee:	e86fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203cf2 <do_pgfault>:
...
ffffffffc0203cf4:	85b2                	mv	a1,a2
do_pgfault(struct mm_struct *mm, uint_t error_code, uintptr_t addr) {
ffffffffc0203cf6:	f022                	sd	s0,32(sp)
ffffffffc0203cf8:	ec26                	sd	s1,24(sp)
ffffffffc0203cfa:	f406                	sd	ra,40(sp)
ffffffffc0203cfc:	e84a                	sd	s2,16(sp)
ffffffffc0203cfe:	8432                	mv	s0,a2
ffffffffc0203d00:	84aa                	mv	s1,a0
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203d02:	8d3ff0ef          	jal	ra,ffffffffc02035d4 <find_vma>

    pgfault_num++;
ffffffffc0203d06:	0000e797          	auipc	a5,0xe
ffffffffc0203d0a:	85a7a783          	lw	a5,-1958(a5) # ffffffffc0211560 <pgfault_num>
ffffffffc0203d0e:	2785                	addiw	a5,a5,1
ffffffffc0203d10:	0000e717          	auipc	a4,0xe
ffffffffc0203d14:	84f72823          	sw	a5,-1968(a4) # ffffffffc0211560 <pgfault_num>
    //If the addr is in the range of a mm's vma?
    if (vma == NULL || vma->vm_start > addr) {
ffffffffc0203d18:	c159                	beqz	a0,ffffffffc0203d9e <do_pgfault+0xac>
ffffffffc0203d1a:	651c                	ld	a5,8(a0)
ffffffffc0203d1c:	08f46163          	bltu	s0,a5,ffffffffc0203d9e <do_pgfault+0xac>
...
ffffffffc0203d20:	6d1c                	ld	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc0203d22:	4941                	li	s2,16
    if (vma->vm_flags & VM_WRITE) {
ffffffffc0203d24:	8b89                	andi	a5,a5,2
ffffffffc0203d26:	ebb1                	bnez	a5,ffffffffc0203d7a <do_pgfault+0x88>
        perm |= (PTE_R | PTE_W);
    }
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203d28:	75fd                	lui	a1,0xfffff
...
ffffffffc0203d2a:	6c88                	ld	a0,24(s1)
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203d2c:	8c6d                	and	s0,s0,a1
    ptep = get_pte(mm->pgdir, addr, 1);  //(1) try to find a pte, if pte's
ffffffffc0203d2e:	85a2                	mv	a1,s0
ffffffffc0203d30:	4605                	li	a2,1
ffffffffc0203d32:	99bfd0ef          	jal	ra,ffffffffc02016cc <get_pte>
                                         //PT(Page Table) isn't existed, then
                                         //create a PT.
    if (*ptep == 0) {
ffffffffc0203d36:	610c                	ld	a1,0(a0)
ffffffffc0203d38:	c1b9                	beqz	a1,ffffffffc0203d7e <do_pgfault+0x8c>
        ...
        */
        if (swap_init_ok) {
ffffffffc0203d3a:	0000e797          	auipc	a5,0xe
ffffffffc0203d3e:	8167a783          	lw	a5,-2026(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc0203d42:	c7bd                	beqz	a5,ffffffffc0203db0 <do_pgfault+0xbe>
...
ffffffffc0203d46:	0030                	addi	a2,sp,8
ffffffffc0203d48:	8526                	mv	a0,s1
            struct Page *page = NULL;
ffffffffc0203d4a:	e402                	sd	zero,8(sp)
            swap_in(mm,addr,&page);
ffffffffc0203d4c:	b66ff0ef          	jal	ra,ffffffffc02030b2 <swap_in>
            page_insert(mm->pgdir,page,addr,perm);
ffffffffc0203d50:	65a2                	ld	a1,8(sp)
ffffffffc0203d52:	6c88                	ld	a0,24(s1)
ffffffffc0203d54:	86ca                	mv	a3,s2
ffffffffc0203d56:	8622                	mv	a2,s0
ffffffffc0203d58:	c5ffd0ef          	jal	ra,ffffffffc02019b6 <page_insert>
            swap_map_swappable(mm,addr,page,1);
ffffffffc0203d5c:	6622                	ld	a2,8(sp)
ffffffffc0203d5e:	4685                	li	a3,1
ffffffffc0203d60:	85a2                	mv	a1,s0
ffffffffc0203d62:	8526                	mv	a0,s1
ffffffffc0203d64:	a2eff0ef          	jal	ra,ffffffffc0202f92 <swap_map_swappable>
            page->pra_vaddr = addr;
ffffffffc0203d68:	67a2                	ld	a5,8(sp)
   ...
   ret = 0;
ffffffffc0203d6a:	4501                	li	a0,0
            page->pra_vaddr = addr;
ffffffffc0203d6c:	e3a0                	sd	s0,64(a5)
failed:
    return ret;
}
ffffffffc0203d6e:	70a2                	ld	ra,40(sp)
ffffffffc0203d70:	7402                	ld	s0,32(sp)
ffffffffc0203d72:	64e2                	ld	s1,24(sp)
ffffffffc0203d74:	6942                	ld	s2,16(sp)
ffffffffc0203d76:	6145                	addi	sp,sp,48
ffffffffc0203d78:	8082                	ret
        perm |= (PTE_R | PTE_W);
ffffffffc0203d7a:	4959                	li	s2,22
ffffffffc0203d7c:	b775                	j	ffffffffc0203d28 <do_pgfault+0x36>
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203d7e:	6c88                	ld	a0,24(s1)
ffffffffc0203d80:	864a                	mv	a2,s2
ffffffffc0203d82:	85a2                	mv	a1,s0
ffffffffc0203d84:	93dfe0ef          	jal	ra,ffffffffc02026c0 <pgdir_alloc_page>
ffffffffc0203d88:	87aa                	mv	a5,a0
   ret = 0;
ffffffffc0203d8a:	4501                	li	a0,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203d8c:	f3ed                	bnez	a5,ffffffffc0203d6e <do_pgfault+0x7c>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc0203d8e:	00002517          	auipc	a0,0x2
ffffffffc0203d92:	2f250513          	addi	a0,a0,754 # ffffffffc0206080 <default_pmm_manager+0xec8>
ffffffffc0203d96:	b24fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203d9a:	5571                	li	a0,-4
            goto failed;
ffffffffc0203d9c:	bfc9                	j	ffffffffc0203d6e <do_pgfault+0x7c>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc0203d9e:	85a2                	mv	a1,s0
ffffffffc0203da0:	00002517          	auipc	a0,0x2
ffffffffc0203da4:	2b050513          	addi	a0,a0,688 # ffffffffc0206050 <default_pmm_manager+0xe98>
ffffffffc0203da8:	b12fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    int ret = -E_INVAL;
ffffffffc0203dac:	5575                	li	a0,-3
        goto failed;
ffffffffc0203dae:	b7c1                	j	ffffffffc0203d6e <do_pgfault+0x7c>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc0203db0:	00002517          	auipc	a0,0x2
ffffffffc0203db4:	2f850513          	addi	a0,a0,760 # ffffffffc02060a8 <default_pmm_manager+0xef0>
ffffffffc0203db8:	b02fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203dbc:	5571                	li	a0,-4
            goto failed;
ffffffffc0203dbe:	bf45                	j	ffffffffc0203d6e <do_pgfault+0x7c>

ffffffffc0203dc0 <swapfs_init>:
#include <ide.h>
#include <pmm.h>
#include <assert.h>
...
ffffffffc0203dc4:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc0203dc6:	ecefc0ef          	jal	ra,ffffffffc0200494 <ide_device_valid>
ffffffffc0203dca:	cd01                	beqz	a0,ffffffffc0203de2 <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203dcc:	4505                	li	a0,1
ffffffffc0203dce:	eccfc0ef          	jal	ra,ffffffffc020049a <ide_device_size>
}
ffffffffc0203dd2:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203dd4:	810d                	srli	a0,a0,0x3
ffffffffc0203dd6:	0000d797          	auipc	a5,0xd
ffffffffc0203dda:	76a7b523          	sd	a0,1898(a5) # ffffffffc0211540 <max_swap_offset>
}
ffffffffc0203dde:	0141                	addi	sp,sp,16
ffffffffc0203de0:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0203de2:	00002617          	auipc	a2,0x2
ffffffffc0203de6:	2ee60613          	addi	a2,a2,750 # ffffffffc02060d0 <default_pmm_manager+0xf18>
ffffffffc0203dea:	45b5                	li	a1,13
ffffffffc0203dec:	00002517          	auipc	a0,0x2
ffffffffc0203df0:	30450513          	addi	a0,a0,772 # ffffffffc02060f0 <default_pmm_manager+0xf38>
ffffffffc0203df4:	d80fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203df8 <swapfs_read>:

int
swapfs_read(swap_entry_t entry, struct Page *page) {
ffffffffc0203df8:	1141                	addi	sp,sp,-16
ffffffffc0203dfa:	e406                	sd	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203dfc:	00855793          	srli	a5,a0,0x8
ffffffffc0203e00:	c3a5                	beqz	a5,ffffffffc0203e60 <swapfs_read+0x68>
ffffffffc0203e02:	0000d717          	auipc	a4,0xd
ffffffffc0203e06:	73e73703          	ld	a4,1854(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203e0a:	04e7fb63          	bgeu	a5,a4,ffffffffc0203e60 <swapfs_read+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203e0e:	0000d617          	auipc	a2,0xd
ffffffffc0203e12:	71a63603          	ld	a2,1818(a2) # ffffffffc0211528 <pages>
ffffffffc0203e16:	8d91                	sub	a1,a1,a2
ffffffffc0203e18:	4035d613          	srai	a2,a1,0x3
ffffffffc0203e1c:	00002597          	auipc	a1,0x2
ffffffffc0203e20:	5545b583          	ld	a1,1364(a1) # ffffffffc0206370 <error_string+0x38>
ffffffffc0203e24:	02b60633          	mul	a2,a2,a1
ffffffffc0203e28:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203e2c:	00002797          	auipc	a5,0x2
ffffffffc0203e30:	54c7b783          	ld	a5,1356(a5) # ffffffffc0206378 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e34:	0000d717          	auipc	a4,0xd
ffffffffc0203e38:	6ec73703          	ld	a4,1772(a4) # ffffffffc0211520 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203e3c:	963e                	add	a2,a2,a5
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e3e:	00c61793          	slli	a5,a2,0xc
ffffffffc0203e42:	83b1                	srli	a5,a5,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc0203e44:	0632                	slli	a2,a2,0xc
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e46:	02e7f963          	bgeu	a5,a4,ffffffffc0203e78 <swapfs_read+0x80>
}
ffffffffc0203e4a:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e4c:	0000d797          	auipc	a5,0xd
ffffffffc0203e50:	6ec7b783          	ld	a5,1772(a5) # ffffffffc0211538 <va_pa_offset>
ffffffffc0203e54:	46a1                	li	a3,8
ffffffffc0203e56:	963e                	add	a2,a2,a5
ffffffffc0203e58:	4505                	li	a0,1
}
ffffffffc0203e5a:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e5c:	e44fc06f          	j	ffffffffc02004a0 <ide_read_secs>
ffffffffc0203e60:	86aa                	mv	a3,a0
ffffffffc0203e62:	00002617          	auipc	a2,0x2
ffffffffc0203e66:	2a660613          	addi	a2,a2,678 # ffffffffc0206108 <default_pmm_manager+0xf50>
ffffffffc0203e6a:	45d1                	li	a1,20
ffffffffc0203e6c:	00002517          	auipc	a0,0x2
ffffffffc0203e70:	28450513          	addi	a0,a0,644 # ffffffffc02060f0 <default_pmm_manager+0xf38>
ffffffffc0203e74:	d00fc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203e78:	86b2                	mv	a3,a2
ffffffffc0203e7a:	06a00593          	li	a1,106
ffffffffc0203e7e:	00001617          	auipc	a2,0x1
ffffffffc0203e82:	3ca60613          	addi	a2,a2,970 # ffffffffc0205248 <default_pmm_manager+0x90>
ffffffffc0203e86:	00001517          	auipc	a0,0x1
ffffffffc0203e8a:	38a50513          	addi	a0,a0,906 # ffffffffc0205210 <default_pmm_manager+0x58>
ffffffffc0203e8e:	ce6fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203e92 <swapfs_write>:

int
swapfs_write(swap_entry_t entry, struct Page *page) {
ffffffffc0203e92:	1141                	addi	sp,sp,-16
ffffffffc0203e94:	e406                	sd	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e96:	00855793          	srli	a5,a0,0x8
ffffffffc0203e9a:	c3a5                	beqz	a5,ffffffffc0203efa <swapfs_write+0x68>
ffffffffc0203e9c:	0000d717          	auipc	a4,0xd
ffffffffc0203ea0:	6a473703          	ld	a4,1700(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203ea4:	04e7fb63          	bgeu	a5,a4,ffffffffc0203efa <swapfs_write+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203ea8:	0000d617          	auipc	a2,0xd
ffffffffc0203eac:	68063603          	ld	a2,1664(a2) # ffffffffc0211528 <pages>
ffffffffc0203eb0:	8d91                	sub	a1,a1,a2
ffffffffc0203eb2:	4035d613          	srai	a2,a1,0x3
ffffffffc0203eb6:	00002597          	auipc	a1,0x2
ffffffffc0203eba:	4ba5b583          	ld	a1,1210(a1) # ffffffffc0206370 <error_string+0x38>
ffffffffc0203ebe:	02b60633          	mul	a2,a2,a1
ffffffffc0203ec2:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203ec6:	00002797          	auipc	a5,0x2
ffffffffc0203eca:	4b27b783          	ld	a5,1202(a5) # ffffffffc0206378 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203ece:	0000d717          	auipc	a4,0xd
ffffffffc0203ed2:	65273703          	ld	a4,1618(a4) # ffffffffc0211520 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203ed6:	963e                	add	a2,a2,a5
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203ed8:	00c61793          	slli	a5,a2,0xc
ffffffffc0203edc:	83b1                	srli	a5,a5,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc0203ede:	0632                	slli	a2,a2,0xc
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203ee0:	02e7f963          	bgeu	a5,a4,ffffffffc0203f12 <swapfs_write+0x80>
}
ffffffffc0203ee4:	60a2                	ld	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203ee6:	0000d797          	auipc	a5,0xd
ffffffffc0203eea:	6527b783          	ld	a5,1618(a5) # ffffffffc0211538 <va_pa_offset>
ffffffffc0203eee:	46a1                	li	a3,8
ffffffffc0203ef0:	963e                	add	a2,a2,a5
ffffffffc0203ef2:	4505                	li	a0,1
}
ffffffffc0203ef4:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203ef6:	dcefc06f          	j	ffffffffc02004c4 <ide_write_secs>
ffffffffc0203efa:	86aa                	mv	a3,a0
ffffffffc0203efc:	00002617          	auipc	a2,0x2
ffffffffc0203f00:	20c60613          	addi	a2,a2,524 # ffffffffc0206108 <default_pmm_manager+0xf50>
ffffffffc0203f04:	45e5                	li	a1,25
ffffffffc0203f06:	00002517          	auipc	a0,0x2
ffffffffc0203f0a:	1ea50513          	addi	a0,a0,490 # ffffffffc02060f0 <default_pmm_manager+0xf38>
...
ffffffffc0203f1c:	33060613          	addi	a2,a2,816 # ffffffffc0205248 <default_pmm_manager+0x90>
ffffffffc0203f20:	00001517          	auipc	a0,0x1
ffffffffc0203f24:	2f050513          	addi	a0,a0,752 # ffffffffc0205210 <default_pmm_manager+0x58>
ffffffffc0203f28:	c4cfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203f2c <printnum>:
 * */
static void
...
ffffffffc0203f2c:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203f30:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0203f32:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203f36:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0203f38:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203f3c:	f022                	sd	s0,32(sp)
ffffffffc0203f3e:	ec26                	sd	s1,24(sp)
ffffffffc0203f40:	e84a                	sd	s2,16(sp)
ffffffffc0203f42:	f406                	sd	ra,40(sp)
ffffffffc0203f44:	e44e                	sd	s3,8(sp)
ffffffffc0203f46:	84aa                	mv	s1,a0
ffffffffc0203f48:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0203f4a:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0203f4e:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0203f50:	03067e63          	bgeu	a2,a6,ffffffffc0203f8c <printnum+0x60>
ffffffffc0203f54:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0203f56:	00805763          	blez	s0,ffffffffc0203f64 <printnum+0x38>
ffffffffc0203f5a:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0203f5c:	85ca                	mv	a1,s2
ffffffffc0203f5e:	854e                	mv	a0,s3
ffffffffc0203f60:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0203f62:	fc65                	bnez	s0,ffffffffc0203f5a <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203f64:	1a02                	slli	s4,s4,0x20
ffffffffc0203f66:	00002797          	auipc	a5,0x2
ffffffffc0203f6a:	1c278793          	addi	a5,a5,450 # ffffffffc0206128 <default_pmm_manager+0xf70>
ffffffffc0203f6e:	020a5a13          	srli	s4,s4,0x20
ffffffffc0203f72:	9a3e                	add	s4,s4,a5
}
ffffffffc0203f74:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203f76:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0203f7a:	70a2                	ld	ra,40(sp)
ffffffffc0203f7c:	69a2                	ld	s3,8(sp)
ffffffffc0203f7e:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203f80:	85ca                	mv	a1,s2
ffffffffc0203f82:	87a6                	mv	a5,s1
}
ffffffffc0203f84:	6942                	ld	s2,16(sp)
ffffffffc0203f86:	64e2                	ld	s1,24(sp)
ffffffffc0203f88:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203f8a:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0203f8c:	03065633          	divu	a2,a2,a6
ffffffffc0203f90:	8722                	mv	a4,s0
ffffffffc0203f92:	f9bff0ef          	jal	ra,ffffffffc0203f2c <printnum>
ffffffffc0203f96:	b7f9                	j	ffffffffc0203f64 <printnum+0x38>

ffffffffc0203f98 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0203f98:	7119                	addi	sp,sp,-128
ffffffffc0203f9a:	f4a6                	sd	s1,104(sp)
...
ffffffffc0203fa8:	f06a                	sd	s10,32(sp)
...
ffffffffc0203fb2:	ec6e                	sd	s11,24(sp)
ffffffffc0203fb4:	892a                	mv	s2,a0
ffffffffc0203fb6:	84ae                	mv	s1,a1
ffffffffc0203fb8:	8d32                	mv	s10,a2
ffffffffc0203fba:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0203fbc:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0203fc0:	5b7d                	li	s6,-1
ffffffffc0203fc2:	00002a97          	auipc	s5,0x2
ffffffffc0203fc6:	19aa8a93          	addi	s5,s5,410 # ffffffffc020615c <default_pmm_manager+0xfa4>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0203fca:	00002b97          	auipc	s7,0x2
ffffffffc0203fce:	36eb8b93          	addi	s7,s7,878 # ffffffffc0206338 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203fd2:	000d4503          	lbu	a0,0(s10) # 80000 <kern_entry-0xffffffffc0180000>
ffffffffc0203fd6:	001d0413          	addi	s0,s10,1
ffffffffc0203fda:	01350a63          	beq	a0,s3,ffffffffc0203fee <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0203fde:	c121                	beqz	a0,ffffffffc020401e <vprintfmt+0x86>
            putch(ch, putdat);
...
ffffffffc0203fe4:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203fe6:	fff44503          	lbu	a0,-1(s0)
ffffffffc0203fea:	ff351ae3          	bne	a0,s3,ffffffffc0203fde <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fee:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0203ff2:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0203ff6:	4c81                	li	s9,0
ffffffffc0203ff8:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0203ffa:	5c7d                	li	s8,-1
ffffffffc0203ffc:	5dfd                	li	s11,-1
ffffffffc0203ffe:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0204002:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204004:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204008:	0ff5f593          	zext.b	a1,a1
ffffffffc020400c:	00140d13          	addi	s10,s0,1
ffffffffc0204010:	04b56263          	bltu	a0,a1,ffffffffc0204054 <vprintfmt+0xbc>
ffffffffc0204014:	058a                	slli	a1,a1,0x2
ffffffffc0204016:	95d6                	add	a1,a1,s5
ffffffffc0204018:	4194                	lw	a3,0(a1)
ffffffffc020401a:	96d6                	add	a3,a3,s5
ffffffffc020401c:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc020401e:	70e6                	ld	ra,120(sp)
ffffffffc0204020:	7446                	ld	s0,112(sp)
ffffffffc0204022:	74a6                	ld	s1,104(sp)
ffffffffc0204024:	7906                	ld	s2,96(sp)
ffffffffc0204026:	69e6                	ld	s3,88(sp)
ffffffffc0204028:	6a46                	ld	s4,80(sp)
ffffffffc020402a:	6aa6                	ld	s5,72(sp)
ffffffffc020402c:	6b06                	ld	s6,64(sp)
ffffffffc020402e:	7be2                	ld	s7,56(sp)
ffffffffc0204030:	7c42                	ld	s8,48(sp)
ffffffffc0204032:	7ca2                	ld	s9,40(sp)
ffffffffc0204034:	7d02                	ld	s10,32(sp)
ffffffffc0204036:	6de2                	ld	s11,24(sp)
ffffffffc0204038:	6109                	addi	sp,sp,128
ffffffffc020403a:	8082                	ret
            padc = '0';
ffffffffc020403c:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc020403e:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204042:	846a                	mv	s0,s10
ffffffffc0204044:	00140d13          	addi	s10,s0,1
ffffffffc0204048:	fdd6059b          	addiw	a1,a2,-35
ffffffffc020404c:	0ff5f593          	zext.b	a1,a1
ffffffffc0204050:	fcb572e3          	bgeu	a0,a1,ffffffffc0204014 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0204054:	85a6                	mv	a1,s1
ffffffffc0204056:	02500513          	li	a0,37
ffffffffc020405a:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc020405c:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204060:	8d22                	mv	s10,s0
ffffffffc0204062:	f73788e3          	beq	a5,s3,ffffffffc0203fd2 <vprintfmt+0x3a>
ffffffffc0204066:	ffed4783          	lbu	a5,-2(s10)
ffffffffc020406a:	1d7d                	addi	s10,s10,-1
ffffffffc020406c:	ff379de3          	bne	a5,s3,ffffffffc0204066 <vprintfmt+0xce>
ffffffffc0204070:	b78d                	j	ffffffffc0203fd2 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0204072:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0204076:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020407a:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc020407c:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204080:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204084:	02d86463          	bltu	a6,a3,ffffffffc02040ac <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0204088:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc020408c:	002c169b          	slliw	a3,s8,0x2
ffffffffc0204090:	0186873b          	addw	a4,a3,s8
ffffffffc0204094:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204098:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc020409a:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc020409e:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc02040a0:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc02040a4:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc02040a8:	fed870e3          	bgeu	a6,a3,ffffffffc0204088 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc02040ac:	f40ddce3          	bgez	s11,ffffffffc0204004 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc02040b0:	8de2                	mv	s11,s8
ffffffffc02040b2:	5c7d                	li	s8,-1
ffffffffc02040b4:	bf81                	j	ffffffffc0204004 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc02040b6:	fffdc693          	not	a3,s11
ffffffffc02040ba:	96fd                	srai	a3,a3,0x3f
ffffffffc02040bc:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040c0:	00144603          	lbu	a2,1(s0)
ffffffffc02040c4:	2d81                	sext.w	s11,s11
ffffffffc02040c6:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02040c8:	bf35                	j	ffffffffc0204004 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc02040ca:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
...
ffffffffc02040d6:	bfd9                	j	ffffffffc02040ac <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc02040d8:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02040da:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02040de:	01174463          	blt	a4,a7,ffffffffc02040e6 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc02040e2:	1a088e63          	beqz	a7,ffffffffc020429e <vprintfmt+0x306>
...
ffffffffc02040f0:	876e                	mv	a4,s11
ffffffffc02040f2:	85a6                	mv	a1,s1
ffffffffc02040f4:	854a                	mv	a0,s2
ffffffffc02040f6:	e37ff0ef          	jal	ra,ffffffffc0203f2c <printnum>
            break;
ffffffffc02040fa:	bde1                	j	ffffffffc0203fd2 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc02040fc:	000a2503          	lw	a0,0(s4)
ffffffffc0204100:	85a6                	mv	a1,s1
ffffffffc0204102:	0a21                	addi	s4,s4,8
ffffffffc0204104:	9902                	jalr	s2
            break;
ffffffffc0204106:	b5f1                	j	ffffffffc0203fd2 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204108:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc020410a:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc020410e:	01174463          	blt	a4,a7,ffffffffc0204116 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204112:	18088163          	beqz	a7,ffffffffc0204294 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204116:	000a3603          	ld	a2,0(s4)
ffffffffc020411a:	46a9                	li	a3,10
ffffffffc020411c:	8a2e                	mv	s4,a1
ffffffffc020411e:	bfc1                	j	ffffffffc02040ee <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204120:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204124:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204126:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204128:	bdf1                	j	ffffffffc0204004 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc020412a:	85a6                	mv	a1,s1
ffffffffc020412c:	02500513          	li	a0,37
ffffffffc0204130:	9902                	jalr	s2
            break;
ffffffffc0204132:	b545                	j	ffffffffc0203fd2 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204134:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204138:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020413a:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc020413c:	b5e1                	j	ffffffffc0204004 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc020413e:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204140:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204144:	01174463          	blt	a4,a7,ffffffffc020414c <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204148:	14088163          	beqz	a7,ffffffffc020428a <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc020414c:	000a3603          	ld	a2,0(s4)
ffffffffc0204150:	46a1                	li	a3,8
ffffffffc0204152:	8a2e                	mv	s4,a1
ffffffffc0204154:	bf69                	j	ffffffffc02040ee <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0204156:	03000513          	li	a0,48
ffffffffc020415a:	85a6                	mv	a1,s1
ffffffffc020415c:	e03e                	sd	a5,0(sp)
...
ffffffffc0204168:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc020416a:	6782                	ld	a5,0(sp)
ffffffffc020416c:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc020416e:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0204172:	bfb5                	j	ffffffffc02040ee <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204174:	000a3403          	ld	s0,0(s4)
ffffffffc0204178:	008a0713          	addi	a4,s4,8
ffffffffc020417c:	e03a                	sd	a4,0(sp)
ffffffffc020417e:	14040263          	beqz	s0,ffffffffc02042c2 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0204182:	0fb05763          	blez	s11,ffffffffc0204270 <vprintfmt+0x2d8>
ffffffffc0204186:	02d00693          	li	a3,45
ffffffffc020418a:	0cd79163          	bne	a5,a3,ffffffffc020424c <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020418e:	00044783          	lbu	a5,0(s0)
ffffffffc0204192:	0007851b          	sext.w	a0,a5
ffffffffc0204196:	cf85                	beqz	a5,ffffffffc02041ce <vprintfmt+0x236>
ffffffffc0204198:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020419c:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02041a0:	000c4563          	bltz	s8,ffffffffc02041aa <vprintfmt+0x212>
ffffffffc02041a4:	3c7d                	addiw	s8,s8,-1
ffffffffc02041a6:	036c0263          	beq	s8,s6,ffffffffc02041ca <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc02041aa:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02041ac:	0e0c8e63          	beqz	s9,ffffffffc02042a8 <vprintfmt+0x310>
ffffffffc02041b0:	3781                	addiw	a5,a5,-32
ffffffffc02041b2:	0ef47b63          	bgeu	s0,a5,ffffffffc02042a8 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc02041b6:	03f00513          	li	a0,63
ffffffffc02041ba:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02041bc:	000a4783          	lbu	a5,0(s4)
ffffffffc02041c0:	3dfd                	addiw	s11,s11,-1
ffffffffc02041c2:	0a05                	addi	s4,s4,1
ffffffffc02041c4:	0007851b          	sext.w	a0,a5
ffffffffc02041c8:	ffe1                	bnez	a5,ffffffffc02041a0 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc02041ca:	01b05963          	blez	s11,ffffffffc02041dc <vprintfmt+0x244>
ffffffffc02041ce:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc02041d0:	85a6                	mv	a1,s1
ffffffffc02041d2:	02000513          	li	a0,32
ffffffffc02041d6:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc02041d8:	fe0d9be3          	bnez	s11,ffffffffc02041ce <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc02041dc:	6a02                	ld	s4,0(sp)
ffffffffc02041de:	bbd5                	j	ffffffffc0203fd2 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02041e0:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02041e2:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc02041e6:	01174463          	blt	a4,a7,ffffffffc02041ee <vprintfmt+0x256>
    else if (lflag) {
ffffffffc02041ea:	08088d63          	beqz	a7,ffffffffc0204284 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc02041ee:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc02041f2:	0a044d63          	bltz	s0,ffffffffc02042ac <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc02041f6:	8622                	mv	a2,s0
ffffffffc02041f8:	8a66                	mv	s4,s9
ffffffffc02041fa:	46a9                	li	a3,10
ffffffffc02041fc:	bdcd                	j	ffffffffc02040ee <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc02041fe:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204202:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204204:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204206:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc020420a:	8fb5                	xor	a5,a5,a3
ffffffffc020420c:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204210:	02d74163          	blt	a4,a3,ffffffffc0204232 <vprintfmt+0x29a>
ffffffffc0204214:	00369793          	slli	a5,a3,0x3
ffffffffc0204218:	97de                	add	a5,a5,s7
ffffffffc020421a:	639c                	ld	a5,0(a5)
ffffffffc020421c:	cb99                	beqz	a5,ffffffffc0204232 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc020421e:	86be                	mv	a3,a5
ffffffffc0204220:	00002617          	auipc	a2,0x2
ffffffffc0204224:	f3860613          	addi	a2,a2,-200 # ffffffffc0206158 <default_pmm_manager+0xfa0>
ffffffffc0204228:	85a6                	mv	a1,s1
ffffffffc020422a:	854a                	mv	a0,s2
ffffffffc020422c:	0ce000ef          	jal	ra,ffffffffc02042fa <printfmt>
ffffffffc0204230:	b34d                	j	ffffffffc0203fd2 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204232:	00002617          	auipc	a2,0x2
ffffffffc0204236:	f1660613          	addi	a2,a2,-234 # ffffffffc0206148 <default_pmm_manager+0xf90>
ffffffffc020423a:	85a6                	mv	a1,s1
ffffffffc020423c:	854a                	mv	a0,s2
ffffffffc020423e:	0bc000ef          	jal	ra,ffffffffc02042fa <printfmt>
ffffffffc0204242:	bb41                	j	ffffffffc0203fd2 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204244:	00002417          	auipc	s0,0x2
ffffffffc0204248:	efc40413          	addi	s0,s0,-260 # ffffffffc0206140 <default_pmm_manager+0xf88>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc020424c:	85e2                	mv	a1,s8
ffffffffc020424e:	8522                	mv	a0,s0
ffffffffc0204250:	e43e                	sd	a5,8(sp)
ffffffffc0204252:	196000ef          	jal	ra,ffffffffc02043e8 <strnlen>
ffffffffc0204256:	40ad8dbb          	subw	s11,s11,a0
ffffffffc020425a:	01b05b63          	blez	s11,ffffffffc0204270 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc020425e:	67a2                	ld	a5,8(sp)
ffffffffc0204260:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204264:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204266:	85a6                	mv	a1,s1
ffffffffc0204268:	8552                	mv	a0,s4
ffffffffc020426a:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc020426c:	fe0d9ce3          	bnez	s11,ffffffffc0204264 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204270:	00044783          	lbu	a5,0(s0)
ffffffffc0204274:	00140a13          	addi	s4,s0,1
ffffffffc0204278:	0007851b          	sext.w	a0,a5
ffffffffc020427c:	d3a5                	beqz	a5,ffffffffc02041dc <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020427e:	05e00413          	li	s0,94
ffffffffc0204282:	bf39                	j	ffffffffc02041a0 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0204284:	000a2403          	lw	s0,0(s4)
ffffffffc0204288:	b7ad                	j	ffffffffc02041f2 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc020428a:	000a6603          	lwu	a2,0(s4)
ffffffffc020428e:	46a1                	li	a3,8
ffffffffc0204290:	8a2e                	mv	s4,a1
ffffffffc0204292:	bdb1                	j	ffffffffc02040ee <vprintfmt+0x156>
ffffffffc0204294:	000a6603          	lwu	a2,0(s4)
ffffffffc0204298:	46a9                	li	a3,10
ffffffffc020429a:	8a2e                	mv	s4,a1
ffffffffc020429c:	bd89                	j	ffffffffc02040ee <vprintfmt+0x156>
ffffffffc020429e:	000a6603          	lwu	a2,0(s4)
ffffffffc02042a2:	46c1                	li	a3,16
ffffffffc02042a4:	8a2e                	mv	s4,a1
ffffffffc02042a6:	b5a1                	j	ffffffffc02040ee <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc02042a8:	9902                	jalr	s2
ffffffffc02042aa:	bf09                	j	ffffffffc02041bc <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc02042ac:	85a6                	mv	a1,s1
ffffffffc02042ae:	02d00513          	li	a0,45
ffffffffc02042b2:	e03e                	sd	a5,0(sp)
ffffffffc02042b4:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc02042b6:	6782                	ld	a5,0(sp)
ffffffffc02042b8:	8a66                	mv	s4,s9
ffffffffc02042ba:	40800633          	neg	a2,s0
ffffffffc02042be:	46a9                	li	a3,10
ffffffffc02042c0:	b53d                	j	ffffffffc02040ee <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc02042c2:	03b05163          	blez	s11,ffffffffc02042e4 <vprintfmt+0x34c>
ffffffffc02042c6:	02d00693          	li	a3,45
ffffffffc02042ca:	f6d79de3          	bne	a5,a3,ffffffffc0204244 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc02042ce:	00002417          	auipc	s0,0x2
ffffffffc02042d2:	e7240413          	addi	s0,s0,-398 # ffffffffc0206140 <default_pmm_manager+0xf88>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02042d6:	02800793          	li	a5,40
ffffffffc02042da:	02800513          	li	a0,40
ffffffffc02042de:	00140a13          	addi	s4,s0,1
ffffffffc02042e2:	bd6d                	j	ffffffffc020419c <vprintfmt+0x204>
ffffffffc02042e4:	00002a17          	auipc	s4,0x2
ffffffffc02042e8:	e5da0a13          	addi	s4,s4,-419 # ffffffffc0206141 <default_pmm_manager+0xf89>
ffffffffc02042ec:	02800513          	li	a0,40
ffffffffc02042f0:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02042f4:	05e00413          	li	s0,94
ffffffffc02042f8:	b565                	j	ffffffffc02041a0 <vprintfmt+0x208>

ffffffffc02042fa <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02042fa:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc02042fc:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204300:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204302:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204304:	ec06                	sd	ra,24(sp)
ffffffffc0204306:	f83a                	sd	a4,48(sp)
ffffffffc0204308:	fc3e                	sd	a5,56(sp)
ffffffffc020430a:	e0c2                	sd	a6,64(sp)
ffffffffc020430c:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc020430e:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204310:	c89ff0ef          	jal	ra,ffffffffc0203f98 <vprintfmt>
}
ffffffffc0204314:	60e2                	ld	ra,24(sp)
ffffffffc0204316:	6161                	addi	sp,sp,80
ffffffffc0204318:	8082                	ret

ffffffffc020431a <readline>:
...
ffffffffc020431c:	e486                	sd	ra,72(sp)
ffffffffc020431e:	e0a6                	sd	s1,64(sp)
ffffffffc0204320:	fc4a                	sd	s2,56(sp)
ffffffffc0204322:	f84e                	sd	s3,48(sp)
ffffffffc0204324:	f452                	sd	s4,40(sp)
ffffffffc0204326:	f056                	sd	s5,32(sp)
ffffffffc0204328:	ec5a                	sd	s6,24(sp)
ffffffffc020432a:	e85e                	sd	s7,16(sp)
    if (prompt != NULL) {
ffffffffc020432c:	c901                	beqz	a0,ffffffffc020433c <readline+0x22>
ffffffffc020432e:	85aa                	mv	a1,a0
        cprintf("%s", prompt);
ffffffffc0204330:	00002517          	auipc	a0,0x2
ffffffffc0204334:	e2850513          	addi	a0,a0,-472 # ffffffffc0206158 <default_pmm_manager+0xfa0>
ffffffffc0204338:	d83fb0ef          	jal	ra,ffffffffc02000ba <cprintf>
readline(const char *prompt) {
ffffffffc020433c:	4481                	li	s1,0
    while (1) {
        c = getchar();
        if (c < 0) {
            return NULL;
...
ffffffffc020433e:	497d                	li	s2,31
            cputchar(c);
            buf[i ++] = c;
        }
        else if (c == '\b' && i > 0) {
ffffffffc0204340:	49a1                	li	s3,8
            cputchar(c);
            i --;
        }
        else if (c == '\n' || c == '\r') {
ffffffffc0204342:	4aa9                	li	s5,10
ffffffffc0204344:	4b35                	li	s6,13
            buf[i ++] = c;
ffffffffc0204346:	0000db97          	auipc	s7,0xd
ffffffffc020434a:	db2b8b93          	addi	s7,s7,-590 # ffffffffc02110f8 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc020434e:	3fe00a13          	li	s4,1022
        c = getchar();
ffffffffc0204352:	da1fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc0204356:	00054a63          	bltz	a0,ffffffffc020436a <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc020435a:	00a95a63          	bge	s2,a0,ffffffffc020436e <readline+0x54>
ffffffffc020435e:	029a5263          	bge	s4,s1,ffffffffc0204382 <readline+0x68>
        c = getchar();
ffffffffc0204362:	d91fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc0204366:	fe055ae3          	bgez	a0,ffffffffc020435a <readline+0x40>
            return NULL;
ffffffffc020436a:	4501                	li	a0,0
ffffffffc020436c:	a091                	j	ffffffffc02043b0 <readline+0x96>
        else if (c == '\b' && i > 0) {
ffffffffc020436e:	03351463          	bne	a0,s3,ffffffffc0204396 <readline+0x7c>
ffffffffc0204372:	e8a9                	bnez	s1,ffffffffc02043c4 <readline+0xaa>
        c = getchar();
ffffffffc0204374:	d7ffb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc0204378:	fe0549e3          	bltz	a0,ffffffffc020436a <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc020437c:	fea959e3          	bge	s2,a0,ffffffffc020436e <readline+0x54>
ffffffffc0204380:	4481                	li	s1,0
            cputchar(c);
ffffffffc0204382:	e42a                	sd	a0,8(sp)
ffffffffc0204384:	d6dfb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i ++] = c;
ffffffffc0204388:	6522                	ld	a0,8(sp)
ffffffffc020438a:	009b87b3          	add	a5,s7,s1
ffffffffc020438e:	2485                	addiw	s1,s1,1
ffffffffc0204390:	00a78023          	sb	a0,0(a5)
ffffffffc0204394:	bf7d                	j	ffffffffc0204352 <readline+0x38>
        else if (c == '\n' || c == '\r') {
ffffffffc0204396:	01550463          	beq	a0,s5,ffffffffc020439e <readline+0x84>
ffffffffc020439a:	fb651ce3          	bne	a0,s6,ffffffffc0204352 <readline+0x38>
            cputchar(c);
ffffffffc020439e:	d53fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i] = '\0';
ffffffffc02043a2:	0000d517          	auipc	a0,0xd
ffffffffc02043a6:	d5650513          	addi	a0,a0,-682 # ffffffffc02110f8 <buf>
ffffffffc02043aa:	94aa                	add	s1,s1,a0
ffffffffc02043ac:	00048023          	sb	zero,0(s1)
            return buf;
        }
    }
}
ffffffffc02043b0:	60a6                	ld	ra,72(sp)
ffffffffc02043b2:	6486                	ld	s1,64(sp)
ffffffffc02043b4:	7962                	ld	s2,56(sp)
ffffffffc02043b6:	79c2                	ld	s3,48(sp)
ffffffffc02043b8:	7a22                	ld	s4,40(sp)
ffffffffc02043ba:	7a82                	ld	s5,32(sp)
ffffffffc02043bc:	6b62                	ld	s6,24(sp)
ffffffffc02043be:	6bc2                	ld	s7,16(sp)
ffffffffc02043c0:	6161                	addi	sp,sp,80
ffffffffc02043c2:	8082                	ret
            cputchar(c);
ffffffffc02043c4:	4521                	li	a0,8
ffffffffc02043c6:	d2bfb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            i --;
ffffffffc02043ca:	34fd                	addiw	s1,s1,-1
ffffffffc02043cc:	b759                	j	ffffffffc0204352 <readline+0x38>
