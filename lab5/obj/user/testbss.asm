...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800032:	5d250513          	addi	a0,a0,1490 # 800600 <main+0xb2>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800052:	5d250513          	addi	a0,a0,1490 # 800620 <main+0xd2>
...
exit(int error_code) {
  ...
  8000b2:	57a50513          	addi	a0,a0,1402 # 800628 <main+0xda>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8001a4:	6c078793          	addi	a5,a5,1728 # 800860 <error_string+0xc8>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001f8:	448a0a13          	addi	s4,s4,1096 # 80063c <main+0xee>
  ...
  800204:	598c0c13          	addi	s8,s8,1432 # 800798 <error_string>
  ...
  80035a:	5fa60613          	addi	a2,a2,1530 # 800950 <error_string+0x1b8>
  ...
  80047a:	4ca60613          	addi	a2,a2,1226 # 800940 <error_string+0x1a8>
  ...
  80048c:	4b060613          	addi	a2,a2,1200 # 800938 <error_string+0x1a0>
            if (width > 0 && padc != '-') {
  800490:	00000417          	auipc	s0,0x0
  800494:	4a940413          	addi	s0,s0,1193 # 800939 <error_string+0x1a1>
                for (width -= strnlen(p, precision); width > 0; width --) {
  ...
  800520:	41d40413          	addi	s0,s0,1053 # 800939 <error_string+0x1a1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
int
main(void) {
  80054e:	1141                	addi	sp,sp,-16
    cprintf("Making sure bss works right...\n");
  800550:	00000517          	auipc	a0,0x0
  800554:	40850513          	addi	a0,a0,1032 # 800958 <error_string+0x1c0>
main(void) {
  800558:	e406                	sd	ra,8(sp)
    cprintf("Making sure bss works right...\n");
  80055a:	ba3ff0ef          	jal	ra,8000fc <cprintf>
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  80055e:	00001597          	auipc	a1,0x1
  800562:	aa258593          	addi	a1,a1,-1374 # 801000 <bigarray>
    cprintf("Making sure bss works right...\n");
  800566:	87ae                	mv	a5,a1
    for (i = 0; i < ARRAYSIZE; i ++) {
  800568:	4681                	li	a3,0
  80056a:	00100637          	lui	a2,0x100
  80056e:	a029                	j	800578 <main+0x2a>
  800570:	2685                	addiw	a3,a3,1
  800572:	0791                	addi	a5,a5,4
  800574:	00c68f63          	beq	a3,a2,800592 <main+0x44>
        if (bigarray[i] != 0) {
  800578:	4398                	lw	a4,0(a5)
  80057a:	db7d                	beqz	a4,800570 <main+0x22>
            panic("bigarray[%d] isn't cleared!\n", i);
  80057c:	00000617          	auipc	a2,0x0
  800580:	3fc60613          	addi	a2,a2,1020 # 800978 <error_string+0x1e0>
  800584:	45b9                	li	a1,14
  800586:	00000517          	auipc	a0,0x0
  80058a:	41250513          	addi	a0,a0,1042 # 800998 <error_string+0x200>
  80058e:	a93ff0ef          	jal	ra,800020 <__panic>
  800592:	00001717          	auipc	a4,0x1
  800596:	a6e70713          	addi	a4,a4,-1426 # 801000 <bigarray>
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  80059a:	4781                	li	a5,0
  80059c:	001006b7          	lui	a3,0x100
        bigarray[i] = i;
  8005a0:	c31c                	sw	a5,0(a4)
    for (i = 0; i < ARRAYSIZE; i ++) {
  8005a2:	2785                	addiw	a5,a5,1
  8005a4:	0711                	addi	a4,a4,4
  8005a6:	fed79de3          	bne	a5,a3,8005a0 <main+0x52>
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  8005aa:	4681                	li	a3,0
  8005ac:	00100737          	lui	a4,0x100
  8005b0:	a029                	j	8005ba <main+0x6c>
  8005b2:	2685                	addiw	a3,a3,1
  8005b4:	0591                	addi	a1,a1,4
  8005b6:	02e68063          	beq	a3,a4,8005d6 <main+0x88>
        if (bigarray[i] != i) {
  8005ba:	419c                	lw	a5,0(a1)
  8005bc:	fed78be3          	beq	a5,a3,8005b2 <main+0x64>
            panic("bigarray[%d] didn't hold its value!\n", i);
  8005c0:	00000617          	auipc	a2,0x0
  8005c4:	3e860613          	addi	a2,a2,1000 # 8009a8 <error_string+0x210>
  8005c8:	45d9                	li	a1,22
  8005ca:	00000517          	auipc	a0,0x0
  8005ce:	3ce50513          	addi	a0,a0,974 # 800998 <error_string+0x200>
  ...
  8005da:	3fa50513          	addi	a0,a0,1018 # 8009d0 <error_string+0x238>
  8005de:	b1fff0ef          	jal	ra,8000fc <cprintf>
    cprintf("testbss may pass.\n");
  8005e2:	00000517          	auipc	a0,0x0
  8005e6:	42650513          	addi	a0,a0,1062 # 800a08 <error_string+0x270>
  8005ea:	b13ff0ef          	jal	ra,8000fc <cprintf>
  ...
  8005ee:	4501                	li	a0,0
    bigarray[ARRAYSIZE + 1024] = 0;
  8005f0:	00402797          	auipc	a5,0x402
  8005f4:	a007a823          	sw	zero,-1520(a5) # c02000 <bigarray+0x401000>
    exit(0);
  8005f8:	aafff0ef          	jal	ra,8000a6 <exit>
