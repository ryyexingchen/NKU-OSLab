...
000000000080006a <sys_pgdir>:
}

int
sys_pgdir(void) {
    return syscall(SYS_pgdir);
  80006a:	457d                	li	a0,31
...
exit(int error_code) {
  ...
  80007a:	4b250513          	addi	a0,a0,1202 # 800528 <main+0x2e>
...
getpid(void) {
    return sys_getpid();
  800084:	bff1                	j	800060 <sys_getpid>

0000000000800086 <print_pgdir>:
}
...
print_pgdir(void) {
    sys_pgdir();
  800086:	b7d5                	j	80006a <sys_pgdir>
...
cputch(int c, int *cnt) {
  ...
  800094:	842e                	mv	s0,a1
    sys_putc(c);
  800096:	fcfff0ef          	jal	ra,800064 <sys_putc>
    (*cnt) ++;
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800150:	61478793          	addi	a5,a5,1556 # 800760 <error_string+0xc8>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001a4:	39ca0a13          	addi	s4,s4,924 # 80053c <main+0x42>
  ...
  8001b0:	4ecc0c13          	addi	s8,s8,1260 # 800698 <error_string>
  ...
  800306:	54e60613          	addi	a2,a2,1358 # 800850 <error_string+0x1b8>
  ...
  800426:	41e60613          	addi	a2,a2,1054 # 800840 <error_string+0x1a8>
  ...
  800438:	40460613          	addi	a2,a2,1028 # 800838 <error_string+0x1a0>
            if (width > 0 && padc != '-') {
  80043c:	00000417          	auipc	s0,0x0
  800440:	3fd40413          	addi	s0,s0,1021 # 800839 <error_string+0x1a1>
                for (width -= strnlen(p, precision); width > 0; width --) {
  ...
  8004cc:	37140413          	addi	s0,s0,881 # 800839 <error_string+0x1a1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  ...
  8004fe:	b87ff0ef          	jal	ra,800084 <getpid>
