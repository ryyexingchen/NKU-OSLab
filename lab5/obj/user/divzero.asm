...
obj/__user_divzero.out：     文件格式 elf64-littleriscv
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800032:	55a50513          	addi	a0,a0,1370 # 800588 <main+0x3a>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800052:	55a50513          	addi	a0,a0,1370 # 8005a8 <main+0x5a>
...
exit(int error_code) {
  ...
  8000b2:	50250513          	addi	a0,a0,1282 # 8005b0 <main+0x62>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8001a4:	64878793          	addi	a5,a5,1608 # 8007e8 <error_string+0xc8>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001f8:	3d0a0a13          	addi	s4,s4,976 # 8005c4 <main+0x76>
  ...
  800204:	520c0c13          	addi	s8,s8,1312 # 800720 <error_string>
  ...
  80035a:	58260613          	addi	a2,a2,1410 # 8008d8 <error_string+0x1b8>
  ...
  80047a:	45260613          	addi	a2,a2,1106 # 8008c8 <error_string+0x1a8>
  ...
  80048c:	43860613          	addi	a2,a2,1080 # 8008c0 <error_string+0x1a0>
            if (width > 0 && padc != '-') {
  800490:	00000417          	auipc	s0,0x0
  800494:	43140413          	addi	s0,s0,1073 # 8008c1 <error_string+0x1a1>
                for (width -= strnlen(p, precision); width > 0; width --) {
  ...
  800520:	3a540413          	addi	s0,s0,933 # 8008c1 <error_string+0x1a1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  800568:	e406                	sd	ra,8(sp)
    cprintf("value is %d.\n", 1 / zero);
  80056a:	b93ff0ef          	jal	ra,8000fc <cprintf>
    panic("FAIL: T.T\n");
  ...
  800580:	aa1ff0ef          	jal	ra,800020 <__panic>
