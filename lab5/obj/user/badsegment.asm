...
obj/__user_badsegment.out：     文件格式 elf64-littleriscv
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800032:	53a50513          	addi	a0,a0,1338 # 800568 <main+0x1a>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800052:	53a50513          	addi	a0,a0,1338 # 800588 <main+0x3a>
...
exit(int error_code) {
  ...
  8000b2:	4e250513          	addi	a0,a0,1250 # 800590 <main+0x42>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8001a4:	62878793          	addi	a5,a5,1576 # 8007c8 <error_string+0xc8>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001f8:	3b0a0a13          	addi	s4,s4,944 # 8005a4 <main+0x56>
  ...
  800204:	500c0c13          	addi	s8,s8,1280 # 800700 <error_string>
  ...
  80035a:	56260613          	addi	a2,a2,1378 # 8008b8 <error_string+0x1b8>
  ...
  80047a:	43260613          	addi	a2,a2,1074 # 8008a8 <error_string+0x1a8>
  ...
  80048c:	41860613          	addi	a2,a2,1048 # 8008a0 <error_string+0x1a0>
            if (width > 0 && padc != '-') {
  800490:	00000417          	auipc	s0,0x0
  800494:	41140413          	addi	s0,s0,1041 # 8008a1 <error_string+0x1a1>
                for (width -= strnlen(p, precision); width > 0; width --) {
  ...
  800520:	38540413          	addi	s0,s0,901 # 8008a1 <error_string+0x1a1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  ...
  800554:	37060613          	addi	a2,a2,880 # 8008c0 <error_string+0x1c0>
  800558:	45a9                	li	a1,10
  80055a:	00000517          	auipc	a0,0x0
  80055e:	37650513          	addi	a0,a0,886 # 8008d0 <error_string+0x1d0>
main(void) {
  800562:	e406                	sd	ra,8(sp)
    panic("FAIL: T.T\n");
  800564:	abdff0ef          	jal	ra,800020 <__panic>
