...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	5dd040ef          	jal	ra,ffffffffc0204e26 <memset>
...
ffffffffc0200056:	e2658593          	addi	a1,a1,-474 # ffffffffc0204e78 <etext+0x4>
ffffffffc020005a:	00005517          	auipc	a0,0x5
ffffffffc020005e:	e3e50513          	addi	a0,a0,-450 # ffffffffc0204e98 <etext+0x24>
...
ffffffffc020007a:	592040ef          	jal	ra,ffffffffc020460c <proc_init>
...
ffffffffc020008e:	7cc040ef          	jal	ra,ffffffffc020485a <cpu_idle>
...
ffffffffc02000ac:	df850513          	addi	a0,a0,-520 # ffffffffc0204ea0 <etext+0x2c>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	0b5040ef          	jal	ra,ffffffffc0204a28 <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	07f040ef          	jal	ra,ffffffffc0204a28 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001ce:	cde50513          	addi	a0,a0,-802 # ffffffffc0204ea8 <etext+0x34>
void print_kerninfo(void) {
...
ffffffffc02001e4:	ce850513          	addi	a0,a0,-792 # ffffffffc0204ec8 <etext+0x54>
ffffffffc02001e8:	f99ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02001ec:	00005597          	auipc	a1,0x5
ffffffffc02001f0:	c8858593          	addi	a1,a1,-888 # ffffffffc0204e74 <etext>
ffffffffc02001f4:	00005517          	auipc	a0,0x5
ffffffffc02001f8:	cf450513          	addi	a0,a0,-780 # ffffffffc0204ee8 <etext+0x74>
...
ffffffffc020020c:	d0050513          	addi	a0,a0,-768 # ffffffffc0204f08 <etext+0x94>
...
ffffffffc0200220:	d0c50513          	addi	a0,a0,-756 # ffffffffc0204f28 <etext+0xb4>
...
ffffffffc020024e:	cfe50513          	addi	a0,a0,-770 # ffffffffc0204f48 <etext+0xd4>
}
...
ffffffffc020025c:	d2060613          	addi	a2,a2,-736 # ffffffffc0204f78 <etext+0x104>
ffffffffc0200260:	04d00593          	li	a1,77
ffffffffc0200264:	00005517          	auipc	a0,0x5
ffffffffc0200268:	d2c50513          	addi	a0,a0,-724 # ffffffffc0204f90 <etext+0x11c>
void print_stackframe(void) {
...
ffffffffc0200278:	d3460613          	addi	a2,a2,-716 # ffffffffc0204fa8 <etext+0x134>
ffffffffc020027c:	00005597          	auipc	a1,0x5
ffffffffc0200280:	d4c58593          	addi	a1,a1,-692 # ffffffffc0204fc8 <etext+0x154>
ffffffffc0200284:	00005517          	auipc	a0,0x5
ffffffffc0200288:	d4c50513          	addi	a0,a0,-692 # ffffffffc0204fd0 <etext+0x15c>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc0200296:	d4e60613          	addi	a2,a2,-690 # ffffffffc0204fe0 <etext+0x16c>
ffffffffc020029a:	00005597          	auipc	a1,0x5
ffffffffc020029e:	d6e58593          	addi	a1,a1,-658 # ffffffffc0205008 <etext+0x194>
ffffffffc02002a2:	00005517          	auipc	a0,0x5
ffffffffc02002a6:	d2e50513          	addi	a0,a0,-722 # ffffffffc0204fd0 <etext+0x15c>
ffffffffc02002aa:	ed7ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ae:	00005617          	auipc	a2,0x5
ffffffffc02002b2:	d6a60613          	addi	a2,a2,-662 # ffffffffc0205018 <etext+0x1a4>
ffffffffc02002b6:	00005597          	auipc	a1,0x5
ffffffffc02002ba:	d8258593          	addi	a1,a1,-638 # ffffffffc0205038 <etext+0x1c4>
ffffffffc02002be:	00005517          	auipc	a0,0x5
ffffffffc02002c2:	d1250513          	addi	a0,a0,-750 # ffffffffc0204fd0 <etext+0x15c>
...
ffffffffc02002fc:	d5050513          	addi	a0,a0,-688 # ffffffffc0205048 <etext+0x1d4>
kmonitor(struct trapframe *tf) {
...
ffffffffc020031e:	d5650513          	addi	a0,a0,-682 # ffffffffc0205070 <etext+0x1fc>
...
ffffffffc0200340:	da4c0c13          	addi	s8,s8,-604 # ffffffffc02050e0 <commands>
        if ((buf = readline("K> ")) != NULL) {
ffffffffc0200344:	00005917          	auipc	s2,0x5
ffffffffc0200348:	d5490913          	addi	s2,s2,-684 # ffffffffc0205098 <etext+0x224>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020034c:	00005497          	auipc	s1,0x5
ffffffffc0200350:	d5448493          	addi	s1,s1,-684 # ffffffffc02050a0 <etext+0x22c>
        if (argc == MAXARGS - 1) {
ffffffffc0200354:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200356:	00005b17          	auipc	s6,0x5
ffffffffc020035a:	d52b0b13          	addi	s6,s6,-686 # ffffffffc02050a8 <etext+0x234>
        argv[argc ++] = buf;
ffffffffc020035e:	00005a17          	auipc	s4,0x5
ffffffffc0200362:	c6aa0a13          	addi	s4,s4,-918 # ffffffffc0204fc8 <etext+0x154>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc0200384:	d60d0d13          	addi	s10,s10,-672 # ffffffffc02050e0 <commands>
        argv[argc ++] = buf;
...
ffffffffc020038c:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc020038e:	265040ef          	jal	ra,ffffffffc0204df2 <strcmp>
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	251040ef          	jal	ra,ffffffffc0204df2 <strcmp>
...
ffffffffc02003e0:	231040ef          	jal	ra,ffffffffc0204e10 <strchr>
...
ffffffffc020041e:	1f3040ef          	jal	ra,ffffffffc0204e10 <strchr>
...
ffffffffc020043c:	c9050513          	addi	a0,a0,-880 # ffffffffc02050c8 <etext+0x254>
...
ffffffffc0200478:	cb450513          	addi	a0,a0,-844 # ffffffffc0205128 <commands+0x48>
    va_start(ap, fmt);
...
ffffffffc020048e:	c0e50513          	addi	a0,a0,-1010 # ffffffffc0206098 <default_pmm_manager+0x4d0>
...
ffffffffc02004cc:	c8050513          	addi	a0,a0,-896 # ffffffffc0205148 <commands+0x68>
    ticks = 0;
...
ffffffffc020058a:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc020058c:	0ad040ef          	jal	ra,ffffffffc0204e38 <memcpy>
    return 0;
}
...
ffffffffc02005ae:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02005b0:	089040ef          	jal	ra,ffffffffc0204e38 <memcpy>
    return 0;
}
...
ffffffffc02005fe:	b6e50513          	addi	a0,a0,-1170 # ffffffffc0205168 <commands+0x88>
...
ffffffffc0200626:	b6660613          	addi	a2,a2,-1178 # ffffffffc0205188 <commands+0xa8>
ffffffffc020062a:	06200593          	li	a1,98
ffffffffc020062e:	00005517          	auipc	a0,0x5
ffffffffc0200632:	b7250513          	addi	a0,a0,-1166 # ffffffffc02051a0 <commands+0xc0>
...
ffffffffc0200660:	b5c50513          	addi	a0,a0,-1188 # ffffffffc02051b8 <commands+0xd8>
void print_regs(struct pushregs *gpr) {
...
ffffffffc0200670:	b6450513          	addi	a0,a0,-1180 # ffffffffc02051d0 <commands+0xf0>
...
ffffffffc020067e:	b6e50513          	addi	a0,a0,-1170 # ffffffffc02051e8 <commands+0x108>
...
ffffffffc020068c:	b7850513          	addi	a0,a0,-1160 # ffffffffc0205200 <commands+0x120>
...
ffffffffc020069a:	b8250513          	addi	a0,a0,-1150 # ffffffffc0205218 <commands+0x138>
...
ffffffffc02006a8:	b8c50513          	addi	a0,a0,-1140 # ffffffffc0205230 <commands+0x150>
...
ffffffffc02006b6:	b9650513          	addi	a0,a0,-1130 # ffffffffc0205248 <commands+0x168>
...
ffffffffc02006c4:	ba050513          	addi	a0,a0,-1120 # ffffffffc0205260 <commands+0x180>
...
ffffffffc02006d2:	baa50513          	addi	a0,a0,-1110 # ffffffffc0205278 <commands+0x198>
...
ffffffffc02006e0:	bb450513          	addi	a0,a0,-1100 # ffffffffc0205290 <commands+0x1b0>
...
ffffffffc02006ee:	bbe50513          	addi	a0,a0,-1090 # ffffffffc02052a8 <commands+0x1c8>
...
ffffffffc02006fc:	bc850513          	addi	a0,a0,-1080 # ffffffffc02052c0 <commands+0x1e0>
...
ffffffffc020070a:	bd250513          	addi	a0,a0,-1070 # ffffffffc02052d8 <commands+0x1f8>
...
ffffffffc0200718:	bdc50513          	addi	a0,a0,-1060 # ffffffffc02052f0 <commands+0x210>
...
ffffffffc0200726:	be650513          	addi	a0,a0,-1050 # ffffffffc0205308 <commands+0x228>
...
ffffffffc0200734:	bf050513          	addi	a0,a0,-1040 # ffffffffc0205320 <commands+0x240>
...
ffffffffc0200742:	bfa50513          	addi	a0,a0,-1030 # ffffffffc0205338 <commands+0x258>
...
ffffffffc0200750:	c0450513          	addi	a0,a0,-1020 # ffffffffc0205350 <commands+0x270>
...
ffffffffc020075e:	c0e50513          	addi	a0,a0,-1010 # ffffffffc0205368 <commands+0x288>
...
ffffffffc020076c:	c1850513          	addi	a0,a0,-1000 # ffffffffc0205380 <commands+0x2a0>
...
ffffffffc020077a:	c2250513          	addi	a0,a0,-990 # ffffffffc0205398 <commands+0x2b8>
...
ffffffffc0200788:	c2c50513          	addi	a0,a0,-980 # ffffffffc02053b0 <commands+0x2d0>
...
ffffffffc0200796:	c3650513          	addi	a0,a0,-970 # ffffffffc02053c8 <commands+0x2e8>
...
ffffffffc02007a4:	c4050513          	addi	a0,a0,-960 # ffffffffc02053e0 <commands+0x300>
...
ffffffffc02007b2:	c4a50513          	addi	a0,a0,-950 # ffffffffc02053f8 <commands+0x318>
ffffffffc02007b6:	9cbff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  s9       0x%08x\n", gpr->s9);
ffffffffc02007ba:	646c                	ld	a1,200(s0)
ffffffffc02007bc:	00005517          	auipc	a0,0x5
ffffffffc02007c0:	c5450513          	addi	a0,a0,-940 # ffffffffc0205410 <commands+0x330>
...
ffffffffc02007ce:	c5e50513          	addi	a0,a0,-930 # ffffffffc0205428 <commands+0x348>
...
ffffffffc02007dc:	c6850513          	addi	a0,a0,-920 # ffffffffc0205440 <commands+0x360>
...
ffffffffc02007ea:	c7250513          	addi	a0,a0,-910 # ffffffffc0205458 <commands+0x378>
...
ffffffffc02007f8:	c7c50513          	addi	a0,a0,-900 # ffffffffc0205470 <commands+0x390>
...
ffffffffc0200806:	c8650513          	addi	a0,a0,-890 # ffffffffc0205488 <commands+0x3a8>
...
ffffffffc0200818:	c8c50513          	addi	a0,a0,-884 # ffffffffc02054a0 <commands+0x3c0>
}
...
ffffffffc020082c:	c9050513          	addi	a0,a0,-880 # ffffffffc02054b8 <commands+0x3d8>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc0200844:	c9050513          	addi	a0,a0,-880 # ffffffffc02054d0 <commands+0x3f0>
...
ffffffffc0200854:	c9850513          	addi	a0,a0,-872 # ffffffffc02054e8 <commands+0x408>
...
ffffffffc0200864:	ca050513          	addi	a0,a0,-864 # ffffffffc0205500 <commands+0x420>
...
ffffffffc0200878:	ca450513          	addi	a0,a0,-860 # ffffffffc0205518 <commands+0x438>
}
...
ffffffffc0200894:	d5070713          	addi	a4,a4,-688 # ffffffffc02055e0 <commands+0x500>
...
ffffffffc02008a6:	cee50513          	addi	a0,a0,-786 # ffffffffc0205590 <commands+0x4b0>
ffffffffc02008aa:	8d7ff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02008ae:	00005517          	auipc	a0,0x5
ffffffffc02008b2:	cc250513          	addi	a0,a0,-830 # ffffffffc0205570 <commands+0x490>
ffffffffc02008b6:	8cbff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02008ba:	00005517          	auipc	a0,0x5
ffffffffc02008be:	c7650513          	addi	a0,a0,-906 # ffffffffc0205530 <commands+0x450>
ffffffffc02008c2:	8bfff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02008c6:	00005517          	auipc	a0,0x5
ffffffffc02008ca:	c8a50513          	addi	a0,a0,-886 # ffffffffc0205550 <commands+0x470>
...
ffffffffc02008fc:	cc850513          	addi	a0,a0,-824 # ffffffffc02055c0 <commands+0x4e0>
...
ffffffffc0200910:	ca450513          	addi	a0,a0,-860 # ffffffffc02055b0 <commands+0x4d0>
}
...
ffffffffc0200932:	e9a70713          	addi	a4,a4,-358 # ffffffffc02057c8 <commands+0x6e8>
...
ffffffffc0200944:	e7050513          	addi	a0,a0,-400 # ffffffffc02057b0 <commands+0x6d0>
...
ffffffffc0200966:	cae50513          	addi	a0,a0,-850 # ffffffffc0205610 <commands+0x530>
}
...
ffffffffc02009c0:	cf460613          	addi	a2,a2,-780 # ffffffffc02056b0 <commands+0x5d0>
ffffffffc02009c4:	0b300593          	li	a1,179
ffffffffc02009c8:	00004517          	auipc	a0,0x4
ffffffffc02009cc:	7d850513          	addi	a0,a0,2008 # ffffffffc02051a0 <commands+0xc0>
ffffffffc02009d0:	a77ff0ef          	jal	ra,ffffffffc0200446 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc02009d4:	00005517          	auipc	a0,0x5
ffffffffc02009d8:	cfc50513          	addi	a0,a0,-772 # ffffffffc02056d0 <commands+0x5f0>
ffffffffc02009dc:	b779                	j	ffffffffc020096a <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc02009de:	00005517          	auipc	a0,0x5
ffffffffc02009e2:	d0a50513          	addi	a0,a0,-758 # ffffffffc02056e8 <commands+0x608>
...
ffffffffc0200a6a:	c4a60613          	addi	a2,a2,-950 # ffffffffc02056b0 <commands+0x5d0>
ffffffffc0200a6e:	0d300593          	li	a1,211
ffffffffc0200a72:	00004517          	auipc	a0,0x4
ffffffffc0200a76:	72e50513          	addi	a0,a0,1838 # ffffffffc02051a0 <commands+0xc0>
...
ffffffffc0200a96:	c1e60613          	addi	a2,a2,-994 # ffffffffc02056b0 <commands+0x5d0>
ffffffffc0200a9a:	0da00593          	li	a1,218
ffffffffc0200a9e:	00004517          	auipc	a0,0x4
ffffffffc0200aa2:	70250513          	addi	a0,a0,1794 # ffffffffc02051a0 <commands+0xc0>
...
ffffffffc0200c2e:	32e63603          	ld	a2,814(a2) # ffffffffc0206f58 <nbase>
...
ffffffffc0200e74:	99868693          	addi	a3,a3,-1640 # ffffffffc0205808 <commands+0x728>
ffffffffc0200e78:	00005617          	auipc	a2,0x5
ffffffffc0200e7c:	9a060613          	addi	a2,a2,-1632 # ffffffffc0205818 <commands+0x738>
ffffffffc0200e80:	0f000593          	li	a1,240
ffffffffc0200e84:	00005517          	auipc	a0,0x5
ffffffffc0200e88:	9ac50513          	addi	a0,a0,-1620 # ffffffffc0205830 <commands+0x750>
ffffffffc0200e8c:	dbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200e90:	00005697          	auipc	a3,0x5
ffffffffc0200e94:	a3868693          	addi	a3,a3,-1480 # ffffffffc02058c8 <commands+0x7e8>
ffffffffc0200e98:	00005617          	auipc	a2,0x5
ffffffffc0200e9c:	98060613          	addi	a2,a2,-1664 # ffffffffc0205818 <commands+0x738>
ffffffffc0200ea0:	0bd00593          	li	a1,189
ffffffffc0200ea4:	00005517          	auipc	a0,0x5
ffffffffc0200ea8:	98c50513          	addi	a0,a0,-1652 # ffffffffc0205830 <commands+0x750>
ffffffffc0200eac:	d9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200eb0:	00005697          	auipc	a3,0x5
ffffffffc0200eb4:	a4068693          	addi	a3,a3,-1472 # ffffffffc02058f0 <commands+0x810>
ffffffffc0200eb8:	00005617          	auipc	a2,0x5
ffffffffc0200ebc:	96060613          	addi	a2,a2,-1696 # ffffffffc0205818 <commands+0x738>
ffffffffc0200ec0:	0be00593          	li	a1,190
ffffffffc0200ec4:	00005517          	auipc	a0,0x5
ffffffffc0200ec8:	96c50513          	addi	a0,a0,-1684 # ffffffffc0205830 <commands+0x750>
ffffffffc0200ecc:	d7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200ed0:	00005697          	auipc	a3,0x5
ffffffffc0200ed4:	a6068693          	addi	a3,a3,-1440 # ffffffffc0205930 <commands+0x850>
ffffffffc0200ed8:	00005617          	auipc	a2,0x5
ffffffffc0200edc:	94060613          	addi	a2,a2,-1728 # ffffffffc0205818 <commands+0x738>
ffffffffc0200ee0:	0c000593          	li	a1,192
ffffffffc0200ee4:	00005517          	auipc	a0,0x5
ffffffffc0200ee8:	94c50513          	addi	a0,a0,-1716 # ffffffffc0205830 <commands+0x750>
ffffffffc0200eec:	d5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200ef0:	00005697          	auipc	a3,0x5
ffffffffc0200ef4:	ac868693          	addi	a3,a3,-1336 # ffffffffc02059b8 <commands+0x8d8>
ffffffffc0200ef8:	00005617          	auipc	a2,0x5
ffffffffc0200efc:	92060613          	addi	a2,a2,-1760 # ffffffffc0205818 <commands+0x738>
ffffffffc0200f00:	0d900593          	li	a1,217
ffffffffc0200f04:	00005517          	auipc	a0,0x5
ffffffffc0200f08:	92c50513          	addi	a0,a0,-1748 # ffffffffc0205830 <commands+0x750>
ffffffffc0200f0c:	d3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200f10:	00005697          	auipc	a3,0x5
ffffffffc0200f14:	95868693          	addi	a3,a3,-1704 # ffffffffc0205868 <commands+0x788>
ffffffffc0200f18:	00005617          	auipc	a2,0x5
ffffffffc0200f1c:	90060613          	addi	a2,a2,-1792 # ffffffffc0205818 <commands+0x738>
ffffffffc0200f20:	0d200593          	li	a1,210
ffffffffc0200f24:	00005517          	auipc	a0,0x5
ffffffffc0200f28:	90c50513          	addi	a0,a0,-1780 # ffffffffc0205830 <commands+0x750>
ffffffffc0200f2c:	d1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 3);
ffffffffc0200f30:	00005697          	auipc	a3,0x5
ffffffffc0200f34:	a7868693          	addi	a3,a3,-1416 # ffffffffc02059a8 <commands+0x8c8>
ffffffffc0200f38:	00005617          	auipc	a2,0x5
ffffffffc0200f3c:	8e060613          	addi	a2,a2,-1824 # ffffffffc0205818 <commands+0x738>
ffffffffc0200f40:	0d000593          	li	a1,208
ffffffffc0200f44:	00005517          	auipc	a0,0x5
ffffffffc0200f48:	8ec50513          	addi	a0,a0,-1812 # ffffffffc0205830 <commands+0x750>
ffffffffc0200f4c:	cfaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f50:	00005697          	auipc	a3,0x5
ffffffffc0200f54:	a4068693          	addi	a3,a3,-1472 # ffffffffc0205990 <commands+0x8b0>
ffffffffc0200f58:	00005617          	auipc	a2,0x5
ffffffffc0200f5c:	8c060613          	addi	a2,a2,-1856 # ffffffffc0205818 <commands+0x738>
ffffffffc0200f60:	0cb00593          	li	a1,203
ffffffffc0200f64:	00005517          	auipc	a0,0x5
ffffffffc0200f68:	8cc50513          	addi	a0,a0,-1844 # ffffffffc0205830 <commands+0x750>
ffffffffc0200f6c:	cdaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200f70:	00005697          	auipc	a3,0x5
ffffffffc0200f74:	a0068693          	addi	a3,a3,-1536 # ffffffffc0205970 <commands+0x890>
ffffffffc0200f78:	00005617          	auipc	a2,0x5
ffffffffc0200f7c:	8a060613          	addi	a2,a2,-1888 # ffffffffc0205818 <commands+0x738>
ffffffffc0200f80:	0c200593          	li	a1,194
ffffffffc0200f84:	00005517          	auipc	a0,0x5
ffffffffc0200f88:	8ac50513          	addi	a0,a0,-1876 # ffffffffc0205830 <commands+0x750>
ffffffffc0200f8c:	cbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 != NULL);
ffffffffc0200f90:	00005697          	auipc	a3,0x5
ffffffffc0200f94:	a7068693          	addi	a3,a3,-1424 # ffffffffc0205a00 <commands+0x920>
ffffffffc0200f98:	00005617          	auipc	a2,0x5
ffffffffc0200f9c:	88060613          	addi	a2,a2,-1920 # ffffffffc0205818 <commands+0x738>
ffffffffc0200fa0:	0f800593          	li	a1,248
ffffffffc0200fa4:	00005517          	auipc	a0,0x5
ffffffffc0200fa8:	88c50513          	addi	a0,a0,-1908 # ffffffffc0205830 <commands+0x750>
ffffffffc0200fac:	c9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 0);
ffffffffc0200fb0:	00005697          	auipc	a3,0x5
ffffffffc0200fb4:	a4068693          	addi	a3,a3,-1472 # ffffffffc02059f0 <commands+0x910>
ffffffffc0200fb8:	00005617          	auipc	a2,0x5
ffffffffc0200fbc:	86060613          	addi	a2,a2,-1952 # ffffffffc0205818 <commands+0x738>
ffffffffc0200fc0:	0df00593          	li	a1,223
ffffffffc0200fc4:	00005517          	auipc	a0,0x5
ffffffffc0200fc8:	86c50513          	addi	a0,a0,-1940 # ffffffffc0205830 <commands+0x750>
ffffffffc0200fcc:	c7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200fd0:	00005697          	auipc	a3,0x5
ffffffffc0200fd4:	9c068693          	addi	a3,a3,-1600 # ffffffffc0205990 <commands+0x8b0>
ffffffffc0200fd8:	00005617          	auipc	a2,0x5
ffffffffc0200fdc:	84060613          	addi	a2,a2,-1984 # ffffffffc0205818 <commands+0x738>
ffffffffc0200fe0:	0dd00593          	li	a1,221
ffffffffc0200fe4:	00005517          	auipc	a0,0x5
ffffffffc0200fe8:	84c50513          	addi	a0,a0,-1972 # ffffffffc0205830 <commands+0x750>
ffffffffc0200fec:	c5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0200ff0:	00005697          	auipc	a3,0x5
ffffffffc0200ff4:	9e068693          	addi	a3,a3,-1568 # ffffffffc02059d0 <commands+0x8f0>
ffffffffc0200ff8:	00005617          	auipc	a2,0x5
ffffffffc0200ffc:	82060613          	addi	a2,a2,-2016 # ffffffffc0205818 <commands+0x738>
ffffffffc0201000:	0dc00593          	li	a1,220
ffffffffc0201004:	00005517          	auipc	a0,0x5
ffffffffc0201008:	82c50513          	addi	a0,a0,-2004 # ffffffffc0205830 <commands+0x750>
ffffffffc020100c:	c3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0201010:	00005697          	auipc	a3,0x5
ffffffffc0201014:	85868693          	addi	a3,a3,-1960 # ffffffffc0205868 <commands+0x788>
ffffffffc0201018:	00005617          	auipc	a2,0x5
ffffffffc020101c:	80060613          	addi	a2,a2,-2048 # ffffffffc0205818 <commands+0x738>
ffffffffc0201020:	0b900593          	li	a1,185
ffffffffc0201024:	00005517          	auipc	a0,0x5
ffffffffc0201028:	80c50513          	addi	a0,a0,-2036 # ffffffffc0205830 <commands+0x750>
ffffffffc020102c:	c1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201030:	00005697          	auipc	a3,0x5
ffffffffc0201034:	96068693          	addi	a3,a3,-1696 # ffffffffc0205990 <commands+0x8b0>
ffffffffc0201038:	00004617          	auipc	a2,0x4
ffffffffc020103c:	7e060613          	addi	a2,a2,2016 # ffffffffc0205818 <commands+0x738>
ffffffffc0201040:	0d600593          	li	a1,214
ffffffffc0201044:	00004517          	auipc	a0,0x4
ffffffffc0201048:	7ec50513          	addi	a0,a0,2028 # ffffffffc0205830 <commands+0x750>
ffffffffc020104c:	bfaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201050:	00005697          	auipc	a3,0x5
ffffffffc0201054:	85868693          	addi	a3,a3,-1960 # ffffffffc02058a8 <commands+0x7c8>
ffffffffc0201058:	00004617          	auipc	a2,0x4
ffffffffc020105c:	7c060613          	addi	a2,a2,1984 # ffffffffc0205818 <commands+0x738>
ffffffffc0201060:	0d400593          	li	a1,212
ffffffffc0201064:	00004517          	auipc	a0,0x4
ffffffffc0201068:	7cc50513          	addi	a0,a0,1996 # ffffffffc0205830 <commands+0x750>
ffffffffc020106c:	bdaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201070:	00005697          	auipc	a3,0x5
ffffffffc0201074:	81868693          	addi	a3,a3,-2024 # ffffffffc0205888 <commands+0x7a8>
ffffffffc0201078:	00004617          	auipc	a2,0x4
ffffffffc020107c:	7a060613          	addi	a2,a2,1952 # ffffffffc0205818 <commands+0x738>
ffffffffc0201080:	0d300593          	li	a1,211
ffffffffc0201084:	00004517          	auipc	a0,0x4
ffffffffc0201088:	7ac50513          	addi	a0,a0,1964 # ffffffffc0205830 <commands+0x750>
ffffffffc020108c:	bbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201090:	00005697          	auipc	a3,0x5
ffffffffc0201094:	81868693          	addi	a3,a3,-2024 # ffffffffc02058a8 <commands+0x7c8>
ffffffffc0201098:	00004617          	auipc	a2,0x4
ffffffffc020109c:	78060613          	addi	a2,a2,1920 # ffffffffc0205818 <commands+0x738>
ffffffffc02010a0:	0bb00593          	li	a1,187
ffffffffc02010a4:	00004517          	auipc	a0,0x4
ffffffffc02010a8:	78c50513          	addi	a0,a0,1932 # ffffffffc0205830 <commands+0x750>
ffffffffc02010ac:	b9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(count == 0);
ffffffffc02010b0:	00005697          	auipc	a3,0x5
ffffffffc02010b4:	aa068693          	addi	a3,a3,-1376 # ffffffffc0205b50 <commands+0xa70>
ffffffffc02010b8:	00004617          	auipc	a2,0x4
ffffffffc02010bc:	76060613          	addi	a2,a2,1888 # ffffffffc0205818 <commands+0x738>
ffffffffc02010c0:	12500593          	li	a1,293
ffffffffc02010c4:	00004517          	auipc	a0,0x4
ffffffffc02010c8:	76c50513          	addi	a0,a0,1900 # ffffffffc0205830 <commands+0x750>
ffffffffc02010cc:	b7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 0);
ffffffffc02010d0:	00005697          	auipc	a3,0x5
ffffffffc02010d4:	92068693          	addi	a3,a3,-1760 # ffffffffc02059f0 <commands+0x910>
ffffffffc02010d8:	00004617          	auipc	a2,0x4
ffffffffc02010dc:	74060613          	addi	a2,a2,1856 # ffffffffc0205818 <commands+0x738>
ffffffffc02010e0:	11a00593          	li	a1,282
ffffffffc02010e4:	00004517          	auipc	a0,0x4
ffffffffc02010e8:	74c50513          	addi	a0,a0,1868 # ffffffffc0205830 <commands+0x750>
ffffffffc02010ec:	b5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02010f0:	00005697          	auipc	a3,0x5
ffffffffc02010f4:	8a068693          	addi	a3,a3,-1888 # ffffffffc0205990 <commands+0x8b0>
ffffffffc02010f8:	00004617          	auipc	a2,0x4
ffffffffc02010fc:	72060613          	addi	a2,a2,1824 # ffffffffc0205818 <commands+0x738>
ffffffffc0201100:	11800593          	li	a1,280
ffffffffc0201104:	00004517          	auipc	a0,0x4
ffffffffc0201108:	72c50513          	addi	a0,a0,1836 # ffffffffc0205830 <commands+0x750>
ffffffffc020110c:	b3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201110:	00005697          	auipc	a3,0x5
ffffffffc0201114:	84068693          	addi	a3,a3,-1984 # ffffffffc0205950 <commands+0x870>
ffffffffc0201118:	00004617          	auipc	a2,0x4
ffffffffc020111c:	70060613          	addi	a2,a2,1792 # ffffffffc0205818 <commands+0x738>
ffffffffc0201120:	0c100593          	li	a1,193
ffffffffc0201124:	00004517          	auipc	a0,0x4
ffffffffc0201128:	70c50513          	addi	a0,a0,1804 # ffffffffc0205830 <commands+0x750>
ffffffffc020112c:	b1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201130:	00005697          	auipc	a3,0x5
ffffffffc0201134:	9e068693          	addi	a3,a3,-1568 # ffffffffc0205b10 <commands+0xa30>
ffffffffc0201138:	00004617          	auipc	a2,0x4
ffffffffc020113c:	6e060613          	addi	a2,a2,1760 # ffffffffc0205818 <commands+0x738>
ffffffffc0201140:	11200593          	li	a1,274
ffffffffc0201144:	00004517          	auipc	a0,0x4
ffffffffc0201148:	6ec50513          	addi	a0,a0,1772 # ffffffffc0205830 <commands+0x750>
ffffffffc020114c:	afaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc0201150:	00005697          	auipc	a3,0x5
ffffffffc0201154:	9a068693          	addi	a3,a3,-1632 # ffffffffc0205af0 <commands+0xa10>
ffffffffc0201158:	00004617          	auipc	a2,0x4
ffffffffc020115c:	6c060613          	addi	a2,a2,1728 # ffffffffc0205818 <commands+0x738>
ffffffffc0201160:	11000593          	li	a1,272
ffffffffc0201164:	00004517          	auipc	a0,0x4
ffffffffc0201168:	6cc50513          	addi	a0,a0,1740 # ffffffffc0205830 <commands+0x750>
ffffffffc020116c:	adaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc0201170:	00005697          	auipc	a3,0x5
ffffffffc0201174:	95868693          	addi	a3,a3,-1704 # ffffffffc0205ac8 <commands+0x9e8>
ffffffffc0201178:	00004617          	auipc	a2,0x4
ffffffffc020117c:	6a060613          	addi	a2,a2,1696 # ffffffffc0205818 <commands+0x738>
ffffffffc0201180:	10e00593          	li	a1,270
ffffffffc0201184:	00004517          	auipc	a0,0x4
ffffffffc0201188:	6ac50513          	addi	a0,a0,1708 # ffffffffc0205830 <commands+0x750>
ffffffffc020118c:	abaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc0201190:	00005697          	auipc	a3,0x5
ffffffffc0201194:	91068693          	addi	a3,a3,-1776 # ffffffffc0205aa0 <commands+0x9c0>
ffffffffc0201198:	00004617          	auipc	a2,0x4
ffffffffc020119c:	68060613          	addi	a2,a2,1664 # ffffffffc0205818 <commands+0x738>
ffffffffc02011a0:	10d00593          	li	a1,269
ffffffffc02011a4:	00004517          	auipc	a0,0x4
ffffffffc02011a8:	68c50513          	addi	a0,a0,1676 # ffffffffc0205830 <commands+0x750>
ffffffffc02011ac:	a9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 + 2 == p1);
ffffffffc02011b0:	00005697          	auipc	a3,0x5
ffffffffc02011b4:	8e068693          	addi	a3,a3,-1824 # ffffffffc0205a90 <commands+0x9b0>
ffffffffc02011b8:	00004617          	auipc	a2,0x4
ffffffffc02011bc:	66060613          	addi	a2,a2,1632 # ffffffffc0205818 <commands+0x738>
ffffffffc02011c0:	10800593          	li	a1,264
ffffffffc02011c4:	00004517          	auipc	a0,0x4
ffffffffc02011c8:	66c50513          	addi	a0,a0,1644 # ffffffffc0205830 <commands+0x750>
ffffffffc02011cc:	a7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011d0:	00004697          	auipc	a3,0x4
ffffffffc02011d4:	7c068693          	addi	a3,a3,1984 # ffffffffc0205990 <commands+0x8b0>
ffffffffc02011d8:	00004617          	auipc	a2,0x4
ffffffffc02011dc:	64060613          	addi	a2,a2,1600 # ffffffffc0205818 <commands+0x738>
ffffffffc02011e0:	10700593          	li	a1,263
ffffffffc02011e4:	00004517          	auipc	a0,0x4
ffffffffc02011e8:	64c50513          	addi	a0,a0,1612 # ffffffffc0205830 <commands+0x750>
ffffffffc02011ec:	a5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc02011f0:	00005697          	auipc	a3,0x5
ffffffffc02011f4:	88068693          	addi	a3,a3,-1920 # ffffffffc0205a70 <commands+0x990>
ffffffffc02011f8:	00004617          	auipc	a2,0x4
ffffffffc02011fc:	62060613          	addi	a2,a2,1568 # ffffffffc0205818 <commands+0x738>
ffffffffc0201200:	10600593          	li	a1,262
ffffffffc0201204:	00004517          	auipc	a0,0x4
ffffffffc0201208:	62c50513          	addi	a0,a0,1580 # ffffffffc0205830 <commands+0x750>
ffffffffc020120c:	a3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201210:	00005697          	auipc	a3,0x5
ffffffffc0201214:	83068693          	addi	a3,a3,-2000 # ffffffffc0205a40 <commands+0x960>
ffffffffc0201218:	00004617          	auipc	a2,0x4
ffffffffc020121c:	60060613          	addi	a2,a2,1536 # ffffffffc0205818 <commands+0x738>
ffffffffc0201220:	10500593          	li	a1,261
ffffffffc0201224:	00004517          	auipc	a0,0x4
ffffffffc0201228:	60c50513          	addi	a0,a0,1548 # ffffffffc0205830 <commands+0x750>
ffffffffc020122c:	a1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201230:	00004697          	auipc	a3,0x4
ffffffffc0201234:	7f868693          	addi	a3,a3,2040 # ffffffffc0205a28 <commands+0x948>
ffffffffc0201238:	00004617          	auipc	a2,0x4
ffffffffc020123c:	5e060613          	addi	a2,a2,1504 # ffffffffc0205818 <commands+0x738>
ffffffffc0201240:	10400593          	li	a1,260
ffffffffc0201244:	00004517          	auipc	a0,0x4
ffffffffc0201248:	5ec50513          	addi	a0,a0,1516 # ffffffffc0205830 <commands+0x750>
ffffffffc020124c:	9faff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201250:	00004697          	auipc	a3,0x4
ffffffffc0201254:	74068693          	addi	a3,a3,1856 # ffffffffc0205990 <commands+0x8b0>
ffffffffc0201258:	00004617          	auipc	a2,0x4
ffffffffc020125c:	5c060613          	addi	a2,a2,1472 # ffffffffc0205818 <commands+0x738>
ffffffffc0201260:	0fe00593          	li	a1,254
ffffffffc0201264:	00004517          	auipc	a0,0x4
ffffffffc0201268:	5cc50513          	addi	a0,a0,1484 # ffffffffc0205830 <commands+0x750>
ffffffffc020126c:	9daff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(!PageProperty(p0));
ffffffffc0201270:	00004697          	auipc	a3,0x4
ffffffffc0201274:	7a068693          	addi	a3,a3,1952 # ffffffffc0205a10 <commands+0x930>
ffffffffc0201278:	00004617          	auipc	a2,0x4
ffffffffc020127c:	5a060613          	addi	a2,a2,1440 # ffffffffc0205818 <commands+0x738>
ffffffffc0201280:	0f900593          	li	a1,249
ffffffffc0201284:	00004517          	auipc	a0,0x4
ffffffffc0201288:	5ac50513          	addi	a0,a0,1452 # ffffffffc0205830 <commands+0x750>
ffffffffc020128c:	9baff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc0201290:	00005697          	auipc	a3,0x5
ffffffffc0201294:	8a068693          	addi	a3,a3,-1888 # ffffffffc0205b30 <commands+0xa50>
ffffffffc0201298:	00004617          	auipc	a2,0x4
ffffffffc020129c:	58060613          	addi	a2,a2,1408 # ffffffffc0205818 <commands+0x738>
ffffffffc02012a0:	11700593          	li	a1,279
ffffffffc02012a4:	00004517          	auipc	a0,0x4
ffffffffc02012a8:	58c50513          	addi	a0,a0,1420 # ffffffffc0205830 <commands+0x750>
ffffffffc02012ac:	99aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(total == 0);
ffffffffc02012b0:	00005697          	auipc	a3,0x5
ffffffffc02012b4:	8b068693          	addi	a3,a3,-1872 # ffffffffc0205b60 <commands+0xa80>
ffffffffc02012b8:	00004617          	auipc	a2,0x4
ffffffffc02012bc:	56060613          	addi	a2,a2,1376 # ffffffffc0205818 <commands+0x738>
ffffffffc02012c0:	12600593          	li	a1,294
ffffffffc02012c4:	00004517          	auipc	a0,0x4
ffffffffc02012c8:	56c50513          	addi	a0,a0,1388 # ffffffffc0205830 <commands+0x750>
ffffffffc02012cc:	97aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(total == nr_free_pages());
ffffffffc02012d0:	00004697          	auipc	a3,0x4
ffffffffc02012d4:	57868693          	addi	a3,a3,1400 # ffffffffc0205848 <commands+0x768>
ffffffffc02012d8:	00004617          	auipc	a2,0x4
ffffffffc02012dc:	54060613          	addi	a2,a2,1344 # ffffffffc0205818 <commands+0x738>
ffffffffc02012e0:	0f300593          	li	a1,243
ffffffffc02012e4:	00004517          	auipc	a0,0x4
ffffffffc02012e8:	54c50513          	addi	a0,a0,1356 # ffffffffc0205830 <commands+0x750>
ffffffffc02012ec:	95aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02012f0:	00004697          	auipc	a3,0x4
ffffffffc02012f4:	59868693          	addi	a3,a3,1432 # ffffffffc0205888 <commands+0x7a8>
ffffffffc02012f8:	00004617          	auipc	a2,0x4
ffffffffc02012fc:	52060613          	addi	a2,a2,1312 # ffffffffc0205818 <commands+0x738>
ffffffffc0201300:	0ba00593          	li	a1,186
ffffffffc0201304:	00004517          	auipc	a0,0x4
ffffffffc0201308:	52c50513          	addi	a0,a0,1324 # ffffffffc0205830 <commands+0x750>
...
ffffffffc0201440:	73c68693          	addi	a3,a3,1852 # ffffffffc0205b78 <commands+0xa98>
ffffffffc0201444:	00004617          	auipc	a2,0x4
ffffffffc0201448:	3d460613          	addi	a2,a2,980 # ffffffffc0205818 <commands+0x738>
ffffffffc020144c:	08300593          	li	a1,131
ffffffffc0201450:	00004517          	auipc	a0,0x4
ffffffffc0201454:	3e050513          	addi	a0,a0,992 # ffffffffc0205830 <commands+0x750>
ffffffffc0201458:	feffe0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(n > 0);
ffffffffc020145c:	00004697          	auipc	a3,0x4
ffffffffc0201460:	71468693          	addi	a3,a3,1812 # ffffffffc0205b70 <commands+0xa90>
ffffffffc0201464:	00004617          	auipc	a2,0x4
ffffffffc0201468:	3b460613          	addi	a2,a2,948 # ffffffffc0205818 <commands+0x738>
ffffffffc020146c:	08000593          	li	a1,128
ffffffffc0201470:	00004517          	auipc	a0,0x4
ffffffffc0201474:	3c050513          	addi	a0,a0,960 # ffffffffc0205830 <commands+0x750>
...
ffffffffc0201512:	66268693          	addi	a3,a3,1634 # ffffffffc0205b70 <commands+0xa90>
ffffffffc0201516:	00004617          	auipc	a2,0x4
ffffffffc020151a:	30260613          	addi	a2,a2,770 # ffffffffc0205818 <commands+0x738>
ffffffffc020151e:	06200593          	li	a1,98
ffffffffc0201522:	00004517          	auipc	a0,0x4
ffffffffc0201526:	30e50513          	addi	a0,a0,782 # ffffffffc0205830 <commands+0x750>
default_alloc_pages(size_t n) {
...
ffffffffc02015e4:	5c068693          	addi	a3,a3,1472 # ffffffffc0205ba0 <commands+0xac0>
ffffffffc02015e8:	00004617          	auipc	a2,0x4
ffffffffc02015ec:	23060613          	addi	a2,a2,560 # ffffffffc0205818 <commands+0x738>
ffffffffc02015f0:	04900593          	li	a1,73
ffffffffc02015f4:	00004517          	auipc	a0,0x4
ffffffffc02015f8:	23c50513          	addi	a0,a0,572 # ffffffffc0205830 <commands+0x750>
ffffffffc02015fc:	e4bfe0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(n > 0);
ffffffffc0201600:	00004697          	auipc	a3,0x4
ffffffffc0201604:	57068693          	addi	a3,a3,1392 # ffffffffc0205b70 <commands+0xa90>
ffffffffc0201608:	00004617          	auipc	a2,0x4
ffffffffc020160c:	21060613          	addi	a2,a2,528 # ffffffffc0205818 <commands+0x738>
ffffffffc0201610:	04600593          	li	a1,70
ffffffffc0201614:	00004517          	auipc	a0,0x4
ffffffffc0201618:	21c50513          	addi	a0,a0,540 # ffffffffc0205830 <commands+0x750>
...
ffffffffc02016f4:	8686b683          	ld	a3,-1944(a3) # ffffffffc0206f58 <nbase>
...
ffffffffc0201724:	4e060613          	addi	a2,a2,1248 # ffffffffc0205c00 <default_pmm_manager+0x38>
ffffffffc0201728:	06900593          	li	a1,105
ffffffffc020172c:	00004517          	auipc	a0,0x4
ffffffffc0201730:	4fc50513          	addi	a0,a0,1276 # ffffffffc0205c28 <default_pmm_manager+0x60>
...
ffffffffc0201812:	42a68693          	addi	a3,a3,1066 # ffffffffc0205c38 <default_pmm_manager+0x70>
ffffffffc0201816:	00004617          	auipc	a2,0x4
ffffffffc020181a:	00260613          	addi	a2,a2,2 # ffffffffc0205818 <commands+0x738>
ffffffffc020181e:	06300593          	li	a1,99
ffffffffc0201822:	00004517          	auipc	a0,0x4
ffffffffc0201826:	43650513          	addi	a0,a0,1078 # ffffffffc0205c58 <default_pmm_manager+0x90>
...
ffffffffc0201834:	44050513          	addi	a0,a0,1088 # ffffffffc0205c70 <default_pmm_manager+0xa8>
kmalloc_init(void) {
...
ffffffffc0201844:	44850513          	addi	a0,a0,1096 # ffffffffc0205c88 <default_pmm_manager+0xc0>
}
...
ffffffffc0201968:	5f453503          	ld	a0,1524(a0) # ffffffffc0206f58 <nbase>
...
ffffffffc02019c6:	30e60613          	addi	a2,a2,782 # ffffffffc0205cd0 <default_pmm_manager+0x108>
ffffffffc02019ca:	06200593          	li	a1,98
ffffffffc02019ce:	00004517          	auipc	a0,0x4
ffffffffc02019d2:	25a50513          	addi	a0,a0,602 # ffffffffc0205c28 <default_pmm_manager+0x60>
...
ffffffffc02019e0:	2cc60613          	addi	a2,a2,716 # ffffffffc0205ca8 <default_pmm_manager+0xe0>
ffffffffc02019e4:	06e00593          	li	a1,110
ffffffffc02019e8:	00004517          	auipc	a0,0x4
ffffffffc02019ec:	24050513          	addi	a0,a0,576 # ffffffffc0205c28 <default_pmm_manager+0x60>
...
ffffffffc02019fa:	2da60613          	addi	a2,a2,730 # ffffffffc0205cd0 <default_pmm_manager+0x108>
ffffffffc02019fe:	06200593          	li	a1,98
ffffffffc0201a02:	00004517          	auipc	a0,0x4
ffffffffc0201a06:	22650513          	addi	a0,a0,550 # ffffffffc0205c28 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc0201a16:	2de60613          	addi	a2,a2,734 # ffffffffc0205cf0 <default_pmm_manager+0x128>
ffffffffc0201a1a:	07400593          	li	a1,116
ffffffffc0201a1e:	00004517          	auipc	a0,0x4
ffffffffc0201a22:	20a50513          	addi	a0,a0,522 # ffffffffc0205c28 <default_pmm_manager+0x60>
pte2page(pte_t pte) {
...
ffffffffc0201bbe:	268030ef          	jal	ra,ffffffffc0204e26 <memset>
    return page - pages + nbase;
...
ffffffffc0201c50:	1d6030ef          	jal	ra,ffffffffc0204e26 <memset>
    return page - pages + nbase;
...
ffffffffc0201caa:	f5a60613          	addi	a2,a2,-166 # ffffffffc0205c00 <default_pmm_manager+0x38>
ffffffffc0201cae:	0e400593          	li	a1,228
ffffffffc0201cb2:	00004517          	auipc	a0,0x4
ffffffffc0201cb6:	06650513          	addi	a0,a0,102 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc0201cba:	f8cfe0ef          	jal	ra,ffffffffc0200446 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201cbe:	00004617          	auipc	a2,0x4
ffffffffc0201cc2:	f4260613          	addi	a2,a2,-190 # ffffffffc0205c00 <default_pmm_manager+0x38>
ffffffffc0201cc6:	0ef00593          	li	a1,239
ffffffffc0201cca:	00004517          	auipc	a0,0x4
ffffffffc0201cce:	04e50513          	addi	a0,a0,78 # ffffffffc0205d18 <default_pmm_manager+0x150>
...
ffffffffc0201cdc:	f2860613          	addi	a2,a2,-216 # ffffffffc0205c00 <default_pmm_manager+0x38>
ffffffffc0201ce0:	0ec00593          	li	a1,236
ffffffffc0201ce4:	00004517          	auipc	a0,0x4
ffffffffc0201ce8:	03450513          	addi	a0,a0,52 # ffffffffc0205d18 <default_pmm_manager+0x150>
...
ffffffffc0201cf6:	f0e60613          	addi	a2,a2,-242 # ffffffffc0205c00 <default_pmm_manager+0x38>
ffffffffc0201cfa:	0e100593          	li	a1,225
ffffffffc0201cfe:	00004517          	auipc	a0,0x4
ffffffffc0201d02:	01a50513          	addi	a0,a0,26 # ffffffffc0205d18 <default_pmm_manager+0x150>
...
ffffffffc0201ef4:	cd878793          	addi	a5,a5,-808 # ffffffffc0205bc8 <default_pmm_manager>
...
ffffffffc0201f02:	e2a50513          	addi	a0,a0,-470 # ffffffffc0205d28 <default_pmm_manager+0x160>
    pmm_manager = &default_pmm_manager;
...
ffffffffc0201f50:	df450513          	addi	a0,a0,-524 # ffffffffc0205d40 <default_pmm_manager+0x178>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0201f70:	dec50513          	addi	a0,a0,-532 # ffffffffc0205d58 <default_pmm_manager+0x190>
...
ffffffffc0201fd8:	dac50513          	addi	a0,a0,-596 # ffffffffc0205d80 <default_pmm_manager+0x1b8>
...
ffffffffc0201ff4:	da850513          	addi	a0,a0,-600 # ffffffffc0205d98 <default_pmm_manager+0x1d0>
...
ffffffffc0202294:	df050513          	addi	a0,a0,-528 # ffffffffc0206080 <default_pmm_manager+0x4b8>
...
ffffffffc020234a:	e7258593          	addi	a1,a1,-398 # ffffffffc02061b8 <default_pmm_manager+0x5f0>
ffffffffc020234e:	10000513          	li	a0,256
ffffffffc0202352:	28f020ef          	jal	ra,ffffffffc0204de0 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202356:	10040593          	addi	a1,s0,256
ffffffffc020235a:	10000513          	li	a0,256
ffffffffc020235e:	295020ef          	jal	ra,ffffffffc0204df2 <strcmp>
...
ffffffffc0202390:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202394:	217020ef          	jal	ra,ffffffffc0204daa <strlen>
...
ffffffffc0202458:	ddc50513          	addi	a0,a0,-548 # ffffffffc0206230 <default_pmm_manager+0x668>
...
ffffffffc0202572:	b7268693          	addi	a3,a3,-1166 # ffffffffc02060e0 <default_pmm_manager+0x518>
ffffffffc0202576:	00003617          	auipc	a2,0x3
ffffffffc020257a:	2a260613          	addi	a2,a2,674 # ffffffffc0205818 <commands+0x738>
ffffffffc020257e:	19e00593          	li	a1,414
ffffffffc0202582:	00003517          	auipc	a0,0x3
ffffffffc0202586:	79650513          	addi	a0,a0,1942 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc020258a:	ebdfd0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc020258e:	00004697          	auipc	a3,0x4
ffffffffc0202592:	b1268693          	addi	a3,a3,-1262 # ffffffffc02060a0 <default_pmm_manager+0x4d8>
ffffffffc0202596:	00003617          	auipc	a2,0x3
ffffffffc020259a:	28260613          	addi	a2,a2,642 # ffffffffc0205818 <commands+0x738>
ffffffffc020259e:	19d00593          	li	a1,413
ffffffffc02025a2:	00003517          	auipc	a0,0x3
ffffffffc02025a6:	77650513          	addi	a0,a0,1910 # ffffffffc0205d18 <default_pmm_manager+0x150>
...
ffffffffc02025b4:	65060613          	addi	a2,a2,1616 # ffffffffc0205c00 <default_pmm_manager+0x38>
ffffffffc02025b8:	19d00593          	li	a1,413
ffffffffc02025bc:	00003517          	auipc	a0,0x3
ffffffffc02025c0:	75c50513          	addi	a0,a0,1884 # ffffffffc0205d18 <default_pmm_manager+0x150>
...
ffffffffc02025d0:	6dc60613          	addi	a2,a2,1756 # ffffffffc0205ca8 <default_pmm_manager+0xe0>
ffffffffc02025d4:	07f00593          	li	a1,127
ffffffffc02025d8:	00003517          	auipc	a0,0x3
ffffffffc02025dc:	74050513          	addi	a0,a0,1856 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc02025e0:	e67fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc02025e4:	00003617          	auipc	a2,0x3
ffffffffc02025e8:	6c460613          	addi	a2,a2,1732 # ffffffffc0205ca8 <default_pmm_manager+0xe0>
ffffffffc02025ec:	0c300593          	li	a1,195
ffffffffc02025f0:	00003517          	auipc	a0,0x3
ffffffffc02025f4:	72850513          	addi	a0,a0,1832 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc02025f8:	e4ffd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc02025fc:	00003697          	auipc	a3,0x3
ffffffffc0202600:	7dc68693          	addi	a3,a3,2012 # ffffffffc0205dd8 <default_pmm_manager+0x210>
ffffffffc0202604:	00003617          	auipc	a2,0x3
ffffffffc0202608:	21460613          	addi	a2,a2,532 # ffffffffc0205818 <commands+0x738>
ffffffffc020260c:	16100593          	li	a1,353
ffffffffc0202610:	00003517          	auipc	a0,0x3
ffffffffc0202614:	70850513          	addi	a0,a0,1800 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc0202618:	e2ffd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc020261c:	00003697          	auipc	a3,0x3
ffffffffc0202620:	79c68693          	addi	a3,a3,1948 # ffffffffc0205db8 <default_pmm_manager+0x1f0>
ffffffffc0202624:	00003617          	auipc	a2,0x3
ffffffffc0202628:	1f460613          	addi	a2,a2,500 # ffffffffc0205818 <commands+0x738>
ffffffffc020262c:	16000593          	li	a1,352
ffffffffc0202630:	00003517          	auipc	a0,0x3
ffffffffc0202634:	6e850513          	addi	a0,a0,1768 # ffffffffc0205d18 <default_pmm_manager+0x150>
...
ffffffffc0202644:	82868693          	addi	a3,a3,-2008 # ffffffffc0205e68 <default_pmm_manager+0x2a0>
ffffffffc0202648:	00003617          	auipc	a2,0x3
ffffffffc020264c:	1d060613          	addi	a2,a2,464 # ffffffffc0205818 <commands+0x738>
ffffffffc0202650:	16900593          	li	a1,361
ffffffffc0202654:	00003517          	auipc	a0,0x3
ffffffffc0202658:	6c450513          	addi	a0,a0,1732 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc020265c:	debfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202660:	00003697          	auipc	a3,0x3
ffffffffc0202664:	7d868693          	addi	a3,a3,2008 # ffffffffc0205e38 <default_pmm_manager+0x270>
ffffffffc0202668:	00003617          	auipc	a2,0x3
ffffffffc020266c:	1b060613          	addi	a2,a2,432 # ffffffffc0205818 <commands+0x738>
ffffffffc0202670:	16600593          	li	a1,358
ffffffffc0202674:	00003517          	auipc	a0,0x3
ffffffffc0202678:	6a450513          	addi	a0,a0,1700 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc020267c:	dcbfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc0202680:	00003697          	auipc	a3,0x3
ffffffffc0202684:	79068693          	addi	a3,a3,1936 # ffffffffc0205e10 <default_pmm_manager+0x248>
ffffffffc0202688:	00003617          	auipc	a2,0x3
ffffffffc020268c:	19060613          	addi	a2,a2,400 # ffffffffc0205818 <commands+0x738>
ffffffffc0202690:	16200593          	li	a1,354
ffffffffc0202694:	00003517          	auipc	a0,0x3
ffffffffc0202698:	68450513          	addi	a0,a0,1668 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc020269c:	dabfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc02026a0:	00004697          	auipc	a3,0x4
ffffffffc02026a4:	85068693          	addi	a3,a3,-1968 # ffffffffc0205ef0 <default_pmm_manager+0x328>
ffffffffc02026a8:	00003617          	auipc	a2,0x3
ffffffffc02026ac:	17060613          	addi	a2,a2,368 # ffffffffc0205818 <commands+0x738>
ffffffffc02026b0:	17200593          	li	a1,370
ffffffffc02026b4:	00003517          	auipc	a0,0x3
ffffffffc02026b8:	66450513          	addi	a0,a0,1636 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc02026bc:	d8bfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc02026c0:	00004697          	auipc	a3,0x4
ffffffffc02026c4:	8d068693          	addi	a3,a3,-1840 # ffffffffc0205f90 <default_pmm_manager+0x3c8>
ffffffffc02026c8:	00003617          	auipc	a2,0x3
ffffffffc02026cc:	15060613          	addi	a2,a2,336 # ffffffffc0205818 <commands+0x738>
ffffffffc02026d0:	17700593          	li	a1,375
ffffffffc02026d4:	00003517          	auipc	a0,0x3
ffffffffc02026d8:	64450513          	addi	a0,a0,1604 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc02026dc:	d6bfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc02026e0:	00003697          	auipc	a3,0x3
ffffffffc02026e4:	7e868693          	addi	a3,a3,2024 # ffffffffc0205ec8 <default_pmm_manager+0x300>
ffffffffc02026e8:	00003617          	auipc	a2,0x3
ffffffffc02026ec:	13060613          	addi	a2,a2,304 # ffffffffc0205818 <commands+0x738>
ffffffffc02026f0:	16f00593          	li	a1,367
ffffffffc02026f4:	00003517          	auipc	a0,0x3
ffffffffc02026f8:	62450513          	addi	a0,a0,1572 # ffffffffc0205d18 <default_pmm_manager+0x150>
...
ffffffffc0202706:	4fe60613          	addi	a2,a2,1278 # ffffffffc0205c00 <default_pmm_manager+0x38>
ffffffffc020270a:	16e00593          	li	a1,366
ffffffffc020270e:	00003517          	auipc	a0,0x3
ffffffffc0202712:	60a50513          	addi	a0,a0,1546 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc0202716:	d31fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020271a:	00004697          	auipc	a3,0x4
ffffffffc020271e:	80e68693          	addi	a3,a3,-2034 # ffffffffc0205f28 <default_pmm_manager+0x360>
ffffffffc0202722:	00003617          	auipc	a2,0x3
ffffffffc0202726:	0f660613          	addi	a2,a2,246 # ffffffffc0205818 <commands+0x738>
ffffffffc020272a:	17c00593          	li	a1,380
ffffffffc020272e:	00003517          	auipc	a0,0x3
ffffffffc0202732:	5ea50513          	addi	a0,a0,1514 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc0202736:	d11fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020273a:	00004697          	auipc	a3,0x4
ffffffffc020273e:	8b668693          	addi	a3,a3,-1866 # ffffffffc0205ff0 <default_pmm_manager+0x428>
ffffffffc0202742:	00003617          	auipc	a2,0x3
ffffffffc0202746:	0d660613          	addi	a2,a2,214 # ffffffffc0205818 <commands+0x738>
ffffffffc020274a:	17b00593          	li	a1,379
ffffffffc020274e:	00003517          	auipc	a0,0x3
ffffffffc0202752:	5ca50513          	addi	a0,a0,1482 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc0202756:	cf1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc020275a:	00004697          	auipc	a3,0x4
ffffffffc020275e:	87e68693          	addi	a3,a3,-1922 # ffffffffc0205fd8 <default_pmm_manager+0x410>
ffffffffc0202762:	00003617          	auipc	a2,0x3
ffffffffc0202766:	0b660613          	addi	a2,a2,182 # ffffffffc0205818 <commands+0x738>
ffffffffc020276a:	17a00593          	li	a1,378
ffffffffc020276e:	00003517          	auipc	a0,0x3
ffffffffc0202772:	5aa50513          	addi	a0,a0,1450 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc0202776:	cd1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc020277a:	00004697          	auipc	a3,0x4
ffffffffc020277e:	82e68693          	addi	a3,a3,-2002 # ffffffffc0205fa8 <default_pmm_manager+0x3e0>
ffffffffc0202782:	00003617          	auipc	a2,0x3
ffffffffc0202786:	09660613          	addi	a2,a2,150 # ffffffffc0205818 <commands+0x738>
ffffffffc020278a:	17900593          	li	a1,377
ffffffffc020278e:	00003517          	auipc	a0,0x3
ffffffffc0202792:	58a50513          	addi	a0,a0,1418 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc0202796:	cb1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc020279a:	00004697          	auipc	a3,0x4
ffffffffc020279e:	9c668693          	addi	a3,a3,-1594 # ffffffffc0206160 <default_pmm_manager+0x598>
ffffffffc02027a2:	00003617          	auipc	a2,0x3
ffffffffc02027a6:	07660613          	addi	a2,a2,118 # ffffffffc0205818 <commands+0x738>
ffffffffc02027aa:	1a700593          	li	a1,423
ffffffffc02027ae:	00003517          	auipc	a0,0x3
ffffffffc02027b2:	56a50513          	addi	a0,a0,1386 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc02027b6:	c91fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc02027ba:	00003697          	auipc	a3,0x3
ffffffffc02027be:	7be68693          	addi	a3,a3,1982 # ffffffffc0205f78 <default_pmm_manager+0x3b0>
ffffffffc02027c2:	00003617          	auipc	a2,0x3
ffffffffc02027c6:	05660613          	addi	a2,a2,86 # ffffffffc0205818 <commands+0x738>
ffffffffc02027ca:	17600593          	li	a1,374
ffffffffc02027ce:	00003517          	auipc	a0,0x3
ffffffffc02027d2:	54a50513          	addi	a0,a0,1354 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc02027d6:	c71fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*ptep & PTE_W);
ffffffffc02027da:	00003697          	auipc	a3,0x3
ffffffffc02027de:	78e68693          	addi	a3,a3,1934 # ffffffffc0205f68 <default_pmm_manager+0x3a0>
ffffffffc02027e2:	00003617          	auipc	a2,0x3
ffffffffc02027e6:	03660613          	addi	a2,a2,54 # ffffffffc0205818 <commands+0x738>
ffffffffc02027ea:	17500593          	li	a1,373
ffffffffc02027ee:	00003517          	auipc	a0,0x3
ffffffffc02027f2:	52a50513          	addi	a0,a0,1322 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc02027f6:	c51fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc02027fa:	00004697          	auipc	a3,0x4
ffffffffc02027fe:	86668693          	addi	a3,a3,-1946 # ffffffffc0206060 <default_pmm_manager+0x498>
ffffffffc0202802:	00003617          	auipc	a2,0x3
ffffffffc0202806:	01660613          	addi	a2,a2,22 # ffffffffc0205818 <commands+0x738>
ffffffffc020280a:	1b800593          	li	a1,440
ffffffffc020280e:	00003517          	auipc	a0,0x3
ffffffffc0202812:	50a50513          	addi	a0,a0,1290 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc0202816:	c31fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*ptep & PTE_U);
ffffffffc020281a:	00003697          	auipc	a3,0x3
ffffffffc020281e:	73e68693          	addi	a3,a3,1854 # ffffffffc0205f58 <default_pmm_manager+0x390>
ffffffffc0202822:	00003617          	auipc	a2,0x3
ffffffffc0202826:	ff660613          	addi	a2,a2,-10 # ffffffffc0205818 <commands+0x738>
ffffffffc020282a:	17400593          	li	a1,372
ffffffffc020282e:	00003517          	auipc	a0,0x3
ffffffffc0202832:	4ea50513          	addi	a0,a0,1258 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc0202836:	c11fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020283a:	00003697          	auipc	a3,0x3
ffffffffc020283e:	67668693          	addi	a3,a3,1654 # ffffffffc0205eb0 <default_pmm_manager+0x2e8>
ffffffffc0202842:	00003617          	auipc	a2,0x3
ffffffffc0202846:	fd660613          	addi	a2,a2,-42 # ffffffffc0205818 <commands+0x738>
ffffffffc020284a:	18100593          	li	a1,385
ffffffffc020284e:	00003517          	auipc	a0,0x3
ffffffffc0202852:	4ca50513          	addi	a0,a0,1226 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc0202856:	bf1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc020285a:	00003697          	auipc	a3,0x3
ffffffffc020285e:	7ae68693          	addi	a3,a3,1966 # ffffffffc0206008 <default_pmm_manager+0x440>
ffffffffc0202862:	00003617          	auipc	a2,0x3
ffffffffc0202866:	fb660613          	addi	a2,a2,-74 # ffffffffc0205818 <commands+0x738>
ffffffffc020286a:	17e00593          	li	a1,382
ffffffffc020286e:	00003517          	auipc	a0,0x3
ffffffffc0202872:	4aa50513          	addi	a0,a0,1194 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc0202876:	bd1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc020287a:	00003697          	auipc	a3,0x3
ffffffffc020287e:	61e68693          	addi	a3,a3,1566 # ffffffffc0205e98 <default_pmm_manager+0x2d0>
ffffffffc0202882:	00003617          	auipc	a2,0x3
ffffffffc0202886:	f9660613          	addi	a2,a2,-106 # ffffffffc0205818 <commands+0x738>
ffffffffc020288a:	17d00593          	li	a1,381
ffffffffc020288e:	00003517          	auipc	a0,0x3
ffffffffc0202892:	48a50513          	addi	a0,a0,1162 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc0202896:	bb1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc020289a:	00003617          	auipc	a2,0x3
ffffffffc020289e:	36660613          	addi	a2,a2,870 # ffffffffc0205c00 <default_pmm_manager+0x38>
ffffffffc02028a2:	06900593          	li	a1,105
ffffffffc02028a6:	00003517          	auipc	a0,0x3
ffffffffc02028aa:	38250513          	addi	a0,a0,898 # ffffffffc0205c28 <default_pmm_manager+0x60>
ffffffffc02028ae:	b99fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02028b2:	00003697          	auipc	a3,0x3
ffffffffc02028b6:	78668693          	addi	a3,a3,1926 # ffffffffc0206038 <default_pmm_manager+0x470>
ffffffffc02028ba:	00003617          	auipc	a2,0x3
ffffffffc02028be:	f5e60613          	addi	a2,a2,-162 # ffffffffc0205818 <commands+0x738>
ffffffffc02028c2:	18800593          	li	a1,392
ffffffffc02028c6:	00003517          	auipc	a0,0x3
ffffffffc02028ca:	45250513          	addi	a0,a0,1106 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc02028ce:	b79fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc02028d2:	00003697          	auipc	a3,0x3
ffffffffc02028d6:	71e68693          	addi	a3,a3,1822 # ffffffffc0205ff0 <default_pmm_manager+0x428>
ffffffffc02028da:	00003617          	auipc	a2,0x3
ffffffffc02028de:	f3e60613          	addi	a2,a2,-194 # ffffffffc0205818 <commands+0x738>
ffffffffc02028e2:	18600593          	li	a1,390
ffffffffc02028e6:	00003517          	auipc	a0,0x3
ffffffffc02028ea:	43250513          	addi	a0,a0,1074 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc02028ee:	b59fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc02028f2:	00003697          	auipc	a3,0x3
ffffffffc02028f6:	72e68693          	addi	a3,a3,1838 # ffffffffc0206020 <default_pmm_manager+0x458>
ffffffffc02028fa:	00003617          	auipc	a2,0x3
ffffffffc02028fe:	f1e60613          	addi	a2,a2,-226 # ffffffffc0205818 <commands+0x738>
ffffffffc0202902:	18500593          	li	a1,389
ffffffffc0202906:	00003517          	auipc	a0,0x3
ffffffffc020290a:	41250513          	addi	a0,a0,1042 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc020290e:	b39fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202912:	00003697          	auipc	a3,0x3
ffffffffc0202916:	6de68693          	addi	a3,a3,1758 # ffffffffc0205ff0 <default_pmm_manager+0x428>
ffffffffc020291a:	00003617          	auipc	a2,0x3
ffffffffc020291e:	efe60613          	addi	a2,a2,-258 # ffffffffc0205818 <commands+0x738>
ffffffffc0202922:	18200593          	li	a1,386
ffffffffc0202926:	00003517          	auipc	a0,0x3
ffffffffc020292a:	3f250513          	addi	a0,a0,1010 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc020292e:	b19fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202932:	00004697          	auipc	a3,0x4
ffffffffc0202936:	81668693          	addi	a3,a3,-2026 # ffffffffc0206148 <default_pmm_manager+0x580>
ffffffffc020293a:	00003617          	auipc	a2,0x3
ffffffffc020293e:	ede60613          	addi	a2,a2,-290 # ffffffffc0205818 <commands+0x738>
ffffffffc0202942:	1a600593          	li	a1,422
ffffffffc0202946:	00003517          	auipc	a0,0x3
ffffffffc020294a:	3d250513          	addi	a0,a0,978 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc020294e:	af9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202952:	00003697          	auipc	a3,0x3
ffffffffc0202956:	7be68693          	addi	a3,a3,1982 # ffffffffc0206110 <default_pmm_manager+0x548>
ffffffffc020295a:	00003617          	auipc	a2,0x3
ffffffffc020295e:	ebe60613          	addi	a2,a2,-322 # ffffffffc0205818 <commands+0x738>
ffffffffc0202962:	1a500593          	li	a1,421
ffffffffc0202966:	00003517          	auipc	a0,0x3
ffffffffc020296a:	3b250513          	addi	a0,a0,946 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc020296e:	ad9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc0202972:	00003697          	auipc	a3,0x3
ffffffffc0202976:	78668693          	addi	a3,a3,1926 # ffffffffc02060f8 <default_pmm_manager+0x530>
ffffffffc020297a:	00003617          	auipc	a2,0x3
ffffffffc020297e:	e9e60613          	addi	a2,a2,-354 # ffffffffc0205818 <commands+0x738>
ffffffffc0202982:	1a100593          	li	a1,417
ffffffffc0202986:	00003517          	auipc	a0,0x3
ffffffffc020298a:	39250513          	addi	a0,a0,914 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc020298e:	ab9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc0202992:	00003697          	auipc	a3,0x3
ffffffffc0202996:	6ce68693          	addi	a3,a3,1742 # ffffffffc0206060 <default_pmm_manager+0x498>
ffffffffc020299a:	00003617          	auipc	a2,0x3
ffffffffc020299e:	e7e60613          	addi	a2,a2,-386 # ffffffffc0205818 <commands+0x738>
ffffffffc02029a2:	19000593          	li	a1,400
ffffffffc02029a6:	00003517          	auipc	a0,0x3
ffffffffc02029aa:	37250513          	addi	a0,a0,882 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc02029ae:	a99fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02029b2:	00003697          	auipc	a3,0x3
ffffffffc02029b6:	4e668693          	addi	a3,a3,1254 # ffffffffc0205e98 <default_pmm_manager+0x2d0>
ffffffffc02029ba:	00003617          	auipc	a2,0x3
ffffffffc02029be:	e5e60613          	addi	a2,a2,-418 # ffffffffc0205818 <commands+0x738>
ffffffffc02029c2:	16a00593          	li	a1,362
ffffffffc02029c6:	00003517          	auipc	a0,0x3
ffffffffc02029ca:	35250513          	addi	a0,a0,850 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc02029ce:	a79fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir[0]));
ffffffffc02029d2:	00003617          	auipc	a2,0x3
ffffffffc02029d6:	22e60613          	addi	a2,a2,558 # ffffffffc0205c00 <default_pmm_manager+0x38>
ffffffffc02029da:	16d00593          	li	a1,365
ffffffffc02029de:	00003517          	auipc	a0,0x3
ffffffffc02029e2:	33a50513          	addi	a0,a0,826 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc02029e6:	a61fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc02029ea:	00003697          	auipc	a3,0x3
ffffffffc02029ee:	4c668693          	addi	a3,a3,1222 # ffffffffc0205eb0 <default_pmm_manager+0x2e8>
ffffffffc02029f2:	00003617          	auipc	a2,0x3
ffffffffc02029f6:	e2660613          	addi	a2,a2,-474 # ffffffffc0205818 <commands+0x738>
ffffffffc02029fa:	16b00593          	li	a1,363
ffffffffc02029fe:	00003517          	auipc	a0,0x3
ffffffffc0202a02:	31a50513          	addi	a0,a0,794 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc0202a06:	a41fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0202a0a:	00003697          	auipc	a3,0x3
ffffffffc0202a0e:	51e68693          	addi	a3,a3,1310 # ffffffffc0205f28 <default_pmm_manager+0x360>
ffffffffc0202a12:	00003617          	auipc	a2,0x3
ffffffffc0202a16:	e0660613          	addi	a2,a2,-506 # ffffffffc0205818 <commands+0x738>
ffffffffc0202a1a:	17300593          	li	a1,371
ffffffffc0202a1e:	00003517          	auipc	a0,0x3
ffffffffc0202a22:	2fa50513          	addi	a0,a0,762 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc0202a26:	a21fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202a2a:	00003697          	auipc	a3,0x3
ffffffffc0202a2e:	7de68693          	addi	a3,a3,2014 # ffffffffc0206208 <default_pmm_manager+0x640>
ffffffffc0202a32:	00003617          	auipc	a2,0x3
ffffffffc0202a36:	de660613          	addi	a2,a2,-538 # ffffffffc0205818 <commands+0x738>
ffffffffc0202a3a:	1af00593          	li	a1,431
ffffffffc0202a3e:	00003517          	auipc	a0,0x3
ffffffffc0202a42:	2da50513          	addi	a0,a0,730 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc0202a46:	a01fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202a4a:	00003697          	auipc	a3,0x3
ffffffffc0202a4e:	78668693          	addi	a3,a3,1926 # ffffffffc02061d0 <default_pmm_manager+0x608>
ffffffffc0202a52:	00003617          	auipc	a2,0x3
ffffffffc0202a56:	dc660613          	addi	a2,a2,-570 # ffffffffc0205818 <commands+0x738>
ffffffffc0202a5a:	1ac00593          	li	a1,428
ffffffffc0202a5e:	00003517          	auipc	a0,0x3
ffffffffc0202a62:	2ba50513          	addi	a0,a0,698 # ffffffffc0205d18 <default_pmm_manager+0x150>
ffffffffc0202a66:	9e1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p) == 2);
ffffffffc0202a6a:	00003697          	auipc	a3,0x3
ffffffffc0202a6e:	73668693          	addi	a3,a3,1846 # ffffffffc02061a0 <default_pmm_manager+0x5d8>
ffffffffc0202a72:	00003617          	auipc	a2,0x3
ffffffffc0202a76:	da660613          	addi	a2,a2,-602 # ffffffffc0205818 <commands+0x738>
ffffffffc0202a7a:	1a800593          	li	a1,424
ffffffffc0202a7e:	00003517          	auipc	a0,0x3
ffffffffc0202a82:	29a50513          	addi	a0,a0,666 # ffffffffc0205d18 <default_pmm_manager+0x150>
...
ffffffffc0202af4:	76068693          	addi	a3,a3,1888 # ffffffffc0206250 <default_pmm_manager+0x688>
ffffffffc0202af8:	00003617          	auipc	a2,0x3
ffffffffc0202afc:	d2060613          	addi	a2,a2,-736 # ffffffffc0205818 <commands+0x738>
ffffffffc0202b00:	14800593          	li	a1,328
ffffffffc0202b04:	00003517          	auipc	a0,0x3
ffffffffc0202b08:	21450513          	addi	a0,a0,532 # ffffffffc0205d18 <default_pmm_manager+0x150>
...
ffffffffc0202b4e:	18660613          	addi	a2,a2,390 # ffffffffc0205cd0 <default_pmm_manager+0x108>
ffffffffc0202b52:	06200593          	li	a1,98
ffffffffc0202b56:	00003517          	auipc	a0,0x3
ffffffffc0202b5a:	0d250513          	addi	a0,a0,210 # ffffffffc0205c28 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc0202bde:	6be50513          	addi	a0,a0,1726 # ffffffffc0206298 <default_pmm_manager+0x6d0>
    return listelm->next;
...
ffffffffc0202c30:	68450513          	addi	a0,a0,1668 # ffffffffc02062b0 <default_pmm_manager+0x6e8>
...
ffffffffc0202c84:	6a050513          	addi	a0,a0,1696 # ffffffffc0206320 <default_pmm_manager+0x758>
...
ffffffffc0202ca0:	6d450513          	addi	a0,a0,1748 # ffffffffc0206370 <default_pmm_manager+0x7a8>
...
ffffffffc0202d14:	6e850513          	addi	a0,a0,1768 # ffffffffc02063f8 <default_pmm_manager+0x830>
...
ffffffffc0202e2c:	13060613          	addi	a2,a2,304 # ffffffffc0206f58 <nbase>
...
ffffffffc0202e58:	64c50513          	addi	a0,a0,1612 # ffffffffc02064a0 <default_pmm_manager+0x8d8>
...
ffffffffc0202f2c:	5c850513          	addi	a0,a0,1480 # ffffffffc02064f0 <default_pmm_manager+0x928>
...
ffffffffc0202f3e:	8ce68693          	addi	a3,a3,-1842 # ffffffffc0205808 <commands+0x728>
ffffffffc0202f42:	00003617          	auipc	a2,0x3
ffffffffc0202f46:	8d660613          	addi	a2,a2,-1834 # ffffffffc0205818 <commands+0x738>
ffffffffc0202f4a:	0bd00593          	li	a1,189
ffffffffc0202f4e:	00003517          	auipc	a0,0x3
ffffffffc0202f52:	33a50513          	addi	a0,a0,826 # ffffffffc0206288 <default_pmm_manager+0x6c0>
...
ffffffffc0202f62:	d7260613          	addi	a2,a2,-654 # ffffffffc0205cd0 <default_pmm_manager+0x108>
ffffffffc0202f66:	06200593          	li	a1,98
ffffffffc0202f6a:	00003517          	auipc	a0,0x3
ffffffffc0202f6e:	cbe50513          	addi	a0,a0,-834 # ffffffffc0205c28 <default_pmm_manager+0x60>
ffffffffc0202f72:	cd4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202f76:	00003697          	auipc	a3,0x3
ffffffffc0202f7a:	50268693          	addi	a3,a3,1282 # ffffffffc0206478 <default_pmm_manager+0x8b0>
ffffffffc0202f7e:	00003617          	auipc	a2,0x3
ffffffffc0202f82:	89a60613          	addi	a2,a2,-1894 # ffffffffc0205818 <commands+0x738>
ffffffffc0202f86:	0fd00593          	li	a1,253
ffffffffc0202f8a:	00003517          	auipc	a0,0x3
ffffffffc0202f8e:	2fe50513          	addi	a0,a0,766 # ffffffffc0206288 <default_pmm_manager+0x6c0>
ffffffffc0202f92:	cb4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202f96:	00003697          	auipc	a3,0x3
ffffffffc0202f9a:	40268693          	addi	a3,a3,1026 # ffffffffc0206398 <default_pmm_manager+0x7d0>
ffffffffc0202f9e:	00003617          	auipc	a2,0x3
ffffffffc0202fa2:	87a60613          	addi	a2,a2,-1926 # ffffffffc0205818 <commands+0x738>
ffffffffc0202fa6:	0dd00593          	li	a1,221
ffffffffc0202faa:	00003517          	auipc	a0,0x3
ffffffffc0202fae:	2de50513          	addi	a0,a0,734 # ffffffffc0206288 <default_pmm_manager+0x6c0>
ffffffffc0202fb2:	c94fd0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202fb6:	00003617          	auipc	a2,0x3
ffffffffc0202fba:	2b260613          	addi	a2,a2,690 # ffffffffc0206268 <default_pmm_manager+0x6a0>
ffffffffc0202fbe:	02a00593          	li	a1,42
ffffffffc0202fc2:	00003517          	auipc	a0,0x3
ffffffffc0202fc6:	2c650513          	addi	a0,a0,710 # ffffffffc0206288 <default_pmm_manager+0x6c0>
ffffffffc0202fca:	c7cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202fce:	00003697          	auipc	a3,0x3
ffffffffc0202fd2:	49268693          	addi	a3,a3,1170 # ffffffffc0206460 <default_pmm_manager+0x898>
ffffffffc0202fd6:	00003617          	auipc	a2,0x3
ffffffffc0202fda:	84260613          	addi	a2,a2,-1982 # ffffffffc0205818 <commands+0x738>
ffffffffc0202fde:	0fc00593          	li	a1,252
ffffffffc0202fe2:	00003517          	auipc	a0,0x3
ffffffffc0202fe6:	2a650513          	addi	a0,a0,678 # ffffffffc0206288 <default_pmm_manager+0x6c0>
ffffffffc0202fea:	c5cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202fee:	00003617          	auipc	a2,0x3
ffffffffc0202ff2:	d0260613          	addi	a2,a2,-766 # ffffffffc0205cf0 <default_pmm_manager+0x128>
ffffffffc0202ff6:	07400593          	li	a1,116
ffffffffc0202ffa:	00003517          	auipc	a0,0x3
ffffffffc0202ffe:	c2e50513          	addi	a0,a0,-978 # ffffffffc0205c28 <default_pmm_manager+0x60>
ffffffffc0203002:	c44fd0ef          	jal	ra,ffffffffc0200446 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0203006:	00003697          	auipc	a3,0x3
ffffffffc020300a:	3aa68693          	addi	a3,a3,938 # ffffffffc02063b0 <default_pmm_manager+0x7e8>
ffffffffc020300e:	00003617          	auipc	a2,0x3
ffffffffc0203012:	80a60613          	addi	a2,a2,-2038 # ffffffffc0205818 <commands+0x738>
ffffffffc0203016:	0de00593          	li	a1,222
ffffffffc020301a:	00003517          	auipc	a0,0x3
ffffffffc020301e:	26e50513          	addi	a0,a0,622 # ffffffffc0206288 <default_pmm_manager+0x6c0>
ffffffffc0203022:	c24fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0203026:	00003697          	auipc	a3,0x3
ffffffffc020302a:	2c268693          	addi	a3,a3,706 # ffffffffc02062e8 <default_pmm_manager+0x720>
ffffffffc020302e:	00002617          	auipc	a2,0x2
ffffffffc0203032:	7ea60613          	addi	a2,a2,2026 # ffffffffc0205818 <commands+0x738>
ffffffffc0203036:	0c800593          	li	a1,200
ffffffffc020303a:	00003517          	auipc	a0,0x3
ffffffffc020303e:	24e50513          	addi	a0,a0,590 # ffffffffc0206288 <default_pmm_manager+0x6c0>
ffffffffc0203042:	c04fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(total == nr_free_pages());
ffffffffc0203046:	00003697          	auipc	a3,0x3
ffffffffc020304a:	80268693          	addi	a3,a3,-2046 # ffffffffc0205848 <commands+0x768>
ffffffffc020304e:	00002617          	auipc	a2,0x2
ffffffffc0203052:	7ca60613          	addi	a2,a2,1994 # ffffffffc0205818 <commands+0x738>
ffffffffc0203056:	0c000593          	li	a1,192
ffffffffc020305a:	00003517          	auipc	a0,0x3
ffffffffc020305e:	22e50513          	addi	a0,a0,558 # ffffffffc0206288 <default_pmm_manager+0x6c0>
ffffffffc0203062:	be4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert( nr_free == 0);         
ffffffffc0203066:	00003697          	auipc	a3,0x3
ffffffffc020306a:	98a68693          	addi	a3,a3,-1654 # ffffffffc02059f0 <commands+0x910>
ffffffffc020306e:	00002617          	auipc	a2,0x2
ffffffffc0203072:	7aa60613          	addi	a2,a2,1962 # ffffffffc0205818 <commands+0x738>
ffffffffc0203076:	0f400593          	li	a1,244
ffffffffc020307a:	00003517          	auipc	a0,0x3
ffffffffc020307e:	20e50513          	addi	a0,a0,526 # ffffffffc0206288 <default_pmm_manager+0x6c0>
ffffffffc0203082:	bc4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0203086:	00003697          	auipc	a3,0x3
ffffffffc020308a:	27a68693          	addi	a3,a3,634 # ffffffffc0206300 <default_pmm_manager+0x738>
ffffffffc020308e:	00002617          	auipc	a2,0x2
ffffffffc0203092:	78a60613          	addi	a2,a2,1930 # ffffffffc0205818 <commands+0x738>
ffffffffc0203096:	0cd00593          	li	a1,205
ffffffffc020309a:	00003517          	auipc	a0,0x3
ffffffffc020309e:	1ee50513          	addi	a0,a0,494 # ffffffffc0206288 <default_pmm_manager+0x6c0>
ffffffffc02030a2:	ba4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(mm != NULL);
ffffffffc02030a6:	00003697          	auipc	a3,0x3
ffffffffc02030aa:	23268693          	addi	a3,a3,562 # ffffffffc02062d8 <default_pmm_manager+0x710>
ffffffffc02030ae:	00002617          	auipc	a2,0x2
ffffffffc02030b2:	76a60613          	addi	a2,a2,1898 # ffffffffc0205818 <commands+0x738>
ffffffffc02030b6:	0c500593          	li	a1,197
ffffffffc02030ba:	00003517          	auipc	a0,0x3
ffffffffc02030be:	1ce50513          	addi	a0,a0,462 # ffffffffc0206288 <default_pmm_manager+0x6c0>
ffffffffc02030c2:	b84fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(total==0);
ffffffffc02030c6:	00003697          	auipc	a3,0x3
ffffffffc02030ca:	41a68693          	addi	a3,a3,1050 # ffffffffc02064e0 <default_pmm_manager+0x918>
ffffffffc02030ce:	00002617          	auipc	a2,0x2
ffffffffc02030d2:	74a60613          	addi	a2,a2,1866 # ffffffffc0205818 <commands+0x738>
ffffffffc02030d6:	11d00593          	li	a1,285
ffffffffc02030da:	00003517          	auipc	a0,0x3
ffffffffc02030de:	1ae50513          	addi	a0,a0,430 # ffffffffc0206288 <default_pmm_manager+0x6c0>
ffffffffc02030e2:	b64fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc02030e6:	00003617          	auipc	a2,0x3
ffffffffc02030ea:	b1a60613          	addi	a2,a2,-1254 # ffffffffc0205c00 <default_pmm_manager+0x38>
ffffffffc02030ee:	06900593          	li	a1,105
ffffffffc02030f2:	00003517          	auipc	a0,0x3
ffffffffc02030f6:	b3650513          	addi	a0,a0,-1226 # ffffffffc0205c28 <default_pmm_manager+0x60>
ffffffffc02030fa:	b4cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(count==0);
ffffffffc02030fe:	00003697          	auipc	a3,0x3
ffffffffc0203102:	3d268693          	addi	a3,a3,978 # ffffffffc02064d0 <default_pmm_manager+0x908>
ffffffffc0203106:	00002617          	auipc	a2,0x2
ffffffffc020310a:	71260613          	addi	a2,a2,1810 # ffffffffc0205818 <commands+0x738>
ffffffffc020310e:	11c00593          	li	a1,284
ffffffffc0203112:	00003517          	auipc	a0,0x3
ffffffffc0203116:	17650513          	addi	a0,a0,374 # ffffffffc0206288 <default_pmm_manager+0x6c0>
ffffffffc020311a:	b2cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==1);
ffffffffc020311e:	00003697          	auipc	a3,0x3
ffffffffc0203122:	30268693          	addi	a3,a3,770 # ffffffffc0206420 <default_pmm_manager+0x858>
ffffffffc0203126:	00002617          	auipc	a2,0x2
ffffffffc020312a:	6f260613          	addi	a2,a2,1778 # ffffffffc0205818 <commands+0x738>
ffffffffc020312e:	09600593          	li	a1,150
ffffffffc0203132:	00003517          	auipc	a0,0x3
ffffffffc0203136:	15650513          	addi	a0,a0,342 # ffffffffc0206288 <default_pmm_manager+0x6c0>
ffffffffc020313a:	b0cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc020313e:	00003697          	auipc	a3,0x3
ffffffffc0203142:	29268693          	addi	a3,a3,658 # ffffffffc02063d0 <default_pmm_manager+0x808>
ffffffffc0203146:	00002617          	auipc	a2,0x2
ffffffffc020314a:	6d260613          	addi	a2,a2,1746 # ffffffffc0205818 <commands+0x738>
ffffffffc020314e:	0eb00593          	li	a1,235
ffffffffc0203152:	00003517          	auipc	a0,0x3
ffffffffc0203156:	13650513          	addi	a0,a0,310 # ffffffffc0206288 <default_pmm_manager+0x6c0>
ffffffffc020315a:	aecfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc020315e:	00003697          	auipc	a3,0x3
ffffffffc0203162:	1fa68693          	addi	a3,a3,506 # ffffffffc0206358 <default_pmm_manager+0x790>
ffffffffc0203166:	00002617          	auipc	a2,0x2
ffffffffc020316a:	6b260613          	addi	a2,a2,1714 # ffffffffc0205818 <commands+0x738>
ffffffffc020316e:	0d800593          	li	a1,216
ffffffffc0203172:	00003517          	auipc	a0,0x3
ffffffffc0203176:	11650513          	addi	a0,a0,278 # ffffffffc0206288 <default_pmm_manager+0x6c0>
ffffffffc020317a:	accfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(ret==0);
ffffffffc020317e:	00003697          	auipc	a3,0x3
ffffffffc0203182:	34a68693          	addi	a3,a3,842 # ffffffffc02064c8 <default_pmm_manager+0x900>
ffffffffc0203186:	00002617          	auipc	a2,0x2
ffffffffc020318a:	69260613          	addi	a2,a2,1682 # ffffffffc0205818 <commands+0x738>
ffffffffc020318e:	10300593          	li	a1,259
ffffffffc0203192:	00003517          	auipc	a0,0x3
ffffffffc0203196:	0f650513          	addi	a0,a0,246 # ffffffffc0206288 <default_pmm_manager+0x6c0>
ffffffffc020319a:	aacfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(vma != NULL);
ffffffffc020319e:	00003697          	auipc	a3,0x3
ffffffffc02031a2:	17268693          	addi	a3,a3,370 # ffffffffc0206310 <default_pmm_manager+0x748>
ffffffffc02031a6:	00002617          	auipc	a2,0x2
ffffffffc02031aa:	67260613          	addi	a2,a2,1650 # ffffffffc0205818 <commands+0x738>
ffffffffc02031ae:	0d000593          	li	a1,208
ffffffffc02031b2:	00003517          	auipc	a0,0x3
ffffffffc02031b6:	0d650513          	addi	a0,a0,214 # ffffffffc0206288 <default_pmm_manager+0x6c0>
ffffffffc02031ba:	a8cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==4);
ffffffffc02031be:	00003697          	auipc	a3,0x3
ffffffffc02031c2:	29268693          	addi	a3,a3,658 # ffffffffc0206450 <default_pmm_manager+0x888>
ffffffffc02031c6:	00002617          	auipc	a2,0x2
ffffffffc02031ca:	65260613          	addi	a2,a2,1618 # ffffffffc0205818 <commands+0x738>
ffffffffc02031ce:	0a000593          	li	a1,160
ffffffffc02031d2:	00003517          	auipc	a0,0x3
ffffffffc02031d6:	0b650513          	addi	a0,a0,182 # ffffffffc0206288 <default_pmm_manager+0x6c0>
ffffffffc02031da:	a6cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==4);
ffffffffc02031de:	00003697          	auipc	a3,0x3
ffffffffc02031e2:	27268693          	addi	a3,a3,626 # ffffffffc0206450 <default_pmm_manager+0x888>
ffffffffc02031e6:	00002617          	auipc	a2,0x2
ffffffffc02031ea:	63260613          	addi	a2,a2,1586 # ffffffffc0205818 <commands+0x738>
ffffffffc02031ee:	0a200593          	li	a1,162
ffffffffc02031f2:	00003517          	auipc	a0,0x3
ffffffffc02031f6:	09650513          	addi	a0,a0,150 # ffffffffc0206288 <default_pmm_manager+0x6c0>
ffffffffc02031fa:	a4cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==2);
ffffffffc02031fe:	00003697          	auipc	a3,0x3
ffffffffc0203202:	23268693          	addi	a3,a3,562 # ffffffffc0206430 <default_pmm_manager+0x868>
ffffffffc0203206:	00002617          	auipc	a2,0x2
ffffffffc020320a:	61260613          	addi	a2,a2,1554 # ffffffffc0205818 <commands+0x738>
ffffffffc020320e:	09800593          	li	a1,152
ffffffffc0203212:	00003517          	auipc	a0,0x3
ffffffffc0203216:	07650513          	addi	a0,a0,118 # ffffffffc0206288 <default_pmm_manager+0x6c0>
ffffffffc020321a:	a2cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==2);
ffffffffc020321e:	00003697          	auipc	a3,0x3
ffffffffc0203222:	21268693          	addi	a3,a3,530 # ffffffffc0206430 <default_pmm_manager+0x868>
ffffffffc0203226:	00002617          	auipc	a2,0x2
ffffffffc020322a:	5f260613          	addi	a2,a2,1522 # ffffffffc0205818 <commands+0x738>
ffffffffc020322e:	09a00593          	li	a1,154
ffffffffc0203232:	00003517          	auipc	a0,0x3
ffffffffc0203236:	05650513          	addi	a0,a0,86 # ffffffffc0206288 <default_pmm_manager+0x6c0>
ffffffffc020323a:	a0cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==3);
ffffffffc020323e:	00003697          	auipc	a3,0x3
ffffffffc0203242:	20268693          	addi	a3,a3,514 # ffffffffc0206440 <default_pmm_manager+0x878>
ffffffffc0203246:	00002617          	auipc	a2,0x2
ffffffffc020324a:	5d260613          	addi	a2,a2,1490 # ffffffffc0205818 <commands+0x738>
ffffffffc020324e:	09c00593          	li	a1,156
ffffffffc0203252:	00003517          	auipc	a0,0x3
ffffffffc0203256:	03650513          	addi	a0,a0,54 # ffffffffc0206288 <default_pmm_manager+0x6c0>
ffffffffc020325a:	9ecfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==3);
ffffffffc020325e:	00003697          	auipc	a3,0x3
ffffffffc0203262:	1e268693          	addi	a3,a3,482 # ffffffffc0206440 <default_pmm_manager+0x878>
ffffffffc0203266:	00002617          	auipc	a2,0x2
ffffffffc020326a:	5b260613          	addi	a2,a2,1458 # ffffffffc0205818 <commands+0x738>
ffffffffc020326e:	09e00593          	li	a1,158
ffffffffc0203272:	00003517          	auipc	a0,0x3
ffffffffc0203276:	01650513          	addi	a0,a0,22 # ffffffffc0206288 <default_pmm_manager+0x6c0>
ffffffffc020327a:	9ccfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==1);
ffffffffc020327e:	00003697          	auipc	a3,0x3
ffffffffc0203282:	1a268693          	addi	a3,a3,418 # ffffffffc0206420 <default_pmm_manager+0x858>
ffffffffc0203286:	00002617          	auipc	a2,0x2
ffffffffc020328a:	59260613          	addi	a2,a2,1426 # ffffffffc0205818 <commands+0x738>
ffffffffc020328e:	09400593          	li	a1,148
ffffffffc0203292:	00003517          	auipc	a0,0x3
ffffffffc0203296:	ff650513          	addi	a0,a0,-10 # ffffffffc0206288 <default_pmm_manager+0x6c0>
...
ffffffffc02032e2:	292b0b13          	addi	s6,s6,658 # ffffffffc0206570 <default_pmm_manager+0x9a8>
                    cprintf("SWAP: failed to save\n");
ffffffffc02032e6:	00003b97          	auipc	s7,0x3
ffffffffc02032ea:	272b8b93          	addi	s7,s7,626 # ffffffffc0206558 <default_pmm_manager+0x990>
...
ffffffffc020339c:	17850513          	addi	a0,a0,376 # ffffffffc0206510 <default_pmm_manager+0x948>
...
ffffffffc02033ae:	19668693          	addi	a3,a3,406 # ffffffffc0206540 <default_pmm_manager+0x978>
ffffffffc02033b2:	00002617          	auipc	a2,0x2
ffffffffc02033b6:	46660613          	addi	a2,a2,1126 # ffffffffc0205818 <commands+0x738>
ffffffffc02033ba:	06900593          	li	a1,105
ffffffffc02033be:	00003517          	auipc	a0,0x3
ffffffffc02033c2:	eca50513          	addi	a0,a0,-310 # ffffffffc0206288 <default_pmm_manager+0x6c0>
...
ffffffffc0203406:	1be50513          	addi	a0,a0,446 # ffffffffc02065c0 <default_pmm_manager+0x9f8>
...
ffffffffc0203428:	18c68693          	addi	a3,a3,396 # ffffffffc02065b0 <default_pmm_manager+0x9e8>
ffffffffc020342c:	00002617          	auipc	a2,0x2
ffffffffc0203430:	3ec60613          	addi	a2,a2,1004 # ffffffffc0205818 <commands+0x738>
ffffffffc0203434:	07f00593          	li	a1,127
ffffffffc0203438:	00003517          	auipc	a0,0x3
ffffffffc020343c:	e5050513          	addi	a0,a0,-432 # ffffffffc0206288 <default_pmm_manager+0x6c0>
...
ffffffffc020346c:	19850513          	addi	a0,a0,408 # ffffffffc0206600 <default_pmm_manager+0xa38>
    *(unsigned char *)0x3000 = 0x0c;
...
ffffffffc02034a2:	1a250513          	addi	a0,a0,418 # ffffffffc0206640 <default_pmm_manager+0xa78>
    *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc02034c6:	1a650513          	addi	a0,a0,422 # ffffffffc0206668 <default_pmm_manager+0xaa0>
    *(unsigned char *)0x4000 = 0x0d;
...
ffffffffc02034e4:	1b050513          	addi	a0,a0,432 # ffffffffc0206690 <default_pmm_manager+0xac8>
    *(unsigned char *)0x2000 = 0x0b;
...
ffffffffc0203500:	1bc50513          	addi	a0,a0,444 # ffffffffc02066b8 <default_pmm_manager+0xaf0>
...
ffffffffc020351e:	17650513          	addi	a0,a0,374 # ffffffffc0206690 <default_pmm_manager+0xac8>
...
ffffffffc0203536:	10e50513          	addi	a0,a0,270 # ffffffffc0206640 <default_pmm_manager+0xa78>
...
ffffffffc0203550:	14450513          	addi	a0,a0,324 # ffffffffc0206690 <default_pmm_manager+0xac8>
...
ffffffffc020356a:	09a50513          	addi	a0,a0,154 # ffffffffc0206600 <default_pmm_manager+0xa38>
...
ffffffffc0203584:	0e850513          	addi	a0,a0,232 # ffffffffc0206668 <default_pmm_manager+0xaa0>
...
ffffffffc020359e:	11e50513          	addi	a0,a0,286 # ffffffffc02066b8 <default_pmm_manager+0xaf0>
...
ffffffffc02035bc:	08850513          	addi	a0,a0,136 # ffffffffc0206640 <default_pmm_manager+0xa78>
...
ffffffffc02035fa:	e5a68693          	addi	a3,a3,-422 # ffffffffc0206450 <default_pmm_manager+0x888>
ffffffffc02035fe:	00002617          	auipc	a2,0x2
ffffffffc0203602:	21a60613          	addi	a2,a2,538 # ffffffffc0205818 <commands+0x738>
ffffffffc0203606:	05100593          	li	a1,81
ffffffffc020360a:	00003517          	auipc	a0,0x3
ffffffffc020360e:	01e50513          	addi	a0,a0,30 # ffffffffc0206628 <default_pmm_manager+0xa60>
ffffffffc0203612:	e35fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==11);
ffffffffc0203616:	00003697          	auipc	a3,0x3
ffffffffc020361a:	15268693          	addi	a3,a3,338 # ffffffffc0206768 <default_pmm_manager+0xba0>
ffffffffc020361e:	00002617          	auipc	a2,0x2
ffffffffc0203622:	1fa60613          	addi	a2,a2,506 # ffffffffc0205818 <commands+0x738>
ffffffffc0203626:	07300593          	li	a1,115
ffffffffc020362a:	00003517          	auipc	a0,0x3
ffffffffc020362e:	ffe50513          	addi	a0,a0,-2 # ffffffffc0206628 <default_pmm_manager+0xa60>
ffffffffc0203632:	e15fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203636:	00003697          	auipc	a3,0x3
ffffffffc020363a:	10a68693          	addi	a3,a3,266 # ffffffffc0206740 <default_pmm_manager+0xb78>
ffffffffc020363e:	00002617          	auipc	a2,0x2
ffffffffc0203642:	1da60613          	addi	a2,a2,474 # ffffffffc0205818 <commands+0x738>
ffffffffc0203646:	07100593          	li	a1,113
ffffffffc020364a:	00003517          	auipc	a0,0x3
ffffffffc020364e:	fde50513          	addi	a0,a0,-34 # ffffffffc0206628 <default_pmm_manager+0xa60>
ffffffffc0203652:	df5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==10);
ffffffffc0203656:	00003697          	auipc	a3,0x3
ffffffffc020365a:	0da68693          	addi	a3,a3,218 # ffffffffc0206730 <default_pmm_manager+0xb68>
ffffffffc020365e:	00002617          	auipc	a2,0x2
ffffffffc0203662:	1ba60613          	addi	a2,a2,442 # ffffffffc0205818 <commands+0x738>
ffffffffc0203666:	06f00593          	li	a1,111
ffffffffc020366a:	00003517          	auipc	a0,0x3
ffffffffc020366e:	fbe50513          	addi	a0,a0,-66 # ffffffffc0206628 <default_pmm_manager+0xa60>
ffffffffc0203672:	dd5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==9);
ffffffffc0203676:	00003697          	auipc	a3,0x3
ffffffffc020367a:	0aa68693          	addi	a3,a3,170 # ffffffffc0206720 <default_pmm_manager+0xb58>
ffffffffc020367e:	00002617          	auipc	a2,0x2
ffffffffc0203682:	19a60613          	addi	a2,a2,410 # ffffffffc0205818 <commands+0x738>
ffffffffc0203686:	06c00593          	li	a1,108
ffffffffc020368a:	00003517          	auipc	a0,0x3
ffffffffc020368e:	f9e50513          	addi	a0,a0,-98 # ffffffffc0206628 <default_pmm_manager+0xa60>
ffffffffc0203692:	db5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==8);
ffffffffc0203696:	00003697          	auipc	a3,0x3
ffffffffc020369a:	07a68693          	addi	a3,a3,122 # ffffffffc0206710 <default_pmm_manager+0xb48>
ffffffffc020369e:	00002617          	auipc	a2,0x2
ffffffffc02036a2:	17a60613          	addi	a2,a2,378 # ffffffffc0205818 <commands+0x738>
ffffffffc02036a6:	06900593          	li	a1,105
ffffffffc02036aa:	00003517          	auipc	a0,0x3
ffffffffc02036ae:	f7e50513          	addi	a0,a0,-130 # ffffffffc0206628 <default_pmm_manager+0xa60>
ffffffffc02036b2:	d95fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==7);
ffffffffc02036b6:	00003697          	auipc	a3,0x3
ffffffffc02036ba:	04a68693          	addi	a3,a3,74 # ffffffffc0206700 <default_pmm_manager+0xb38>
ffffffffc02036be:	00002617          	auipc	a2,0x2
ffffffffc02036c2:	15a60613          	addi	a2,a2,346 # ffffffffc0205818 <commands+0x738>
ffffffffc02036c6:	06600593          	li	a1,102
ffffffffc02036ca:	00003517          	auipc	a0,0x3
ffffffffc02036ce:	f5e50513          	addi	a0,a0,-162 # ffffffffc0206628 <default_pmm_manager+0xa60>
ffffffffc02036d2:	d75fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==6);
ffffffffc02036d6:	00003697          	auipc	a3,0x3
ffffffffc02036da:	01a68693          	addi	a3,a3,26 # ffffffffc02066f0 <default_pmm_manager+0xb28>
ffffffffc02036de:	00002617          	auipc	a2,0x2
ffffffffc02036e2:	13a60613          	addi	a2,a2,314 # ffffffffc0205818 <commands+0x738>
ffffffffc02036e6:	06300593          	li	a1,99
ffffffffc02036ea:	00003517          	auipc	a0,0x3
ffffffffc02036ee:	f3e50513          	addi	a0,a0,-194 # ffffffffc0206628 <default_pmm_manager+0xa60>
ffffffffc02036f2:	d55fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==5);
ffffffffc02036f6:	00003697          	auipc	a3,0x3
ffffffffc02036fa:	fea68693          	addi	a3,a3,-22 # ffffffffc02066e0 <default_pmm_manager+0xb18>
ffffffffc02036fe:	00002617          	auipc	a2,0x2
ffffffffc0203702:	11a60613          	addi	a2,a2,282 # ffffffffc0205818 <commands+0x738>
ffffffffc0203706:	06000593          	li	a1,96
ffffffffc020370a:	00003517          	auipc	a0,0x3
ffffffffc020370e:	f1e50513          	addi	a0,a0,-226 # ffffffffc0206628 <default_pmm_manager+0xa60>
ffffffffc0203712:	d35fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==5);
ffffffffc0203716:	00003697          	auipc	a3,0x3
ffffffffc020371a:	fca68693          	addi	a3,a3,-54 # ffffffffc02066e0 <default_pmm_manager+0xb18>
ffffffffc020371e:	00002617          	auipc	a2,0x2
ffffffffc0203722:	0fa60613          	addi	a2,a2,250 # ffffffffc0205818 <commands+0x738>
ffffffffc0203726:	05d00593          	li	a1,93
ffffffffc020372a:	00003517          	auipc	a0,0x3
ffffffffc020372e:	efe50513          	addi	a0,a0,-258 # ffffffffc0206628 <default_pmm_manager+0xa60>
ffffffffc0203732:	d15fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203736:	00003697          	auipc	a3,0x3
ffffffffc020373a:	d1a68693          	addi	a3,a3,-742 # ffffffffc0206450 <default_pmm_manager+0x888>
ffffffffc020373e:	00002617          	auipc	a2,0x2
ffffffffc0203742:	0da60613          	addi	a2,a2,218 # ffffffffc0205818 <commands+0x738>
ffffffffc0203746:	05a00593          	li	a1,90
ffffffffc020374a:	00003517          	auipc	a0,0x3
ffffffffc020374e:	ede50513          	addi	a0,a0,-290 # ffffffffc0206628 <default_pmm_manager+0xa60>
ffffffffc0203752:	cf5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203756:	00003697          	auipc	a3,0x3
ffffffffc020375a:	cfa68693          	addi	a3,a3,-774 # ffffffffc0206450 <default_pmm_manager+0x888>
ffffffffc020375e:	00002617          	auipc	a2,0x2
ffffffffc0203762:	0ba60613          	addi	a2,a2,186 # ffffffffc0205818 <commands+0x738>
ffffffffc0203766:	05700593          	li	a1,87
ffffffffc020376a:	00003517          	auipc	a0,0x3
ffffffffc020376e:	ebe50513          	addi	a0,a0,-322 # ffffffffc0206628 <default_pmm_manager+0xa60>
ffffffffc0203772:	cd5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203776:	00003697          	auipc	a3,0x3
ffffffffc020377a:	cda68693          	addi	a3,a3,-806 # ffffffffc0206450 <default_pmm_manager+0x888>
ffffffffc020377e:	00002617          	auipc	a2,0x2
ffffffffc0203782:	09a60613          	addi	a2,a2,154 # ffffffffc0205818 <commands+0x738>
ffffffffc0203786:	05400593          	li	a1,84
ffffffffc020378a:	00003517          	auipc	a0,0x3
ffffffffc020378e:	e9e50513          	addi	a0,a0,-354 # ffffffffc0206628 <default_pmm_manager+0xa60>
...
ffffffffc02037bc:	fc068693          	addi	a3,a3,-64 # ffffffffc0206778 <default_pmm_manager+0xbb0>
ffffffffc02037c0:	00002617          	auipc	a2,0x2
ffffffffc02037c4:	05860613          	addi	a2,a2,88 # ffffffffc0205818 <commands+0x738>
ffffffffc02037c8:	04100593          	li	a1,65
ffffffffc02037cc:	00003517          	auipc	a0,0x3
ffffffffc02037d0:	e5c50513          	addi	a0,a0,-420 # ffffffffc0206628 <default_pmm_manager+0xa60>
ffffffffc02037d4:	c73fc0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(in_tick==0);
ffffffffc02037d8:	00003697          	auipc	a3,0x3
ffffffffc02037dc:	fb068693          	addi	a3,a3,-80 # ffffffffc0206788 <default_pmm_manager+0xbc0>
ffffffffc02037e0:	00002617          	auipc	a2,0x2
ffffffffc02037e4:	03860613          	addi	a2,a2,56 # ffffffffc0205818 <commands+0x738>
ffffffffc02037e8:	04200593          	li	a1,66
ffffffffc02037ec:	00003517          	auipc	a0,0x3
ffffffffc02037f0:	e3c50513          	addi	a0,a0,-452 # ffffffffc0206628 <default_pmm_manager+0xa60>
...
ffffffffc0203814:	f8868693          	addi	a3,a3,-120 # ffffffffc0206798 <default_pmm_manager+0xbd0>
...
ffffffffc0203828:	e0450513          	addi	a0,a0,-508 # ffffffffc0206628 <default_pmm_manager+0xa60>
{
...
ffffffffc0203838:	f9c68693          	addi	a3,a3,-100 # ffffffffc02067d0 <default_pmm_manager+0xc08>
ffffffffc020383c:	00002617          	auipc	a2,0x2
ffffffffc0203840:	fdc60613          	addi	a2,a2,-36 # ffffffffc0205818 <commands+0x738>
ffffffffc0203844:	07e00593          	li	a1,126
ffffffffc0203848:	00003517          	auipc	a0,0x3
ffffffffc020384c:	fa850513          	addi	a0,a0,-88 # ffffffffc02067f0 <default_pmm_manager+0xc28>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
...
ffffffffc0203980:	e8468693          	addi	a3,a3,-380 # ffffffffc0206800 <default_pmm_manager+0xc38>
ffffffffc0203984:	00002617          	auipc	a2,0x2
ffffffffc0203988:	e9460613          	addi	a2,a2,-364 # ffffffffc0205818 <commands+0x738>
ffffffffc020398c:	08500593          	li	a1,133
ffffffffc0203990:	00003517          	auipc	a0,0x3
ffffffffc0203994:	e6050513          	addi	a0,a0,-416 # ffffffffc02067f0 <default_pmm_manager+0xc28>
ffffffffc0203998:	aaffc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc020399c:	00003697          	auipc	a3,0x3
ffffffffc02039a0:	ea468693          	addi	a3,a3,-348 # ffffffffc0206840 <default_pmm_manager+0xc78>
ffffffffc02039a4:	00002617          	auipc	a2,0x2
ffffffffc02039a8:	e7460613          	addi	a2,a2,-396 # ffffffffc0205818 <commands+0x738>
ffffffffc02039ac:	07d00593          	li	a1,125
ffffffffc02039b0:	00003517          	auipc	a0,0x3
ffffffffc02039b4:	e4050513          	addi	a0,a0,-448 # ffffffffc02067f0 <default_pmm_manager+0xc28>
ffffffffc02039b8:	a8ffc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc02039bc:	00003697          	auipc	a3,0x3
ffffffffc02039c0:	e6468693          	addi	a3,a3,-412 # ffffffffc0206820 <default_pmm_manager+0xc58>
ffffffffc02039c4:	00002617          	auipc	a2,0x2
ffffffffc02039c8:	e5460613          	addi	a2,a2,-428 # ffffffffc0205818 <commands+0x738>
ffffffffc02039cc:	07c00593          	li	a1,124
ffffffffc02039d0:	00003517          	auipc	a0,0x3
ffffffffc02039d4:	e2050513          	addi	a0,a0,-480 # ffffffffc02067f0 <default_pmm_manager+0xc28>
...
ffffffffc0203a72:	8a268693          	addi	a3,a3,-1886 # ffffffffc0206310 <default_pmm_manager+0x748>
ffffffffc0203a76:	00002617          	auipc	a2,0x2
ffffffffc0203a7a:	da260613          	addi	a2,a2,-606 # ffffffffc0205818 <commands+0x738>
ffffffffc0203a7e:	0c900593          	li	a1,201
ffffffffc0203a82:	00003517          	auipc	a0,0x3
ffffffffc0203a86:	d6e50513          	addi	a0,a0,-658 # ffffffffc02067f0 <default_pmm_manager+0xc28>
...
ffffffffc0203ac6:	84e68693          	addi	a3,a3,-1970 # ffffffffc0206310 <default_pmm_manager+0x748>
ffffffffc0203aca:	00002617          	auipc	a2,0x2
ffffffffc0203ace:	d4e60613          	addi	a2,a2,-690 # ffffffffc0205818 <commands+0x738>
ffffffffc0203ad2:	0cf00593          	li	a1,207
ffffffffc0203ad6:	00003517          	auipc	a0,0x3
ffffffffc0203ada:	d1a50513          	addi	a0,a0,-742 # ffffffffc02067f0 <default_pmm_manager+0xc28>
...
ffffffffc0203b9a:	dca50513          	addi	a0,a0,-566 # ffffffffc0206960 <default_pmm_manager+0xd98>
ffffffffc0203b9e:	de2fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203ba2:	00003697          	auipc	a3,0x3
ffffffffc0203ba6:	de668693          	addi	a3,a3,-538 # ffffffffc0206988 <default_pmm_manager+0xdc0>
ffffffffc0203baa:	00002617          	auipc	a2,0x2
ffffffffc0203bae:	c6e60613          	addi	a2,a2,-914 # ffffffffc0205818 <commands+0x738>
ffffffffc0203bb2:	0f100593          	li	a1,241
ffffffffc0203bb6:	00003517          	auipc	a0,0x3
ffffffffc0203bba:	c3a50513          	addi	a0,a0,-966 # ffffffffc02067f0 <default_pmm_manager+0xc28>
...
ffffffffc0203be8:	dbc50513          	addi	a0,a0,-580 # ffffffffc02069a0 <default_pmm_manager+0xdd8>
...
ffffffffc0203cc2:	29aa3a03          	ld	s4,666(s4) # ffffffffc0206f58 <nbase>
...
ffffffffc0203d7c:	ca050513          	addi	a0,a0,-864 # ffffffffc0206a18 <default_pmm_manager+0xe50>
...
ffffffffc0203d96:	ca650513          	addi	a0,a0,-858 # ffffffffc0206a38 <default_pmm_manager+0xe70>
}
...
ffffffffc0203daa:	ad268693          	addi	a3,a3,-1326 # ffffffffc0206878 <default_pmm_manager+0xcb0>
ffffffffc0203dae:	00002617          	auipc	a2,0x2
ffffffffc0203db2:	a6a60613          	addi	a2,a2,-1430 # ffffffffc0205818 <commands+0x738>
ffffffffc0203db6:	0d800593          	li	a1,216
ffffffffc0203dba:	00003517          	auipc	a0,0x3
ffffffffc0203dbe:	a3650513          	addi	a0,a0,-1482 # ffffffffc02067f0 <default_pmm_manager+0xc28>
ffffffffc0203dc2:	e84fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203dc6:	00003697          	auipc	a3,0x3
ffffffffc0203dca:	b3a68693          	addi	a3,a3,-1222 # ffffffffc0206900 <default_pmm_manager+0xd38>
ffffffffc0203dce:	00002617          	auipc	a2,0x2
ffffffffc0203dd2:	a4a60613          	addi	a2,a2,-1462 # ffffffffc0205818 <commands+0x738>
ffffffffc0203dd6:	0e800593          	li	a1,232
ffffffffc0203dda:	00003517          	auipc	a0,0x3
ffffffffc0203dde:	a1650513          	addi	a0,a0,-1514 # ffffffffc02067f0 <default_pmm_manager+0xc28>
ffffffffc0203de2:	e64fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203de6:	00003697          	auipc	a3,0x3
ffffffffc0203dea:	b4a68693          	addi	a3,a3,-1206 # ffffffffc0206930 <default_pmm_manager+0xd68>
ffffffffc0203dee:	00002617          	auipc	a2,0x2
ffffffffc0203df2:	a2a60613          	addi	a2,a2,-1494 # ffffffffc0205818 <commands+0x738>
ffffffffc0203df6:	0e900593          	li	a1,233
ffffffffc0203dfa:	00003517          	auipc	a0,0x3
ffffffffc0203dfe:	9f650513          	addi	a0,a0,-1546 # ffffffffc02067f0 <default_pmm_manager+0xc28>
ffffffffc0203e02:	e44fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203e06:	00003697          	auipc	a3,0x3
ffffffffc0203e0a:	a5a68693          	addi	a3,a3,-1446 # ffffffffc0206860 <default_pmm_manager+0xc98>
ffffffffc0203e0e:	00002617          	auipc	a2,0x2
ffffffffc0203e12:	a0a60613          	addi	a2,a2,-1526 # ffffffffc0205818 <commands+0x738>
ffffffffc0203e16:	0d600593          	li	a1,214
ffffffffc0203e1a:	00003517          	auipc	a0,0x3
ffffffffc0203e1e:	9d650513          	addi	a0,a0,-1578 # ffffffffc02067f0 <default_pmm_manager+0xc28>
ffffffffc0203e22:	e24fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma4 == NULL);
ffffffffc0203e26:	00003697          	auipc	a3,0x3
ffffffffc0203e2a:	aba68693          	addi	a3,a3,-1350 # ffffffffc02068e0 <default_pmm_manager+0xd18>
ffffffffc0203e2e:	00002617          	auipc	a2,0x2
ffffffffc0203e32:	9ea60613          	addi	a2,a2,-1558 # ffffffffc0205818 <commands+0x738>
ffffffffc0203e36:	0e400593          	li	a1,228
ffffffffc0203e3a:	00003517          	auipc	a0,0x3
ffffffffc0203e3e:	9b650513          	addi	a0,a0,-1610 # ffffffffc02067f0 <default_pmm_manager+0xc28>
ffffffffc0203e42:	e04fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma5 == NULL);
ffffffffc0203e46:	00003697          	auipc	a3,0x3
ffffffffc0203e4a:	aaa68693          	addi	a3,a3,-1366 # ffffffffc02068f0 <default_pmm_manager+0xd28>
ffffffffc0203e4e:	00002617          	auipc	a2,0x2
ffffffffc0203e52:	9ca60613          	addi	a2,a2,-1590 # ffffffffc0205818 <commands+0x738>
ffffffffc0203e56:	0e600593          	li	a1,230
ffffffffc0203e5a:	00003517          	auipc	a0,0x3
ffffffffc0203e5e:	99650513          	addi	a0,a0,-1642 # ffffffffc02067f0 <default_pmm_manager+0xc28>
ffffffffc0203e62:	de4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma1 != NULL);
ffffffffc0203e66:	00003697          	auipc	a3,0x3
ffffffffc0203e6a:	a4a68693          	addi	a3,a3,-1462 # ffffffffc02068b0 <default_pmm_manager+0xce8>
ffffffffc0203e6e:	00002617          	auipc	a2,0x2
ffffffffc0203e72:	9aa60613          	addi	a2,a2,-1622 # ffffffffc0205818 <commands+0x738>
ffffffffc0203e76:	0de00593          	li	a1,222
ffffffffc0203e7a:	00003517          	auipc	a0,0x3
ffffffffc0203e7e:	97650513          	addi	a0,a0,-1674 # ffffffffc02067f0 <default_pmm_manager+0xc28>
ffffffffc0203e82:	dc4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma2 != NULL);
ffffffffc0203e86:	00003697          	auipc	a3,0x3
ffffffffc0203e8a:	a3a68693          	addi	a3,a3,-1478 # ffffffffc02068c0 <default_pmm_manager+0xcf8>
ffffffffc0203e8e:	00002617          	auipc	a2,0x2
ffffffffc0203e92:	98a60613          	addi	a2,a2,-1654 # ffffffffc0205818 <commands+0x738>
ffffffffc0203e96:	0e000593          	li	a1,224
ffffffffc0203e9a:	00003517          	auipc	a0,0x3
ffffffffc0203e9e:	95650513          	addi	a0,a0,-1706 # ffffffffc02067f0 <default_pmm_manager+0xc28>
ffffffffc0203ea2:	da4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma3 == NULL);
ffffffffc0203ea6:	00003697          	auipc	a3,0x3
ffffffffc0203eaa:	a2a68693          	addi	a3,a3,-1494 # ffffffffc02068d0 <default_pmm_manager+0xd08>
ffffffffc0203eae:	00002617          	auipc	a2,0x2
ffffffffc0203eb2:	96a60613          	addi	a2,a2,-1686 # ffffffffc0205818 <commands+0x738>
ffffffffc0203eb6:	0e200593          	li	a1,226
ffffffffc0203eba:	00003517          	auipc	a0,0x3
ffffffffc0203ebe:	93650513          	addi	a0,a0,-1738 # ffffffffc02067f0 <default_pmm_manager+0xc28>
ffffffffc0203ec2:	d84fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203ec6:	00003697          	auipc	a3,0x3
ffffffffc0203eca:	b8a68693          	addi	a3,a3,-1142 # ffffffffc0206a50 <default_pmm_manager+0xe88>
ffffffffc0203ece:	00002617          	auipc	a2,0x2
ffffffffc0203ed2:	94a60613          	addi	a2,a2,-1718 # ffffffffc0205818 <commands+0x738>
ffffffffc0203ed6:	10100593          	li	a1,257
ffffffffc0203eda:	00003517          	auipc	a0,0x3
ffffffffc0203ede:	91650513          	addi	a0,a0,-1770 # ffffffffc02067f0 <default_pmm_manager+0xc28>
    check_mm_struct = mm_create();
...
ffffffffc0203ef2:	42268693          	addi	a3,a3,1058 # ffffffffc0206310 <default_pmm_manager+0x748>
ffffffffc0203ef6:	00002617          	auipc	a2,0x2
ffffffffc0203efa:	92260613          	addi	a2,a2,-1758 # ffffffffc0205818 <commands+0x738>
ffffffffc0203efe:	10800593          	li	a1,264
ffffffffc0203f02:	00003517          	auipc	a0,0x3
ffffffffc0203f06:	8ee50513          	addi	a0,a0,-1810 # ffffffffc02067f0 <default_pmm_manager+0xc28>
ffffffffc0203f0a:	d3cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203f0e:	00003697          	auipc	a3,0x3
ffffffffc0203f12:	ab268693          	addi	a3,a3,-1358 # ffffffffc02069c0 <default_pmm_manager+0xdf8>
ffffffffc0203f16:	00002617          	auipc	a2,0x2
ffffffffc0203f1a:	90260613          	addi	a2,a2,-1790 # ffffffffc0205818 <commands+0x738>
ffffffffc0203f1e:	10d00593          	li	a1,269
ffffffffc0203f22:	00003517          	auipc	a0,0x3
ffffffffc0203f26:	8ce50513          	addi	a0,a0,-1842 # ffffffffc02067f0 <default_pmm_manager+0xc28>
ffffffffc0203f2a:	d1cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(sum == 0);
ffffffffc0203f2e:	00003697          	auipc	a3,0x3
ffffffffc0203f32:	ab268693          	addi	a3,a3,-1358 # ffffffffc02069e0 <default_pmm_manager+0xe18>
ffffffffc0203f36:	00002617          	auipc	a2,0x2
ffffffffc0203f3a:	8e260613          	addi	a2,a2,-1822 # ffffffffc0205818 <commands+0x738>
ffffffffc0203f3e:	11700593          	li	a1,279
ffffffffc0203f42:	00003517          	auipc	a0,0x3
ffffffffc0203f46:	8ae50513          	addi	a0,a0,-1874 # ffffffffc02067f0 <default_pmm_manager+0xc28>
ffffffffc0203f4a:	cfcfc0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203f4e:	00002617          	auipc	a2,0x2
ffffffffc0203f52:	d8260613          	addi	a2,a2,-638 # ffffffffc0205cd0 <default_pmm_manager+0x108>
ffffffffc0203f56:	06200593          	li	a1,98
ffffffffc0203f5a:	00002517          	auipc	a0,0x2
ffffffffc0203f5e:	cce50513          	addi	a0,a0,-818 # ffffffffc0205c28 <default_pmm_manager+0x60>
ffffffffc0203f62:	ce4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc0203f66:	00002617          	auipc	a2,0x2
ffffffffc0203f6a:	c9a60613          	addi	a2,a2,-870 # ffffffffc0205c00 <default_pmm_manager+0x38>
ffffffffc0203f6e:	06900593          	li	a1,105
ffffffffc0203f72:	00002517          	auipc	a0,0x2
ffffffffc0203f76:	cb650513          	addi	a0,a0,-842 # ffffffffc0205c28 <default_pmm_manager+0x60>
ffffffffc0203f7a:	cccfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203f7e:	00003697          	auipc	a3,0x3
ffffffffc0203f82:	a7268693          	addi	a3,a3,-1422 # ffffffffc02069f0 <default_pmm_manager+0xe28>
ffffffffc0203f86:	00002617          	auipc	a2,0x2
ffffffffc0203f8a:	89260613          	addi	a2,a2,-1902 # ffffffffc0205818 <commands+0x738>
ffffffffc0203f8e:	12400593          	li	a1,292
ffffffffc0203f92:	00003517          	auipc	a0,0x3
ffffffffc0203f96:	85e50513          	addi	a0,a0,-1954 # ffffffffc02067f0 <default_pmm_manager+0xc28>
ffffffffc0203f9a:	cacfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203f9e:	00002697          	auipc	a3,0x2
ffffffffc0203fa2:	36268693          	addi	a3,a3,866 # ffffffffc0206300 <default_pmm_manager+0x738>
ffffffffc0203fa6:	00002617          	auipc	a2,0x2
ffffffffc0203faa:	87260613          	addi	a2,a2,-1934 # ffffffffc0205818 <commands+0x738>
ffffffffc0203fae:	10500593          	li	a1,261
ffffffffc0203fb2:	00003517          	auipc	a0,0x3
ffffffffc0203fb6:	83e50513          	addi	a0,a0,-1986 # ffffffffc02067f0 <default_pmm_manager+0xc28>
ffffffffc0203fba:	c8cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(mm != NULL);
ffffffffc0203fbe:	00002697          	auipc	a3,0x2
ffffffffc0203fc2:	31a68693          	addi	a3,a3,794 # ffffffffc02062d8 <default_pmm_manager+0x710>
ffffffffc0203fc6:	00002617          	auipc	a2,0x2
ffffffffc0203fca:	85260613          	addi	a2,a2,-1966 # ffffffffc0205818 <commands+0x738>
ffffffffc0203fce:	0c200593          	li	a1,194
ffffffffc0203fd2:	00003517          	auipc	a0,0x3
ffffffffc0203fd6:	81e50513          	addi	a0,a0,-2018 # ffffffffc02067f0 <default_pmm_manager+0xc28>
...
ffffffffc0204080:	a3c50513          	addi	a0,a0,-1476 # ffffffffc0206ab8 <default_pmm_manager+0xef0>
...
ffffffffc0204092:	9da50513          	addi	a0,a0,-1574 # ffffffffc0206a68 <default_pmm_manager+0xea0>
...
ffffffffc02040a2:	a4250513          	addi	a0,a0,-1470 # ffffffffc0206ae0 <default_pmm_manager+0xf18>
...
ffffffffc02040b2:	9ea50513          	addi	a0,a0,-1558 # ffffffffc0206a98 <default_pmm_manager+0xed0>
...
ffffffffc02040d8:	4aa7ba23          	sd	a0,1204(a5) # ffffffffc0215588 <max_swap_offset>
}
ffffffffc02040dc:	0141                	addi	sp,sp,16
ffffffffc02040de:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc02040e0:	00003617          	auipc	a2,0x3
ffffffffc02040e4:	a2860613          	addi	a2,a2,-1496 # ffffffffc0206b08 <default_pmm_manager+0xf40>
ffffffffc02040e8:	45b5                	li	a1,13
ffffffffc02040ea:	00003517          	auipc	a0,0x3
ffffffffc02040ee:	a3e50513          	addi	a0,a0,-1474 # ffffffffc0206b28 <default_pmm_manager+0xf60>
...
ffffffffc0204104:	48873703          	ld	a4,1160(a4) # ffffffffc0215588 <max_swap_offset>
ffffffffc0204108:	04e7f563          	bgeu	a5,a4,ffffffffc0204152 <swapfs_read+0x5c>
    return page - pages + nbase;
ffffffffc020410c:	00011617          	auipc	a2,0x11
ffffffffc0204110:	46463603          	ld	a2,1124(a2) # ffffffffc0215570 <pages>
...
ffffffffc020412e:	43e6b683          	ld	a3,1086(a3) # ffffffffc0215568 <npage>
...
ffffffffc0204142:	4427b783          	ld	a5,1090(a5) # ffffffffc0215580 <va_pa_offset>
...
ffffffffc0204158:	9ec60613          	addi	a2,a2,-1556 # ffffffffc0206b40 <default_pmm_manager+0xf78>
ffffffffc020415c:	45d1                	li	a1,20
ffffffffc020415e:	00003517          	auipc	a0,0x3
ffffffffc0204162:	9ca50513          	addi	a0,a0,-1590 # ffffffffc0206b28 <default_pmm_manager+0xf60>
...
ffffffffc0204174:	a9060613          	addi	a2,a2,-1392 # ffffffffc0205c00 <default_pmm_manager+0x38>
ffffffffc0204178:	00002517          	auipc	a0,0x2
ffffffffc020417c:	ab050513          	addi	a0,a0,-1360 # ffffffffc0205c28 <default_pmm_manager+0x60>
...
ffffffffc0204192:	3fa73703          	ld	a4,1018(a4) # ffffffffc0215588 <max_swap_offset>
ffffffffc0204196:	04e7f563          	bgeu	a5,a4,ffffffffc02041e0 <swapfs_write+0x5c>
    return page - pages + nbase;
ffffffffc020419a:	00011617          	auipc	a2,0x11
ffffffffc020419e:	3d663603          	ld	a2,982(a2) # ffffffffc0215570 <pages>
...
ffffffffc02041bc:	3b06b683          	ld	a3,944(a3) # ffffffffc0215568 <npage>
...
ffffffffc02041d0:	3b47b783          	ld	a5,948(a5) # ffffffffc0215580 <va_pa_offset>
...
ffffffffc02041e6:	95e60613          	addi	a2,a2,-1698 # ffffffffc0206b40 <default_pmm_manager+0xf78>
ffffffffc02041ea:	45e5                	li	a1,25
ffffffffc02041ec:	00003517          	auipc	a0,0x3
ffffffffc02041f0:	93c50513          	addi	a0,a0,-1732 # ffffffffc0206b28 <default_pmm_manager+0xf60>
...
ffffffffc0204202:	a0260613          	addi	a2,a2,-1534 # ffffffffc0205c00 <default_pmm_manager+0x38>
ffffffffc0204206:	00002517          	auipc	a0,0x2
ffffffffc020420a:	a2250513          	addi	a0,a0,-1502 # ffffffffc0205c28 <default_pmm_manager+0x60>
...
ffffffffc0204214:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc0204216:	3da000ef          	jal	ra,ffffffffc02045f0 <do_exit>
...
ffffffffc0204250:	3d7000ef          	jal	ra,ffffffffc0204e26 <memset>
...
ffffffffc020426e:	3b9000ef          	jal	ra,ffffffffc0204e26 <memset>
...
forkret(void) {
    forkrets(current->tf);
ffffffffc020427c:	00011797          	auipc	a5,0x11
ffffffffc0204280:	3347b783          	ld	a5,820(a5) # ffffffffc02155b0 <current>
...
ffffffffc020428e:	00011497          	auipc	s1,0x11
ffffffffc0204292:	28a48493          	addi	s1,s1,650 # ffffffffc0215518 <name.2>
init_main(void *arg) {
ffffffffc0204296:	f022                	sd	s0,32(sp)
ffffffffc0204298:	e84a                	sd	s2,16(sp)
ffffffffc020429a:	842a                	mv	s0,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc020429c:	00011917          	auipc	s2,0x11
ffffffffc02042a0:	31493903          	ld	s2,788(s2) # ffffffffc02155b0 <current>
    memset(name, 0, sizeof(name));
...
ffffffffc02042d8:	8b450513          	addi	a0,a0,-1868 # ffffffffc0206b88 <default_pmm_manager+0xfc0>
ffffffffc02042dc:	ea5fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc02042e0:	00003517          	auipc	a0,0x3
ffffffffc02042e4:	8b850513          	addi	a0,a0,-1864 # ffffffffc0206b98 <default_pmm_manager+0xfd0>
...
ffffffffc02042fe:	ec4a                	sd	s2,24(sp)
    if (proc != current) {
ffffffffc0204300:	00011917          	auipc	s2,0x11
ffffffffc0204304:	2b090913          	addi	s2,s2,688 # ffffffffc02155b0 <current>
proc_run(struct proc_struct *proc) {
...
ffffffffc020433c:	53a000ef          	jal	ra,ffffffffc0204876 <switch_to>
    if (flag) {
...
ffffffffc020436a:	00011717          	auipc	a4,0x11
ffffffffc020436e:	25e72703          	lw	a4,606(a4) # ffffffffc02155c8 <nr_process>
ffffffffc0204372:	6785                	lui	a5,0x1
ffffffffc0204374:	1ef75363          	bge	a4,a5,ffffffffc020455a <do_fork+0x1f0>
...
ffffffffc020438c:	892a                	mv	s2,a0
    if(proc == NULL){
ffffffffc020438e:	1c050b63          	beqz	a0,ffffffffc0204564 <do_fork+0x1fa>
    proc->parent = current;
ffffffffc0204392:	00011997          	auipc	s3,0x11
ffffffffc0204396:	21e98993          	addi	s3,s3,542 # ffffffffc02155b0 <current>
...
ffffffffc02043a4:	e88fd0ef          	jal	ra,ffffffffc0201a2c <alloc_pages>
    if (page != NULL) {
ffffffffc02043a8:	1a050463          	beqz	a0,ffffffffc0204550 <do_fork+0x1e6>
    return page - pages + nbase;
ffffffffc02043ac:	00011697          	auipc	a3,0x11
ffffffffc02043b0:	1c46b683          	ld	a3,452(a3) # ffffffffc0215570 <pages>
ffffffffc02043b4:	40d506b3          	sub	a3,a0,a3
ffffffffc02043b8:	8699                	srai	a3,a3,0x6
ffffffffc02043ba:	00003517          	auipc	a0,0x3
ffffffffc02043be:	b9e53503          	ld	a0,-1122(a0) # ffffffffc0206f58 <nbase>
ffffffffc02043c2:	96aa                	add	a3,a3,a0
    return KADDR(page2pa(page));
ffffffffc02043c4:	00c69793          	slli	a5,a3,0xc
ffffffffc02043c8:	83b1                	srli	a5,a5,0xc
ffffffffc02043ca:	00011717          	auipc	a4,0x11
ffffffffc02043ce:	19e73703          	ld	a4,414(a4) # ffffffffc0215568 <npage>
    return page2ppn(page) << PGSHIFT;
ffffffffc02043d2:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02043d4:	1ae7fa63          	bgeu	a5,a4,ffffffffc0204588 <do_fork+0x21e>
    assert(current->mm == NULL);
ffffffffc02043d8:	0009b783          	ld	a5,0(s3)
ffffffffc02043dc:	00011717          	auipc	a4,0x11
ffffffffc02043e0:	1a473703          	ld	a4,420(a4) # ffffffffc0215580 <va_pa_offset>
ffffffffc02043e4:	96ba                	add	a3,a3,a4
ffffffffc02043e6:	779c                	ld	a5,40(a5)
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc02043e8:	00d93823          	sd	a3,16(s2)
    assert(current->mm == NULL);
ffffffffc02043ec:	16079e63          	bnez	a5,ffffffffc0204568 <do_fork+0x1fe>
...
ffffffffc0204428:	10048863          	beqz	s1,ffffffffc0204538 <do_fork+0x1ce>
    if (++ last_pid >= MAX_PID) {
ffffffffc020442c:	00006817          	auipc	a6,0x6
ffffffffc0204430:	c2c80813          	addi	a6,a6,-980 # ffffffffc020a058 <last_pid.1>
ffffffffc0204434:	00082783          	lw	a5,0(a6)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204438:	ea84                	sd	s1,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc020443a:	00000717          	auipc	a4,0x0
ffffffffc020443e:	e4270713          	addi	a4,a4,-446 # ffffffffc020427c <forkret>
    if (++ last_pid >= MAX_PID) {
ffffffffc0204442:	0017851b          	addiw	a0,a5,1
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204446:	02e93823          	sd	a4,48(s2)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc020444a:	02d93c23          	sd	a3,56(s2)
    if (++ last_pid >= MAX_PID) {
ffffffffc020444e:	00a82023          	sw	a0,0(a6)
ffffffffc0204452:	6789                	lui	a5,0x2
ffffffffc0204454:	06f55b63          	bge	a0,a5,ffffffffc02044ca <do_fork+0x160>
    if (last_pid >= next_safe) {
ffffffffc0204458:	00006317          	auipc	t1,0x6
ffffffffc020445c:	c0430313          	addi	t1,t1,-1020 # ffffffffc020a05c <next_safe.0>
ffffffffc0204460:	00032783          	lw	a5,0(t1)
ffffffffc0204464:	00011417          	auipc	s0,0x11
ffffffffc0204468:	0c440413          	addi	s0,s0,196 # ffffffffc0215528 <proc_list>
ffffffffc020446c:	06f55763          	bge	a0,a5,ffffffffc02044da <do_fork+0x170>
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0204470:	45a9                	li	a1,10
    proc->pid = get_pid();
ffffffffc0204472:	00a92223          	sw	a0,4(s2)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0204476:	2501                	sext.w	a0,a0
ffffffffc0204478:	52e000ef          	jal	ra,ffffffffc02049a6 <hash32>
ffffffffc020447c:	02051793          	slli	a5,a0,0x20
ffffffffc0204480:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0204484:	0000d797          	auipc	a5,0xd
ffffffffc0204488:	09478793          	addi	a5,a5,148 # ffffffffc0211518 <hash_list>
ffffffffc020448c:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc020448e:	651c                	ld	a5,8(a0)
ffffffffc0204490:	0d890693          	addi	a3,s2,216
ffffffffc0204494:	6418                	ld	a4,8(s0)
    prev->next = next->prev = elm;
ffffffffc0204496:	e394                	sd	a3,0(a5)
ffffffffc0204498:	e514                	sd	a3,8(a0)
    elm->next = next;
ffffffffc020449a:	0ef93023          	sd	a5,224(s2)
    elm->prev = prev;
ffffffffc020449e:	0ca93c23          	sd	a0,216(s2)
    list_add(&proc_list, &(proc->list_link));
ffffffffc02044a2:	0c890793          	addi	a5,s2,200
    prev->next = next->prev = elm;
ffffffffc02044a6:	e31c                	sd	a5,0(a4)
    wakeup_proc(proc);
ffffffffc02044a8:	854a                	mv	a0,s2
    elm->next = next;
ffffffffc02044aa:	0ce93823          	sd	a4,208(s2)
    elm->prev = prev;
ffffffffc02044ae:	0c893423          	sd	s0,200(s2)
    prev->next = next->prev = elm;
ffffffffc02044b2:	e41c                	sd	a5,8(s0)
ffffffffc02044b4:	42c000ef          	jal	ra,ffffffffc02048e0 <wakeup_proc>
    ret = proc->pid;
ffffffffc02044b8:	00492503          	lw	a0,4(s2)
}
...
ffffffffc02044c6:	6145                	addi	sp,sp,48
ffffffffc02044c8:	8082                	ret
        last_pid = 1;
ffffffffc02044ca:	4785                	li	a5,1
ffffffffc02044cc:	00f82023          	sw	a5,0(a6)
        goto inside;
ffffffffc02044d0:	4505                	li	a0,1
ffffffffc02044d2:	00006317          	auipc	t1,0x6
ffffffffc02044d6:	b8a30313          	addi	t1,t1,-1142 # ffffffffc020a05c <next_safe.0>
    return listelm->next;
ffffffffc02044da:	00011417          	auipc	s0,0x11
ffffffffc02044de:	04e40413          	addi	s0,s0,78 # ffffffffc0215528 <proc_list>
ffffffffc02044e2:	00843e03          	ld	t3,8(s0)
        next_safe = MAX_PID;
ffffffffc02044e6:	6789                	lui	a5,0x2
ffffffffc02044e8:	00f32023          	sw	a5,0(t1)
ffffffffc02044ec:	86aa                	mv	a3,a0
ffffffffc02044ee:	4581                	li	a1,0
        while ((le = list_next(le)) != list) {
ffffffffc02044f0:	6e89                	lui	t4,0x2
ffffffffc02044f2:	048e0a63          	beq	t3,s0,ffffffffc0204546 <do_fork+0x1dc>
ffffffffc02044f6:	88ae                	mv	a7,a1
ffffffffc02044f8:	87f2                	mv	a5,t3
ffffffffc02044fa:	6609                	lui	a2,0x2
ffffffffc02044fc:	a811                	j	ffffffffc0204510 <do_fork+0x1a6>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc02044fe:	00e6d663          	bge	a3,a4,ffffffffc020450a <do_fork+0x1a0>
ffffffffc0204502:	00c75463          	bge	a4,a2,ffffffffc020450a <do_fork+0x1a0>
ffffffffc0204506:	863a                	mv	a2,a4
ffffffffc0204508:	4885                	li	a7,1
ffffffffc020450a:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc020450c:	00878d63          	beq	a5,s0,ffffffffc0204526 <do_fork+0x1bc>
            if (proc->pid == last_pid) {
ffffffffc0204510:	f3c7a703          	lw	a4,-196(a5) # 1f3c <kern_entry-0xffffffffc01fe0c4>
ffffffffc0204514:	fed715e3          	bne	a4,a3,ffffffffc02044fe <do_fork+0x194>
                if (++ last_pid >= next_safe) {
ffffffffc0204518:	2685                	addiw	a3,a3,1
ffffffffc020451a:	02c6d163          	bge	a3,a2,ffffffffc020453c <do_fork+0x1d2>
ffffffffc020451e:	679c                	ld	a5,8(a5)
ffffffffc0204520:	4585                	li	a1,1
        while ((le = list_next(le)) != list) {
ffffffffc0204522:	fe8797e3          	bne	a5,s0,ffffffffc0204510 <do_fork+0x1a6>
ffffffffc0204526:	c581                	beqz	a1,ffffffffc020452e <do_fork+0x1c4>
ffffffffc0204528:	00d82023          	sw	a3,0(a6)
ffffffffc020452c:	8536                	mv	a0,a3
ffffffffc020452e:	f40881e3          	beqz	a7,ffffffffc0204470 <do_fork+0x106>
ffffffffc0204532:	00c32023          	sw	a2,0(t1)
ffffffffc0204536:	bf2d                	j	ffffffffc0204470 <do_fork+0x106>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204538:	84b6                	mv	s1,a3
ffffffffc020453a:	bdcd                	j	ffffffffc020442c <do_fork+0xc2>
                    if (last_pid >= MAX_PID) {
ffffffffc020453c:	01d6c363          	blt	a3,t4,ffffffffc0204542 <do_fork+0x1d8>
                        last_pid = 1;
ffffffffc0204540:	4685                	li	a3,1
                    goto repeat;
ffffffffc0204542:	4585                	li	a1,1
ffffffffc0204544:	b77d                	j	ffffffffc02044f2 <do_fork+0x188>
ffffffffc0204546:	cd81                	beqz	a1,ffffffffc020455e <do_fork+0x1f4>
ffffffffc0204548:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc020454c:	8536                	mv	a0,a3
ffffffffc020454e:	b70d                	j	ffffffffc0204470 <do_fork+0x106>
    kfree(proc);
ffffffffc0204550:	854a                	mv	a0,s2
ffffffffc0204552:	bacfd0ef          	jal	ra,ffffffffc02018fe <kfree>
    ret = -E_NO_MEM;
ffffffffc0204556:	5571                	li	a0,-4
    goto fork_out;
ffffffffc0204558:	b795                	j	ffffffffc02044bc <do_fork+0x152>
...
ffffffffc0204562:	b739                	j	ffffffffc0204470 <do_fork+0x106>
    ret = -E_NO_MEM;
ffffffffc0204564:	5571                	li	a0,-4
    return ret;
ffffffffc0204566:	bf99                	j	ffffffffc02044bc <do_fork+0x152>
    assert(current->mm == NULL);
ffffffffc0204568:	00002697          	auipc	a3,0x2
ffffffffc020456c:	65068693          	addi	a3,a3,1616 # ffffffffc0206bb8 <default_pmm_manager+0xff0>
ffffffffc0204570:	00001617          	auipc	a2,0x1
ffffffffc0204574:	2a860613          	addi	a2,a2,680 # ffffffffc0205818 <commands+0x738>
ffffffffc0204578:	10500593          	li	a1,261
ffffffffc020457c:	00002517          	auipc	a0,0x2
ffffffffc0204580:	65450513          	addi	a0,a0,1620 # ffffffffc0206bd0 <default_pmm_manager+0x1008>
ffffffffc0204584:	ec3fb0ef          	jal	ra,ffffffffc0200446 <__panic>
ffffffffc0204588:	00001617          	auipc	a2,0x1
ffffffffc020458c:	67860613          	addi	a2,a2,1656 # ffffffffc0205c00 <default_pmm_manager+0x38>
ffffffffc0204590:	06900593          	li	a1,105
ffffffffc0204594:	00001517          	auipc	a0,0x1
ffffffffc0204598:	69450513          	addi	a0,a0,1684 # ffffffffc0205c28 <default_pmm_manager+0x60>
ffffffffc020459c:	eabfb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02045a0 <kernel_thread>:
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc02045a0:	7129                	addi	sp,sp,-320
ffffffffc02045a2:	fa22                	sd	s0,304(sp)
ffffffffc02045a4:	f626                	sd	s1,296(sp)
ffffffffc02045a6:	f24a                	sd	s2,288(sp)
ffffffffc02045a8:	84ae                	mv	s1,a1
ffffffffc02045aa:	892a                	mv	s2,a0
ffffffffc02045ac:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02045ae:	4581                	li	a1,0
ffffffffc02045b0:	12000613          	li	a2,288
ffffffffc02045b4:	850a                	mv	a0,sp
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc02045b6:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02045b8:	06f000ef          	jal	ra,ffffffffc0204e26 <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc02045bc:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc02045be:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc02045c0:	100027f3          	csrr	a5,sstatus
ffffffffc02045c4:	edd7f793          	andi	a5,a5,-291
ffffffffc02045c8:	1207e793          	ori	a5,a5,288
ffffffffc02045cc:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02045ce:	860a                	mv	a2,sp
ffffffffc02045d0:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02045d4:	00000797          	auipc	a5,0x0
ffffffffc02045d8:	c3e78793          	addi	a5,a5,-962 # ffffffffc0204212 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02045dc:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02045de:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02045e0:	d8bff0ef          	jal	ra,ffffffffc020436a <do_fork>
}
ffffffffc02045e4:	70f2                	ld	ra,312(sp)
ffffffffc02045e6:	7452                	ld	s0,304(sp)
ffffffffc02045e8:	74b2                	ld	s1,296(sp)
ffffffffc02045ea:	7912                	ld	s2,288(sp)
ffffffffc02045ec:	6131                	addi	sp,sp,320
ffffffffc02045ee:	8082                	ret

ffffffffc02045f0 <do_exit>:
do_exit(int error_code) {
ffffffffc02045f0:	1141                	addi	sp,sp,-16
    panic("process exit!!.\n");
ffffffffc02045f2:	00002617          	auipc	a2,0x2
ffffffffc02045f6:	5f660613          	addi	a2,a2,1526 # ffffffffc0206be8 <default_pmm_manager+0x1020>
ffffffffc02045fa:	16100593          	li	a1,353
ffffffffc02045fe:	00002517          	auipc	a0,0x2
ffffffffc0204602:	5d250513          	addi	a0,a0,1490 # ffffffffc0206bd0 <default_pmm_manager+0x1008>
do_exit(int error_code) {
ffffffffc0204606:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc0204608:	e3ffb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc020460c <proc_init>:
...
ffffffffc020460e:	ec26                	sd	s1,24(sp)
    elm->prev = elm->next = elm;
ffffffffc0204610:	00011797          	auipc	a5,0x11
ffffffffc0204614:	f1878793          	addi	a5,a5,-232 # ffffffffc0215528 <proc_list>
ffffffffc0204618:	f406                	sd	ra,40(sp)
ffffffffc020461a:	f022                	sd	s0,32(sp)
ffffffffc020461c:	e84a                	sd	s2,16(sp)
ffffffffc020461e:	e44e                	sd	s3,8(sp)
ffffffffc0204620:	0000d497          	auipc	s1,0xd
ffffffffc0204624:	ef848493          	addi	s1,s1,-264 # ffffffffc0211518 <hash_list>
ffffffffc0204628:	e79c                	sd	a5,8(a5)
ffffffffc020462a:	e39c                	sd	a5,0(a5)
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i ++) {
ffffffffc020462c:	00011717          	auipc	a4,0x11
ffffffffc0204630:	eec70713          	addi	a4,a4,-276 # ffffffffc0215518 <name.2>
ffffffffc0204634:	87a6                	mv	a5,s1
ffffffffc0204636:	e79c                	sd	a5,8(a5)
ffffffffc0204638:	e39c                	sd	a5,0(a5)
ffffffffc020463a:	07c1                	addi	a5,a5,16
ffffffffc020463c:	fef71de3          	bne	a4,a5,ffffffffc0204636 <proc_init+0x2a>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc0204640:	bdbff0ef          	jal	ra,ffffffffc020421a <alloc_proc>
ffffffffc0204644:	00011917          	auipc	s2,0x11
ffffffffc0204648:	f7490913          	addi	s2,s2,-140 # ffffffffc02155b8 <idleproc>
ffffffffc020464c:	00a93023          	sd	a0,0(s2)
ffffffffc0204650:	18050d63          	beqz	a0,ffffffffc02047ea <proc_init+0x1de>
        panic("cannot alloc idleproc.\n");
    }

    // check the proc structure
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc0204654:	07000513          	li	a0,112
ffffffffc0204658:	9f6fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
    memset(context_mem, 0, sizeof(struct context));
ffffffffc020465c:	07000613          	li	a2,112
ffffffffc0204660:	4581                	li	a1,0
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc0204662:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc0204664:	7c2000ef          	jal	ra,ffffffffc0204e26 <memset>
    int context_init_flag = memcmp(&(idleproc->context), context_mem, sizeof(struct context));
ffffffffc0204668:	00093503          	ld	a0,0(s2)
ffffffffc020466c:	85a2                	mv	a1,s0
ffffffffc020466e:	07000613          	li	a2,112
ffffffffc0204672:	03050513          	addi	a0,a0,48
ffffffffc0204676:	7da000ef          	jal	ra,ffffffffc0204e50 <memcmp>
ffffffffc020467a:	89aa                	mv	s3,a0

    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc020467c:	453d                	li	a0,15
ffffffffc020467e:	9d0fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc0204682:	463d                	li	a2,15
ffffffffc0204684:	4581                	li	a1,0
    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc0204686:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc0204688:	79e000ef          	jal	ra,ffffffffc0204e26 <memset>
    int proc_name_flag = memcmp(&(idleproc->name), proc_name_mem, PROC_NAME_LEN);
ffffffffc020468c:	00093503          	ld	a0,0(s2)
ffffffffc0204690:	463d                	li	a2,15
ffffffffc0204692:	85a2                	mv	a1,s0
ffffffffc0204694:	0b450513          	addi	a0,a0,180
ffffffffc0204698:	7b8000ef          	jal	ra,ffffffffc0204e50 <memcmp>

    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc020469c:	00093783          	ld	a5,0(s2)
ffffffffc02046a0:	00011717          	auipc	a4,0x11
ffffffffc02046a4:	eb873703          	ld	a4,-328(a4) # ffffffffc0215558 <boot_cr3>
ffffffffc02046a8:	77d4                	ld	a3,168(a5)
ffffffffc02046aa:	0ee68463          	beq	a3,a4,ffffffffc0204792 <proc_init+0x186>
...
ffffffffc02046ae:	4709                	li	a4,2
ffffffffc02046b0:	e398                	sd	a4,0(a5)
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc02046b2:	00003717          	auipc	a4,0x3
ffffffffc02046b6:	94e70713          	addi	a4,a4,-1714 # ffffffffc0207000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02046ba:	0b478413          	addi	s0,a5,180
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc02046be:	eb98                	sd	a4,16(a5)
    idleproc->need_resched = 1;
ffffffffc02046c0:	4705                	li	a4,1
ffffffffc02046c2:	cf98                	sw	a4,24(a5)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02046c4:	4641                	li	a2,16
ffffffffc02046c6:	4581                	li	a1,0
ffffffffc02046c8:	8522                	mv	a0,s0
ffffffffc02046ca:	75c000ef          	jal	ra,ffffffffc0204e26 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc02046ce:	463d                	li	a2,15
ffffffffc02046d0:	00002597          	auipc	a1,0x2
ffffffffc02046d4:	56058593          	addi	a1,a1,1376 # ffffffffc0206c30 <default_pmm_manager+0x1068>
ffffffffc02046d8:	8522                	mv	a0,s0
ffffffffc02046da:	75e000ef          	jal	ra,ffffffffc0204e38 <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process ++;
ffffffffc02046de:	00011717          	auipc	a4,0x11
ffffffffc02046e2:	eea70713          	addi	a4,a4,-278 # ffffffffc02155c8 <nr_process>
ffffffffc02046e6:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc02046e8:	00093683          	ld	a3,0(s2)
    
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02046ec:	4601                	li	a2,0
    nr_process ++;
ffffffffc02046ee:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02046f0:	00002597          	auipc	a1,0x2
ffffffffc02046f4:	54858593          	addi	a1,a1,1352 # ffffffffc0206c38 <default_pmm_manager+0x1070>
ffffffffc02046f8:	00000517          	auipc	a0,0x0
ffffffffc02046fc:	b9250513          	addi	a0,a0,-1134 # ffffffffc020428a <init_main>
    nr_process ++;
ffffffffc0204700:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc0204702:	00011797          	auipc	a5,0x11
ffffffffc0204706:	ead7b723          	sd	a3,-338(a5) # ffffffffc02155b0 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc020470a:	e97ff0ef          	jal	ra,ffffffffc02045a0 <kernel_thread>
ffffffffc020470e:	842a                	mv	s0,a0
    if (pid <= 0) {
ffffffffc0204710:	0ea05963          	blez	a0,ffffffffc0204802 <proc_init+0x1f6>
    if (0 < pid && pid < MAX_PID) {
ffffffffc0204714:	6789                	lui	a5,0x2
ffffffffc0204716:	fff5071b          	addiw	a4,a0,-1
ffffffffc020471a:	17f9                	addi	a5,a5,-2
ffffffffc020471c:	2501                	sext.w	a0,a0
ffffffffc020471e:	02e7e363          	bltu	a5,a4,ffffffffc0204744 <proc_init+0x138>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0204722:	45a9                	li	a1,10
ffffffffc0204724:	282000ef          	jal	ra,ffffffffc02049a6 <hash32>
ffffffffc0204728:	02051793          	slli	a5,a0,0x20
ffffffffc020472c:	01c7d693          	srli	a3,a5,0x1c
ffffffffc0204730:	96a6                	add	a3,a3,s1
ffffffffc0204732:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list) {
ffffffffc0204734:	a029                	j	ffffffffc020473e <proc_init+0x132>
            if (proc->pid == pid) {
ffffffffc0204736:	f2c7a703          	lw	a4,-212(a5) # 1f2c <kern_entry-0xffffffffc01fe0d4>
ffffffffc020473a:	0a870563          	beq	a4,s0,ffffffffc02047e4 <proc_init+0x1d8>
    return listelm->next;
ffffffffc020473e:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0204740:	fef69be3          	bne	a3,a5,ffffffffc0204736 <proc_init+0x12a>
    return NULL;
ffffffffc0204744:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204746:	0b478493          	addi	s1,a5,180
ffffffffc020474a:	4641                	li	a2,16
ffffffffc020474c:	4581                	li	a1,0
        panic("create init_main failed.\n");
    }

    initproc = find_proc(pid);
ffffffffc020474e:	00011417          	auipc	s0,0x11
ffffffffc0204752:	e7240413          	addi	s0,s0,-398 # ffffffffc02155c0 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204756:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc0204758:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020475a:	6cc000ef          	jal	ra,ffffffffc0204e26 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc020475e:	463d                	li	a2,15
ffffffffc0204760:	00002597          	auipc	a1,0x2
ffffffffc0204764:	50858593          	addi	a1,a1,1288 # ffffffffc0206c68 <default_pmm_manager+0x10a0>
ffffffffc0204768:	8526                	mv	a0,s1
ffffffffc020476a:	6ce000ef          	jal	ra,ffffffffc0204e38 <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc020476e:	00093783          	ld	a5,0(s2)
ffffffffc0204772:	c7e1                	beqz	a5,ffffffffc020483a <proc_init+0x22e>
ffffffffc0204774:	43dc                	lw	a5,4(a5)
ffffffffc0204776:	e3f1                	bnez	a5,ffffffffc020483a <proc_init+0x22e>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0204778:	601c                	ld	a5,0(s0)
ffffffffc020477a:	c3c5                	beqz	a5,ffffffffc020481a <proc_init+0x20e>
ffffffffc020477c:	43d8                	lw	a4,4(a5)
ffffffffc020477e:	4785                	li	a5,1
ffffffffc0204780:	08f71d63          	bne	a4,a5,ffffffffc020481a <proc_init+0x20e>
}
ffffffffc0204784:	70a2                	ld	ra,40(sp)
ffffffffc0204786:	7402                	ld	s0,32(sp)
ffffffffc0204788:	64e2                	ld	s1,24(sp)
ffffffffc020478a:	6942                	ld	s2,16(sp)
ffffffffc020478c:	69a2                	ld	s3,8(sp)
ffffffffc020478e:	6145                	addi	sp,sp,48
ffffffffc0204790:	8082                	ret
    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc0204792:	73d8                	ld	a4,160(a5)
ffffffffc0204794:	ff09                	bnez	a4,ffffffffc02046ae <proc_init+0xa2>
ffffffffc0204796:	f0099ce3          	bnez	s3,ffffffffc02046ae <proc_init+0xa2>
        && idleproc->state == PROC_UNINIT && idleproc->pid == -1 && idleproc->runs == 0
ffffffffc020479a:	6394                	ld	a3,0(a5)
ffffffffc020479c:	577d                	li	a4,-1
ffffffffc020479e:	1702                	slli	a4,a4,0x20
ffffffffc02047a0:	f0e697e3          	bne	a3,a4,ffffffffc02046ae <proc_init+0xa2>
ffffffffc02047a4:	4798                	lw	a4,8(a5)
ffffffffc02047a6:	f00714e3          	bnez	a4,ffffffffc02046ae <proc_init+0xa2>
        && idleproc->kstack == 0 && idleproc->need_resched == 0 && idleproc->parent == NULL
ffffffffc02047aa:	6b98                	ld	a4,16(a5)
ffffffffc02047ac:	f00711e3          	bnez	a4,ffffffffc02046ae <proc_init+0xa2>
ffffffffc02047b0:	4f98                	lw	a4,24(a5)
ffffffffc02047b2:	2701                	sext.w	a4,a4
ffffffffc02047b4:	ee071de3          	bnez	a4,ffffffffc02046ae <proc_init+0xa2>
ffffffffc02047b8:	7398                	ld	a4,32(a5)
ffffffffc02047ba:	ee071ae3          	bnez	a4,ffffffffc02046ae <proc_init+0xa2>
        && idleproc->mm == NULL && idleproc->flags == 0 && !proc_name_flag
ffffffffc02047be:	7798                	ld	a4,40(a5)
ffffffffc02047c0:	ee0717e3          	bnez	a4,ffffffffc02046ae <proc_init+0xa2>
ffffffffc02047c4:	0b07a703          	lw	a4,176(a5)
ffffffffc02047c8:	8d59                	or	a0,a0,a4
ffffffffc02047ca:	0005071b          	sext.w	a4,a0
ffffffffc02047ce:	ee0710e3          	bnez	a4,ffffffffc02046ae <proc_init+0xa2>
        cprintf("alloc_proc() correct!\n");
ffffffffc02047d2:	00002517          	auipc	a0,0x2
ffffffffc02047d6:	44650513          	addi	a0,a0,1094 # ffffffffc0206c18 <default_pmm_manager+0x1050>
ffffffffc02047da:	9a7fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    idleproc->pid = 0;
ffffffffc02047de:	00093783          	ld	a5,0(s2)
ffffffffc02047e2:	b5f1                	j	ffffffffc02046ae <proc_init+0xa2>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc02047e4:	f2878793          	addi	a5,a5,-216
ffffffffc02047e8:	bfb9                	j	ffffffffc0204746 <proc_init+0x13a>
        panic("cannot alloc idleproc.\n");
ffffffffc02047ea:	00002617          	auipc	a2,0x2
ffffffffc02047ee:	41660613          	addi	a2,a2,1046 # ffffffffc0206c00 <default_pmm_manager+0x1038>
ffffffffc02047f2:	17900593          	li	a1,377
ffffffffc02047f6:	00002517          	auipc	a0,0x2
ffffffffc02047fa:	3da50513          	addi	a0,a0,986 # ffffffffc0206bd0 <default_pmm_manager+0x1008>
ffffffffc02047fe:	c49fb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("create init_main failed.\n");
ffffffffc0204802:	00002617          	auipc	a2,0x2
ffffffffc0204806:	44660613          	addi	a2,a2,1094 # ffffffffc0206c48 <default_pmm_manager+0x1080>
ffffffffc020480a:	19900593          	li	a1,409
ffffffffc020480e:	00002517          	auipc	a0,0x2
ffffffffc0204812:	3c250513          	addi	a0,a0,962 # ffffffffc0206bd0 <default_pmm_manager+0x1008>
ffffffffc0204816:	c31fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc020481a:	00002697          	auipc	a3,0x2
ffffffffc020481e:	47e68693          	addi	a3,a3,1150 # ffffffffc0206c98 <default_pmm_manager+0x10d0>
ffffffffc0204822:	00001617          	auipc	a2,0x1
ffffffffc0204826:	ff660613          	addi	a2,a2,-10 # ffffffffc0205818 <commands+0x738>
ffffffffc020482a:	1a000593          	li	a1,416
ffffffffc020482e:	00002517          	auipc	a0,0x2
ffffffffc0204832:	3a250513          	addi	a0,a0,930 # ffffffffc0206bd0 <default_pmm_manager+0x1008>
ffffffffc0204836:	c11fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc020483a:	00002697          	auipc	a3,0x2
ffffffffc020483e:	43668693          	addi	a3,a3,1078 # ffffffffc0206c70 <default_pmm_manager+0x10a8>
ffffffffc0204842:	00001617          	auipc	a2,0x1
ffffffffc0204846:	fd660613          	addi	a2,a2,-42 # ffffffffc0205818 <commands+0x738>
ffffffffc020484a:	19f00593          	li	a1,415
ffffffffc020484e:	00002517          	auipc	a0,0x2
ffffffffc0204852:	38250513          	addi	a0,a0,898 # ffffffffc0206bd0 <default_pmm_manager+0x1008>
ffffffffc0204856:	bf1fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc020485a <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void
cpu_idle(void) {
ffffffffc020485a:	1141                	addi	sp,sp,-16
ffffffffc020485c:	e022                	sd	s0,0(sp)
ffffffffc020485e:	e406                	sd	ra,8(sp)
ffffffffc0204860:	00011417          	auipc	s0,0x11
ffffffffc0204864:	d5040413          	addi	s0,s0,-688 # ffffffffc02155b0 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc0204868:	6018                	ld	a4,0(s0)
ffffffffc020486a:	4f1c                	lw	a5,24(a4)
ffffffffc020486c:	2781                	sext.w	a5,a5
ffffffffc020486e:	dff5                	beqz	a5,ffffffffc020486a <cpu_idle+0x10>
            schedule();
ffffffffc0204870:	0a2000ef          	jal	ra,ffffffffc0204912 <schedule>
ffffffffc0204874:	bfd5                	j	ffffffffc0204868 <cpu_idle+0xe>

ffffffffc0204876 <switch_to>:
.text
...
ffffffffc0204876:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc020487a:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc020487e:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc0204880:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc0204882:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc0204886:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc020488a:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc020488e:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc0204892:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc0204896:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc020489a:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc020489e:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc02048a2:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc02048a6:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc02048aa:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc02048ae:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc02048b2:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc02048b4:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc02048b6:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc02048ba:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc02048be:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc02048c2:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc02048c6:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc02048ca:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc02048ce:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc02048d2:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc02048d6:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc02048da:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc02048de:	8082                	ret
...
ffffffffc02048f6:	3ce68693          	addi	a3,a3,974 # ffffffffc0206cc0 <default_pmm_manager+0x10f8>
ffffffffc02048fa:	00001617          	auipc	a2,0x1
ffffffffc02048fe:	f1e60613          	addi	a2,a2,-226 # ffffffffc0205818 <commands+0x738>
ffffffffc0204902:	45a5                	li	a1,9
ffffffffc0204904:	00002517          	auipc	a0,0x2
ffffffffc0204908:	3fc50513          	addi	a0,a0,1020 # ffffffffc0206d00 <default_pmm_manager+0x1138>
wakeup_proc(struct proc_struct *proc) {
ffffffffc020490c:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc020490e:	b39fb0ef          	jal	ra,ffffffffc0200446 <__panic>
...
ffffffffc0204920:	efbd                	bnez	a5,ffffffffc020499e <schedule+0x8c>
    bool intr_flag;
...
ffffffffc0204922:	00011897          	auipc	a7,0x11
ffffffffc0204926:	c8e8b883          	ld	a7,-882(a7) # ffffffffc02155b0 <current>
ffffffffc020492a:	0008ac23          	sw	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc020492e:	00011517          	auipc	a0,0x11
ffffffffc0204932:	c8a53503          	ld	a0,-886(a0) # ffffffffc02155b8 <idleproc>
ffffffffc0204936:	04a88e63          	beq	a7,a0,ffffffffc0204992 <schedule+0x80>
ffffffffc020493a:	0c888693          	addi	a3,a7,200
ffffffffc020493e:	00011617          	auipc	a2,0x11
ffffffffc0204942:	bea60613          	addi	a2,a2,-1046 # ffffffffc0215528 <proc_list>
        le = last;
ffffffffc0204946:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
ffffffffc0204948:	4581                	li	a1,0
        do {
            if ((le = list_next(le)) != &proc_list) {
                next = le2proc(le, list_link);
                if (next->state == PROC_RUNNABLE) {
ffffffffc020494a:	4809                	li	a6,2
ffffffffc020494c:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc020494e:	00c78863          	beq	a5,a2,ffffffffc020495e <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc0204952:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc0204956:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc020495a:	03070163          	beq	a4,a6,ffffffffc020497c <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc020495e:	fef697e3          	bne	a3,a5,ffffffffc020494c <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0204962:	ed89                	bnez	a1,ffffffffc020497c <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
ffffffffc0204964:	451c                	lw	a5,8(a0)
ffffffffc0204966:	2785                	addiw	a5,a5,1
ffffffffc0204968:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc020496a:	00a88463          	beq	a7,a0,ffffffffc0204972 <schedule+0x60>
            proc_run(next);
ffffffffc020496e:	98fff0ef          	jal	ra,ffffffffc02042fc <proc_run>
    if (flag) {
ffffffffc0204972:	e819                	bnez	s0,ffffffffc0204988 <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
...
ffffffffc020497a:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc020497c:	4198                	lw	a4,0(a1)
ffffffffc020497e:	4789                	li	a5,2
ffffffffc0204980:	fef712e3          	bne	a4,a5,ffffffffc0204964 <schedule+0x52>
ffffffffc0204984:	852e                	mv	a0,a1
ffffffffc0204986:	bff9                	j	ffffffffc0204964 <schedule+0x52>
}
ffffffffc0204988:	6402                	ld	s0,0(sp)
ffffffffc020498a:	60a2                	ld	ra,8(sp)
ffffffffc020498c:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc020498e:	c2ffb06f          	j	ffffffffc02005bc <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0204992:	00011617          	auipc	a2,0x11
ffffffffc0204996:	b9660613          	addi	a2,a2,-1130 # ffffffffc0215528 <proc_list>
ffffffffc020499a:	86b2                	mv	a3,a2
ffffffffc020499c:	b76d                	j	ffffffffc0204946 <schedule+0x34>
        intr_disable();
ffffffffc020499e:	c25fb0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc02049a2:	4405                	li	s0,1
ffffffffc02049a4:	bfbd                	j	ffffffffc0204922 <schedule+0x10>

ffffffffc02049a6 <hash32>:
 *
...
ffffffffc02049a6:	9e3707b7          	lui	a5,0x9e370
ffffffffc02049aa:	2785                	addiw	a5,a5,1
ffffffffc02049ac:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc02049b0:	02000793          	li	a5,32
ffffffffc02049b4:	9f8d                	subw	a5,a5,a1
}
ffffffffc02049b6:	00f5553b          	srlw	a0,a0,a5
...
ffffffffc02049f6:	00002797          	auipc	a5,0x2
ffffffffc02049fa:	32278793          	addi	a5,a5,802 # ffffffffc0206d18 <default_pmm_manager+0x1150>
ffffffffc02049fe:	020a5a13          	srli	s4,s4,0x20
...
ffffffffc0204a30:	e8d2                	sd	s4,80(sp)
ffffffffc0204a32:	e4d6                	sd	s5,72(sp)
ffffffffc0204a34:	e0da                	sd	s6,64(sp)
ffffffffc0204a36:	fc5e                	sd	s7,56(sp)
ffffffffc0204a38:	f06a                	sd	s10,32(sp)
ffffffffc0204a3a:	fc86                	sd	ra,120(sp)
ffffffffc0204a3c:	f8a2                	sd	s0,112(sp)
ffffffffc0204a3e:	f862                	sd	s8,48(sp)
...
ffffffffc0204a4a:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0204a4c:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0204a50:	5b7d                	li	s6,-1
ffffffffc0204a52:	00002a97          	auipc	s5,0x2
ffffffffc0204a56:	2f2a8a93          	addi	s5,s5,754 # ffffffffc0206d44 <default_pmm_manager+0x117c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0204a5a:	00002b97          	auipc	s7,0x2
ffffffffc0204a5e:	4c6b8b93          	addi	s7,s7,1222 # ffffffffc0206f20 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204a62:	000d4503          	lbu	a0,0(s10)
ffffffffc0204a66:	001d0413          	addi	s0,s10,1
ffffffffc0204a6a:	01350a63          	beq	a0,s3,ffffffffc0204a7e <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0204a6e:	c121                	beqz	a0,ffffffffc0204aae <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0204a70:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204a72:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0204a74:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204a76:	fff44503          	lbu	a0,-1(s0)
ffffffffc0204a7a:	ff351ae3          	bne	a0,s3,ffffffffc0204a6e <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204a7e:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0204a82:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204a86:	4c81                	li	s9,0
ffffffffc0204a88:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0204a8a:	5c7d                	li	s8,-1
ffffffffc0204a8c:	5dfd                	li	s11,-1
ffffffffc0204a8e:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0204a92:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204a94:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204a98:	0ff5f593          	zext.b	a1,a1
ffffffffc0204a9c:	00140d13          	addi	s10,s0,1
ffffffffc0204aa0:	04b56263          	bltu	a0,a1,ffffffffc0204ae4 <vprintfmt+0xbc>
ffffffffc0204aa4:	058a                	slli	a1,a1,0x2
ffffffffc0204aa6:	95d6                	add	a1,a1,s5
ffffffffc0204aa8:	4194                	lw	a3,0(a1)
ffffffffc0204aaa:	96d6                	add	a3,a3,s5
ffffffffc0204aac:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0204aae:	70e6                	ld	ra,120(sp)
ffffffffc0204ab0:	7446                	ld	s0,112(sp)
ffffffffc0204ab2:	74a6                	ld	s1,104(sp)
ffffffffc0204ab4:	7906                	ld	s2,96(sp)
ffffffffc0204ab6:	69e6                	ld	s3,88(sp)
ffffffffc0204ab8:	6a46                	ld	s4,80(sp)
ffffffffc0204aba:	6aa6                	ld	s5,72(sp)
ffffffffc0204abc:	6b06                	ld	s6,64(sp)
ffffffffc0204abe:	7be2                	ld	s7,56(sp)
ffffffffc0204ac0:	7c42                	ld	s8,48(sp)
ffffffffc0204ac2:	7ca2                	ld	s9,40(sp)
ffffffffc0204ac4:	7d02                	ld	s10,32(sp)
ffffffffc0204ac6:	6de2                	ld	s11,24(sp)
ffffffffc0204ac8:	6109                	addi	sp,sp,128
ffffffffc0204aca:	8082                	ret
            padc = '0';
ffffffffc0204acc:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0204ace:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204ad2:	846a                	mv	s0,s10
ffffffffc0204ad4:	00140d13          	addi	s10,s0,1
ffffffffc0204ad8:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204adc:	0ff5f593          	zext.b	a1,a1
ffffffffc0204ae0:	fcb572e3          	bgeu	a0,a1,ffffffffc0204aa4 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0204ae4:	85a6                	mv	a1,s1
ffffffffc0204ae6:	02500513          	li	a0,37
ffffffffc0204aea:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204aec:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204af0:	8d22                	mv	s10,s0
ffffffffc0204af2:	f73788e3          	beq	a5,s3,ffffffffc0204a62 <vprintfmt+0x3a>
ffffffffc0204af6:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0204afa:	1d7d                	addi	s10,s10,-1
ffffffffc0204afc:	ff379de3          	bne	a5,s3,ffffffffc0204af6 <vprintfmt+0xce>
ffffffffc0204b00:	b78d                	j	ffffffffc0204a62 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0204b02:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
...
ffffffffc0204b0c:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204b10:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204b14:	02d86463          	bltu	a6,a3,ffffffffc0204b3c <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0204b18:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204b1c:	002c169b          	slliw	a3,s8,0x2
ffffffffc0204b20:	0186873b          	addw	a4,a3,s8
ffffffffc0204b24:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204b28:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204b2a:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204b2e:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204b30:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204b34:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204b38:	fed870e3          	bgeu	a6,a3,ffffffffc0204b18 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0204b3c:	f40ddce3          	bgez	s11,ffffffffc0204a94 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0204b40:	8de2                	mv	s11,s8
ffffffffc0204b42:	5c7d                	li	s8,-1
ffffffffc0204b44:	bf81                	j	ffffffffc0204a94 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0204b46:	fffdc693          	not	a3,s11
ffffffffc0204b4a:	96fd                	srai	a3,a3,0x3f
ffffffffc0204b4c:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b50:	00144603          	lbu	a2,1(s0)
ffffffffc0204b54:	2d81                	sext.w	s11,s11
ffffffffc0204b56:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204b58:	bf35                	j	ffffffffc0204a94 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204b5a:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b5e:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0204b62:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b64:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0204b66:	bfd9                	j	ffffffffc0204b3c <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204b68:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204b6a:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204b6e:	01174463          	blt	a4,a7,ffffffffc0204b76 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0204b72:	1a088e63          	beqz	a7,ffffffffc0204d2e <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204b76:	000a3603          	ld	a2,0(s4)
ffffffffc0204b7a:	46c1                	li	a3,16
ffffffffc0204b7c:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204b7e:	2781                	sext.w	a5,a5
ffffffffc0204b80:	876e                	mv	a4,s11
ffffffffc0204b82:	85a6                	mv	a1,s1
ffffffffc0204b84:	854a                	mv	a0,s2
ffffffffc0204b86:	e37ff0ef          	jal	ra,ffffffffc02049bc <printnum>
            break;
ffffffffc0204b8a:	bde1                	j	ffffffffc0204a62 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204b8c:	000a2503          	lw	a0,0(s4)
ffffffffc0204b90:	85a6                	mv	a1,s1
ffffffffc0204b92:	0a21                	addi	s4,s4,8
ffffffffc0204b94:	9902                	jalr	s2
            break;
ffffffffc0204b96:	b5f1                	j	ffffffffc0204a62 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204b98:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204b9a:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204b9e:	01174463          	blt	a4,a7,ffffffffc0204ba6 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204ba2:	18088163          	beqz	a7,ffffffffc0204d24 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204ba6:	000a3603          	ld	a2,0(s4)
ffffffffc0204baa:	46a9                	li	a3,10
ffffffffc0204bac:	8a2e                	mv	s4,a1
ffffffffc0204bae:	bfc1                	j	ffffffffc0204b7e <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bb0:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204bb4:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bb6:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204bb8:	bdf1                	j	ffffffffc0204a94 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204bba:	85a6                	mv	a1,s1
ffffffffc0204bbc:	02500513          	li	a0,37
ffffffffc0204bc0:	9902                	jalr	s2
            break;
ffffffffc0204bc2:	b545                	j	ffffffffc0204a62 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bc4:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204bc8:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bca:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204bcc:	b5e1                	j	ffffffffc0204a94 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204bce:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204bd0:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204bd4:	01174463          	blt	a4,a7,ffffffffc0204bdc <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204bd8:	14088163          	beqz	a7,ffffffffc0204d1a <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204bdc:	000a3603          	ld	a2,0(s4)
ffffffffc0204be0:	46a1                	li	a3,8
ffffffffc0204be2:	8a2e                	mv	s4,a1
ffffffffc0204be4:	bf69                	j	ffffffffc0204b7e <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0204be6:	03000513          	li	a0,48
ffffffffc0204bea:	85a6                	mv	a1,s1
ffffffffc0204bec:	e03e                	sd	a5,0(sp)
ffffffffc0204bee:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0204bf0:	85a6                	mv	a1,s1
ffffffffc0204bf2:	07800513          	li	a0,120
ffffffffc0204bf6:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204bf8:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0204bfa:	6782                	ld	a5,0(sp)
ffffffffc0204bfc:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204bfe:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0204c02:	bfb5                	j	ffffffffc0204b7e <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204c04:	000a3403          	ld	s0,0(s4)
ffffffffc0204c08:	008a0713          	addi	a4,s4,8
ffffffffc0204c0c:	e03a                	sd	a4,0(sp)
ffffffffc0204c0e:	14040263          	beqz	s0,ffffffffc0204d52 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0204c12:	0fb05763          	blez	s11,ffffffffc0204d00 <vprintfmt+0x2d8>
ffffffffc0204c16:	02d00693          	li	a3,45
ffffffffc0204c1a:	0cd79163          	bne	a5,a3,ffffffffc0204cdc <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c1e:	00044783          	lbu	a5,0(s0)
ffffffffc0204c22:	0007851b          	sext.w	a0,a5
ffffffffc0204c26:	cf85                	beqz	a5,ffffffffc0204c5e <vprintfmt+0x236>
ffffffffc0204c28:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204c2c:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c30:	000c4563          	bltz	s8,ffffffffc0204c3a <vprintfmt+0x212>
ffffffffc0204c34:	3c7d                	addiw	s8,s8,-1
ffffffffc0204c36:	036c0263          	beq	s8,s6,ffffffffc0204c5a <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204c3a:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204c3c:	0e0c8e63          	beqz	s9,ffffffffc0204d38 <vprintfmt+0x310>
ffffffffc0204c40:	3781                	addiw	a5,a5,-32
ffffffffc0204c42:	0ef47b63          	bgeu	s0,a5,ffffffffc0204d38 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204c46:	03f00513          	li	a0,63
ffffffffc0204c4a:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c4c:	000a4783          	lbu	a5,0(s4)
ffffffffc0204c50:	3dfd                	addiw	s11,s11,-1
ffffffffc0204c52:	0a05                	addi	s4,s4,1
ffffffffc0204c54:	0007851b          	sext.w	a0,a5
ffffffffc0204c58:	ffe1                	bnez	a5,ffffffffc0204c30 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204c5a:	01b05963          	blez	s11,ffffffffc0204c6c <vprintfmt+0x244>
ffffffffc0204c5e:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0204c60:	85a6                	mv	a1,s1
ffffffffc0204c62:	02000513          	li	a0,32
ffffffffc0204c66:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204c68:	fe0d9be3          	bnez	s11,ffffffffc0204c5e <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204c6c:	6a02                	ld	s4,0(sp)
ffffffffc0204c6e:	bbd5                	j	ffffffffc0204a62 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204c70:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c72:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204c76:	01174463          	blt	a4,a7,ffffffffc0204c7e <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204c7a:	08088d63          	beqz	a7,ffffffffc0204d14 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204c7e:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204c82:	0a044d63          	bltz	s0,ffffffffc0204d3c <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204c86:	8622                	mv	a2,s0
ffffffffc0204c88:	8a66                	mv	s4,s9
ffffffffc0204c8a:	46a9                	li	a3,10
ffffffffc0204c8c:	bdcd                	j	ffffffffc0204b7e <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204c8e:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204c92:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204c94:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204c96:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204c9a:	8fb5                	xor	a5,a5,a3
ffffffffc0204c9c:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204ca0:	02d74163          	blt	a4,a3,ffffffffc0204cc2 <vprintfmt+0x29a>
ffffffffc0204ca4:	00369793          	slli	a5,a3,0x3
ffffffffc0204ca8:	97de                	add	a5,a5,s7
ffffffffc0204caa:	639c                	ld	a5,0(a5)
ffffffffc0204cac:	cb99                	beqz	a5,ffffffffc0204cc2 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204cae:	86be                	mv	a3,a5
ffffffffc0204cb0:	00000617          	auipc	a2,0x0
ffffffffc0204cb4:	1f060613          	addi	a2,a2,496 # ffffffffc0204ea0 <etext+0x2c>
ffffffffc0204cb8:	85a6                	mv	a1,s1
ffffffffc0204cba:	854a                	mv	a0,s2
ffffffffc0204cbc:	0ce000ef          	jal	ra,ffffffffc0204d8a <printfmt>
ffffffffc0204cc0:	b34d                	j	ffffffffc0204a62 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204cc2:	00002617          	auipc	a2,0x2
ffffffffc0204cc6:	07660613          	addi	a2,a2,118 # ffffffffc0206d38 <default_pmm_manager+0x1170>
ffffffffc0204cca:	85a6                	mv	a1,s1
ffffffffc0204ccc:	854a                	mv	a0,s2
ffffffffc0204cce:	0bc000ef          	jal	ra,ffffffffc0204d8a <printfmt>
ffffffffc0204cd2:	bb41                	j	ffffffffc0204a62 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204cd4:	00002417          	auipc	s0,0x2
ffffffffc0204cd8:	05c40413          	addi	s0,s0,92 # ffffffffc0206d30 <default_pmm_manager+0x1168>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204cdc:	85e2                	mv	a1,s8
ffffffffc0204cde:	8522                	mv	a0,s0
ffffffffc0204ce0:	e43e                	sd	a5,8(sp)
ffffffffc0204ce2:	0e2000ef          	jal	ra,ffffffffc0204dc4 <strnlen>
ffffffffc0204ce6:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204cea:	01b05b63          	blez	s11,ffffffffc0204d00 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0204cee:	67a2                	ld	a5,8(sp)
ffffffffc0204cf0:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204cf4:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204cf6:	85a6                	mv	a1,s1
ffffffffc0204cf8:	8552                	mv	a0,s4
ffffffffc0204cfa:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204cfc:	fe0d9ce3          	bnez	s11,ffffffffc0204cf4 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d00:	00044783          	lbu	a5,0(s0)
ffffffffc0204d04:	00140a13          	addi	s4,s0,1
ffffffffc0204d08:	0007851b          	sext.w	a0,a5
ffffffffc0204d0c:	d3a5                	beqz	a5,ffffffffc0204c6c <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204d0e:	05e00413          	li	s0,94
ffffffffc0204d12:	bf39                	j	ffffffffc0204c30 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0204d14:	000a2403          	lw	s0,0(s4)
ffffffffc0204d18:	b7ad                	j	ffffffffc0204c82 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0204d1a:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d1e:	46a1                	li	a3,8
ffffffffc0204d20:	8a2e                	mv	s4,a1
ffffffffc0204d22:	bdb1                	j	ffffffffc0204b7e <vprintfmt+0x156>
ffffffffc0204d24:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d28:	46a9                	li	a3,10
ffffffffc0204d2a:	8a2e                	mv	s4,a1
ffffffffc0204d2c:	bd89                	j	ffffffffc0204b7e <vprintfmt+0x156>
ffffffffc0204d2e:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d32:	46c1                	li	a3,16
ffffffffc0204d34:	8a2e                	mv	s4,a1
ffffffffc0204d36:	b5a1                	j	ffffffffc0204b7e <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0204d38:	9902                	jalr	s2
ffffffffc0204d3a:	bf09                	j	ffffffffc0204c4c <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0204d3c:	85a6                	mv	a1,s1
ffffffffc0204d3e:	02d00513          	li	a0,45
ffffffffc0204d42:	e03e                	sd	a5,0(sp)
ffffffffc0204d44:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204d46:	6782                	ld	a5,0(sp)
ffffffffc0204d48:	8a66                	mv	s4,s9
ffffffffc0204d4a:	40800633          	neg	a2,s0
ffffffffc0204d4e:	46a9                	li	a3,10
ffffffffc0204d50:	b53d                	j	ffffffffc0204b7e <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204d52:	03b05163          	blez	s11,ffffffffc0204d74 <vprintfmt+0x34c>
ffffffffc0204d56:	02d00693          	li	a3,45
ffffffffc0204d5a:	f6d79de3          	bne	a5,a3,ffffffffc0204cd4 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204d5e:	00002417          	auipc	s0,0x2
ffffffffc0204d62:	fd240413          	addi	s0,s0,-46 # ffffffffc0206d30 <default_pmm_manager+0x1168>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d66:	02800793          	li	a5,40
ffffffffc0204d6a:	02800513          	li	a0,40
ffffffffc0204d6e:	00140a13          	addi	s4,s0,1
ffffffffc0204d72:	bd6d                	j	ffffffffc0204c2c <vprintfmt+0x204>
ffffffffc0204d74:	00002a17          	auipc	s4,0x2
ffffffffc0204d78:	fbda0a13          	addi	s4,s4,-67 # ffffffffc0206d31 <default_pmm_manager+0x1169>
ffffffffc0204d7c:	02800513          	li	a0,40
ffffffffc0204d80:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204d84:	05e00413          	li	s0,94
ffffffffc0204d88:	b565                	j	ffffffffc0204c30 <vprintfmt+0x208>

ffffffffc0204d8a <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204d8a:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0204d8c:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204d90:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204d92:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204d94:	ec06                	sd	ra,24(sp)
ffffffffc0204d96:	f83a                	sd	a4,48(sp)
ffffffffc0204d98:	fc3e                	sd	a5,56(sp)
ffffffffc0204d9a:	e0c2                	sd	a6,64(sp)
ffffffffc0204d9c:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0204d9e:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204da0:	c89ff0ef          	jal	ra,ffffffffc0204a28 <vprintfmt>
}
ffffffffc0204da4:	60e2                	ld	ra,24(sp)
ffffffffc0204da6:	6161                	addi	sp,sp,80
ffffffffc0204da8:	8082                	ret

ffffffffc0204daa <strlen>:
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc0204daa:	00054783          	lbu	a5,0(a0)
strlen(const char *s) {
ffffffffc0204dae:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0204db0:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204db2:	cb81                	beqz	a5,ffffffffc0204dc2 <strlen+0x18>
        cnt ++;
ffffffffc0204db4:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204db6:	00a707b3          	add	a5,a4,a0
ffffffffc0204dba:	0007c783          	lbu	a5,0(a5)
ffffffffc0204dbe:	fbfd                	bnez	a5,ffffffffc0204db4 <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0204dc4:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204dc6:	e589                	bnez	a1,ffffffffc0204dd0 <strnlen+0xc>
ffffffffc0204dc8:	a811                	j	ffffffffc0204ddc <strnlen+0x18>
        cnt ++;
ffffffffc0204dca:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204dcc:	00f58863          	beq	a1,a5,ffffffffc0204ddc <strnlen+0x18>
ffffffffc0204dd0:	00f50733          	add	a4,a0,a5
ffffffffc0204dd4:	00074703          	lbu	a4,0(a4)
ffffffffc0204dd8:	fb6d                	bnez	a4,ffffffffc0204dca <strnlen+0x6>
ffffffffc0204dda:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204ddc:	852e                	mv	a0,a1
ffffffffc0204dde:	8082                	ret

ffffffffc0204de0 <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc0204de0:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0204de2:	0005c703          	lbu	a4,0(a1)
ffffffffc0204de6:	0785                	addi	a5,a5,1
ffffffffc0204de8:	0585                	addi	a1,a1,1
ffffffffc0204dea:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0204dee:	fb75                	bnez	a4,ffffffffc0204de2 <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0204df6:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204dfa:	cb89                	beqz	a5,ffffffffc0204e0c <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204dfc:	0505                	addi	a0,a0,1
ffffffffc0204dfe:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e00:	fee789e3          	beq	a5,a4,ffffffffc0204df2 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204e04:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204e08:	9d19                	subw	a0,a0,a4
ffffffffc0204e0a:	8082                	ret
ffffffffc0204e0c:	4501                	li	a0,0
ffffffffc0204e0e:	bfed                	j	ffffffffc0204e08 <strcmp+0x16>

ffffffffc0204e10 <strchr>:
...
ffffffffc0204e14:	c799                	beqz	a5,ffffffffc0204e22 <strchr+0x12>
        if (*s == c) {
ffffffffc0204e16:	00f58763          	beq	a1,a5,ffffffffc0204e24 <strchr+0x14>
    while (*s != '\0') {
ffffffffc0204e1a:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0204e1e:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0204e20:	fbfd                	bnez	a5,ffffffffc0204e16 <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204e26:	ca01                	beqz	a2,ffffffffc0204e36 <memset+0x10>
ffffffffc0204e28:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204e2a:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204e2c:	0785                	addi	a5,a5,1
ffffffffc0204e2e:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0204e32:	fec79de3          	bne	a5,a2,ffffffffc0204e2c <memset+0x6>
    }
    return s;
...
ffffffffc0204e38 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0204e38:	ca19                	beqz	a2,ffffffffc0204e4e <memcpy+0x16>
ffffffffc0204e3a:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0204e3c:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0204e3e:	0005c703          	lbu	a4,0(a1)
ffffffffc0204e42:	0585                	addi	a1,a1,1
ffffffffc0204e44:	0785                	addi	a5,a5,1
ffffffffc0204e46:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0204e4a:	fec59ae3          	bne	a1,a2,ffffffffc0204e3e <memcpy+0x6>
    }
    return dst;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0204e50:	c205                	beqz	a2,ffffffffc0204e70 <memcmp+0x20>
ffffffffc0204e52:	962e                	add	a2,a2,a1
ffffffffc0204e54:	a019                	j	ffffffffc0204e5a <memcmp+0xa>
ffffffffc0204e56:	00c58d63          	beq	a1,a2,ffffffffc0204e70 <memcmp+0x20>
        if (*s1 != *s2) {
ffffffffc0204e5a:	00054783          	lbu	a5,0(a0)
ffffffffc0204e5e:	0005c703          	lbu	a4,0(a1)
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
        }
        s1 ++, s2 ++;
...
ffffffffc0204e64:	0585                	addi	a1,a1,1
        if (*s1 != *s2) {
ffffffffc0204e66:	fee788e3          	beq	a5,a4,ffffffffc0204e56 <memcmp+0x6>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204e6a:	40e7853b          	subw	a0,a5,a4
