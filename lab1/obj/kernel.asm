...
void interrupt_handler(struct trapframe *tf) {
    ...
    8020043c:	b1050513          	addi	a0,a0,-1264 # 80200f48 <etext+0x520>
    80200440:	b905                	j	80200070 <cprintf>
            print_trapframe(tf);
    80200442:	b70d                	j	80200364 <print_trapframe>
                num+=1;
    80200444:	00004417          	auipc	s0,0x4
    80200448:	bd440413          	addi	s0,s0,-1068 # 80204018 <num>
    8020044c:	601c                	ld	a5,0(s0)
    cprintf("%d ticks\n", TICK_NUM);
    8020044e:	06400593          	li	a1,100
    80200452:	00001517          	auipc	a0,0x1
    80200456:	ae650513          	addi	a0,a0,-1306 # 80200f38 <etext+0x510>
                num+=1;
    ...
    8020045e:	c13ff0ef          	jal	ra,80200070 <cprintf>
                if(num==10)
    80200462:	6018                	ld	a4,0(s0)
    80200464:	47a9                	li	a5,10
    80200466:	fcf715e3          	bne	a4,a5,80200430 <interrupt_handler+0x6c>
}
